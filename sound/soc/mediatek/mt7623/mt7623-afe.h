...
#ifndef _MT7623_AFE_H_
#define _MT7623_AFE_H_
...
{
    switch (fs) {
    case 8000:   return FS_8000HZ;
    case 12000:  return FS_12000HZ;
    case 16000:  return FS_16000HZ;
    case 24000:  return FS_24000HZ;
    case 32000:  return FS_32000HZ;
    case 48000:  return FS_48000HZ;
    case 96000:  return FS_96000HZ;
    case 192000: return FS_192000HZ;
    case 384000: return FS_384000HZ;
    case 7350:   return FS_7350HZ;
    case 11025:  return FS_11025HZ;
    case 14700:  return FS_14700HZ;
    case 22050:  return FS_22050HZ;
    case 29400:  return FS_29400HZ;
    case 44100:  return FS_44100HZ;
    case 88200:  return FS_88200HZ;
    case 176400: return FS_176400HZ;
    case 352800: return FS_352800HZ;
    case 768000: return FS_768000HZ;
    default:     return FS_48000HZ;
...
int afe_i2s_in_master_pcm_configurate(enum afe_i2s_in_id id, enum afe_i2s_format fmt, int mclk, enum afe_sampling_rate fs, int use_asrc);
...
int afe_i2s_out_master_dsd_configurate(enum afe_i2s_out_id id, enum afe_sampling_rate fs, int mclk, enum afe_i2s_out_dsd_use dsd_use);
...
struct afe_daibt_config
{
    ...
    enum afe_daibt_output_fs afe_daibt_fs;    //daibt output fs is 8k or 16k. 0: 8k. 1:16k
    enum afe_daibt_input_sel afe_daibt_input; //daibt input data is from merge if or daibt rx. 0: dairx, 1: mergeif
};
...
extern int afe_daibt_configurate(struct afe_daibt_config*);
extern int afe_daibt_set_output_fs(enum afe_daibt_output_fs);
extern void afe_daibt_set_enable(int);
extern void afe_o31_pcm_tx_sel_pcmtx(int);
extern void afe_i26_pcm_rx_sel_pcmrx(int);
extern void afe_merge_set_sync_dly(uint);
extern void afe_merge_set_clk_edge_dly(uint);
extern void afe_merge_set_clk_dly(uint);
extern void afe_merge_set_enable(int);
extern void afe_merge_i2s_clk_invert(int); // 0:invert,1:non-invert
extern void afe_merge_i2s_enable(int);
extern void afe_merge_i2s_set_mode(enum afe_mrg_i2s_mode);
...
{
    switch (mode) {
    case PCM_MODE_16K: return FS_16000HZ;
    case PCM_MODE_8K: default: return FS_8000HZ;
    }
}
