...
#ifndef _MT7623_AFE_REG_H_
#define _MT7623_AFE_REG_H_

/* export to mt7623-afe.c only */
...
#define AINACK_CFG_INT_MUTLI           ((unsigned)0x1<< 6)    // Multiline INT
...
#define FOC_EN_LEN  1
    ...
    // Morning add for 7623 PCM intf test
...
#define IRQ4_ON         1 << 3
#define IRQ5_ON         1 << 12// this bit controls the enable for IRQ5_MCU,which is speciallized for HDMI 8ch I2S
#define IRQ6_ON         1 << 13// this bit controls the enable for IRQ5_MCU,which is speciallized for SPDIF
...
#define IRQ_CLR_ALL \
    (IRQ1_IRQ_CLR|IRQ2_IRQ_CLR|MULTIIN_IRQ_CLR|SPDIF2_IRQ_CLR|HDMI_IRQ_CLR|SPDIF_IRQ_CLR|SPDIFIN_IRQ_CLR)
...
#define SPDIFIN_INT_ERR_CLEAR_MASK 0xFFF
    ...
    #define SPDIFIN_INT_CLEAR_ALL                 (SPDIFIN_PRE_ERR_CLEAR|SPDIFIN_PRE_ERR_B_CLEAR|SPDIFIN_PRE_ERR_M_CLEAR|\
                                                       SPDIFIN_PRE_ERR_W_CLEAR|SPDIFIN_PRE_ERR_BITCNT_CLEAR|SPDIFIN_PRE_ERR_PARITY_CLEAR|\
                                                       SPDIFIN_TIMEOUT_INT_CLEAR|SPDIFIN_CHSTS_PREAMPHASIS_CLEAR|SPDIFIN_DATA_LATCH_CLEAR)
...
#define SPDIFIN_INT_ERR_EN_MASK                0xFFF << 20
    ...
    #define SPDIFIN_ALL_ERR_INT_EN         (SPDIFIN_PRE_ERR_NON_EN|SPDIFIN_PRE_ERR_B_EN|SPDIFIN_PRE_ERR_M_EN| \
                                                ...
                                                SPDIFIN_CHSTS_PREAMPHASIS_EN)
    //AFE_SPDIFIN_CLK_CFG
#define SPDIFIN_AUTOLOCK_EN_MASK   1
    #define SPDIFIN_AUTOLOCK_EN    1
    #define SPDIFIN_AUTOLOCK_DIS   0
...
#define REG_ASRC_IER                            (AFE_BASE + 0x0B04)
    #define POS_IBUF_EMPTY_INTEN    20
    #define MASK_IBUF_EMPTY_INTEN   (1<<POS_IBUF_EMPTY_INTEN)
    #define POS_IBUF_AMOUNT_INTEN   16
    #define MASK_IBUF_AMOUNT_INTEN  (1<<POS_IBUF_AMOUNT_INTEN)
    #define POS_OBUF_OV_INTEN       12
    #define MASK_OBUF_OV_INTEN      (1<<POS_OBUF_OV_INTEN)
    #define POS_OBUF_AMOUNT_INTEN   8
    #define MASK_OBUF_AMOUNT_INTEN  (1<<POS_OBUF_AMOUNT_INTEN)

#define REG_ASRC_IFR                            (AFE_BASE + 0x0B08)
    // Bit define is same as REG_ASRC_IER
