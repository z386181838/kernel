...
typedef enum _VIDEO_DECODER_T {
    ...
    CODEC_DEC_RV9       = (0x1<<9),     ///< RV9
    CODEC_DEC_MAX       = (0x1<<10)     ///< MAX
} VIDEO_DECODER_T;
 ...
 */
VIDEO_DEC_API_T * GetDecoderAPI(VIDEO_DECODER_T eDecType, HANDLE hWrapper, void **ppDrvModule,
 ...
 */
VIDEO_ENC_API_T *GetEncoderAPI(VIDEO_ENCODER_T eEncType, HANDLE hWrapper, void **ppDrvModule,
			       unsigned int bUseMultiCoreCodec);
