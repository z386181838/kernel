...
typedef enum __VENC_DRV_SET_TYPE_T
{
    ...
    VENC_DRV_SET_TYPE_ADJUST_ROI,           //adjust ROI info
    VENC_DRV_SET_TYPE_ADJUST_RESOLUTION,
 ...
 *   VENC_DRV_ROI_T
 * @par Description
 *   This is timestamp information and used as items for ROI rectangle
 */
	typedef struct __VENC_DRV_ROI_T {
		VAL_UINT32_T u4ROI[4];/* /< [IN] Timestamp information */
	} VENC_DRV_ROI_T;
	typedef VENC_DRV_ROI_T * pVENC_DRV_ROI_T;

 /**
 * @par Structure
 *   VENC_DRV_RESOLUTON_T
 * @par Description
 *   This is timestamp information and used as items for resolution
 */
typedef struct  __VENC_DRV_RESOLUTON_T {
VAL_UINT32_T u4FrameWidth;
VAL_UINT32_T u4FrameHeight;
VAL_UINT32_T u4BufWidth;
VAL_UINT32_T u4BufHeight;
} VENC_DRV_RESOLUTON_T;
typedef VENC_DRV_RESOLUTON_T * pVENC_DRV_RESOLUTON_T;
/**
 * @par Structure
