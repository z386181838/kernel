 ...
 */
    ...
    VDEC_DRV_GET_TYPE_FREE_INPUT_BUFFER_RV9,        ///< RV9 Codec free input buffer
 ...
 */
	...
	VDEC_DRV_DECODE_MODE_SKIP_REFERENCE_CHECK,/* skip referencemode - force decode and display from first frame*/
	VDEC_DRV_DECODE_MODE_LOW_LATENCY_DECODE,/* decode immediately no check.(parser check the completed frame)*/
	} VDEC_DRV_DECODE_MODE_T;
 ...
 */
    ...
    VAL_UINT32_T    u4RvRead;                   ///< [IN/OUT] RV Codec Read Pointer
	} VDEC_DRV_RINGBUF_T;
 ...
 */
    ...
    VAL_BOOL_T      bNfyCropInfo;               ///< [IN/OUT] Notify Crop Info 
	} VDEC_DRV_FRAMEBUF_T;
 ...
 */
	...
	VAL_UINT32_T    u4ReferenceFrameNumber;
 ...
 */
	VDEC_DRV_MRESULT_T eVDecDrvQueryCapability(VDEC_DRV_QUERY_TYPE_T a_eType,
 ...
 */
	VDEC_DRV_MRESULT_T eVDecDrvCreate(VAL_HANDLE_T *a_phHandle,
					  VDEC_DRV_VIDEO_FORMAT_T a_eVideoFormat);
 ...
 */
	VDEC_DRV_MRESULT_T eVDecDrvInit(VAL_HANDLE_T a_hHandle, VDEC_DRV_RINGBUF_T *a_prBitstream,
 ...
 */
	VDEC_DRV_MRESULT_T eVDecDrvGetParam(VAL_HANDLE_T a_hHandle, VDEC_DRV_GET_TYPE_T a_eType,
 ...
 */
	VDEC_DRV_MRESULT_T eVDecDrvSetParam(VAL_HANDLE_T a_hHandle, VDEC_DRV_SET_TYPE_T a_eType,
					    VAL_VOID_T *a_pvInParam, VAL_VOID_T *a_pvOutParam);
 ...
 */
	VDEC_DRV_MRESULT_T eVDecDrvDecode(VAL_HANDLE_T a_hHandle,
