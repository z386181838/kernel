...
VOID CheckAmsduMiss(RTMP_ADAPTER *pAd, UINT16 CurSN, UINT8 cur_amsdu_state, PBA_REC_ENTRY pBAEntry, ULONG Now32)
{
...
VOID BAReorder(RTMP_ADAPTER *pAd, RX_BLK *pRxBlk, UCHAR wdev_idx)
{
	...
	CheckAmsduMiss(pAd, Sequence, pRxBlk->AmsduState, pBAEntry, Now32);
