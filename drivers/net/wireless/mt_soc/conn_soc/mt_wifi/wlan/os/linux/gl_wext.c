...
static const struct iw_priv_args rIwPrivTable[] = {
    ...
    /* added for APSOC */    
    {IOCTL_ATE_SET,          IW_PRIV_TYPE_CHAR | 1536,                 0,    "set"},  
#endif
...
#if (CFG_SUPPORT_APSOC_MP_TOOL == 1)    
    [IOCTL_ATE_SET - SIOCIWFIRSTPRIV]  = priv_ate_set,
#endif        
};
...
static INT_32          i4WextScanDoing = 0;
/*******************************************************************************
    ...
    )
{
    ...
    */
    ...
    case SIOCGIWSCAN: /* 0x8B19, get scan results */
        if (i4WextScanDoing == 1) {
            DBGLOG(INIT, INFO, ("[wifi] Get scan result fail...in scaning -EAGAIN\n"));
            ret = -EAGAIN;
            break;
        }
    ...
    )
{
    ...
    case SIOCGIWSCAN:
        if (i4WextScanDoing == 1) {
            i4WextScanDoing = 0;
            DBGLOG(INIT, INFO, ("[wifi] WEXT SCAN done...\n"));
        }
