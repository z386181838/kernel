    ...
    )
{
    ...
    if(prScanParam->eScanChannel == SCAN_CHANNEL_FULL
        ...
        if(prScanDone->ucSparseChannelValid) {
            ...
            prScanInfo->ucSparseChannelArrayValid = prScanDone->ucSparseChannelArrayValid;
            prScanInfo->aucReserved[0] = prScanDone->aucReserved[0];
            prScanInfo->aucReserved[1] = prScanDone->aucReserved[1];
            ...
            for(channel_count=0;channel_count<prScanInfo->ucSparseChannelArrayValid;channel_count++){
            	...
            	prScanInfo->aucChannelNum[channel_count]= prScanDone->aucChannelNum[channel_count];
            	prScanInfo->au2ChannelIdleTime[channel_count]=prScanDone->au2ChannelIdleTime[channel_count];
