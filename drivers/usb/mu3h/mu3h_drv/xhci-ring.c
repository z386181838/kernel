		...
		struct xhci_transfer_event *event)
{
	...
	case COMP_SHORT_TX:
		break;
	case COMP_STOP:
		printk("Stopped on Transfer TRB\n");
		xhci_dbg(xhci, "Stopped on Transfer TRB\n");
		break;
	case COMP_STOP_INVAL:
		printk("Stopped on No-op or Link TRB\n");
		xhci_dbg(xhci, "Stopped on No-op or Link TRB\n");
		break;
	case COMP_STALL:
		printk(KERN_EMERG"WARN: Stalled endpoint\n");
		xhci_warn(xhci, "WARN: Stalled endpoint\n");
		ep->ep_state |= EP_HALTED;
		status = -EPIPE;
		break;
	case COMP_TRB_ERR:
		printk(KERN_EMERG"WARN: TRB error on endpoint\n");
		xhci_warn(xhci, "WARN: TRB error on endpoint\n");
		status = -EILSEQ;
		break;
	case COMP_SPLIT_ERR:
	case COMP_TX_ERR:
		printk(KERN_EMERG"WARN: transfer error on endpoint\n");
	...
	case COMP_BABBLE:
		...
		break;
	case COMP_DB_ERR:
		printk(KERN_EMERG"WARN: HC couldn't access mem fast enough\n");
		xhci_warn(xhci, "WARN: HC couldn't access mem fast enough\n");
		status = -ENOSR;
		break;
	case COMP_BW_OVER:
			printk(KERN_EMERG"WARN: bandwidth overrun event on endpoint\n");
		xhci_warn(xhci, "WARN: bandwidth overrun event on endpoint\n");
		break;
	case COMP_BUFF_OVER:
			printk(KERN_EMERG"WARN: buffer overrun event on endpoint\n");
	...
	case COMP_UNDERRUN:
		 ...
		 */
			printk(KERN_EMERG"WARN: buffer underrun event on endpoint\n");
		...
		goto cleanup;
	case COMP_OVERRUN:
		printk(KERN_EMERG"overrun event on endpoint\n");
		...
		goto cleanup;
	case COMP_DEV_ERR:
		printk(KERN_EMERG"WARN: detect an incompatible device");
	...
	case COMP_MISSED_INT:
		 ...
		 */
		ep->skip = true;
		printk(KERN_EMERG"Miss service interval error, set skip flag\n");
	...
	default:
		...
		printk("ERROR Unknown event condition, HC probably "
				"busted\n");
