...
#endif
		printk("Execute recovery function!\n");
...
int xhci_gen_setup(struct usb_hcd *hcd, xhci_get_quirks_t get_quirks)
{
	...
	for(i=0; i<u3_port_num; i++){
		addr = (u32 __iomem *)(u3h_hw->u3h_virtual_base + SSUSB_USB3_CSR_OFFSET + U3H_LTSSM_TIMING_PARAMETER_3);
                data =  U3_LTSSM_TIMING_PARAMETER3_VALUE;
                writel(data, addr);
	}
#endif
