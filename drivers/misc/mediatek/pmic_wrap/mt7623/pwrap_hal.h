...
#else
  #define PWRAPDEB(fmt, arg...)     do{}while(0)
  #define PWRAPFUC(fmt, arg...)     do{}while(0)
  #define PWRAPLOG(fmt, arg...)     do{}while(0)
  #define PWRAPERR(fmt, arg...)     do{}while(0)
  #define PWRAPREG(fmt, arg...)     do{}while(0)
#endif
