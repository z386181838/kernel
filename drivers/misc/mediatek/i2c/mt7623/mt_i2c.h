...
extern int i2c_trans_data(int bus_id, int address, char *buf, int count, unsigned int ext_flag,int timing);
...
extern void i2c_write(u32 address, u8 *data, u32 nbytes);
extern void i2c_read(u8 *data, u32 nbytes);
extern int  i2c_WriteRead(u32 address, u8 *data, u32 nbytes);
extern void random_read_block(u32 address, u8 *data);
extern u8 random_read_one_byte(u32 address);
extern void random_write_block(u32 address, u8 *data);
extern void random_write_one_byte(u32 address, u8 *data);
#if 0   /* for API UT */
extern void random_read_block_test(u32 address, u8 *data);
extern u8 random_read_one_byte_test(u32 address);
#endif   /* for API UT */
