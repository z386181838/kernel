...
#define DISP_OVL_ENGINE_ERR(string, args...) if(disp_ovl_engine_log_level >= 0) pr_err("[OVL] mt7623 "string,##args)  // 
#define DISP_OVL_ENGINE_WARN(string, args...) if(disp_ovl_engine_log_level >= 1) pr_err("[OVL] mt7623 "string,##args)  // 
#define DISP_OVL_ENGINE_INFO(string, args...) if(disp_ovl_engine_log_level >= 2) pr_err("[OVL] mt7623 "string,##args)  // 
#define DISP_OVL_ENGINE_DBG(string, args...) if(disp_ovl_engine_log_level >= 3) pr_err("[OVL] mt7623 "string,##args)  // 
