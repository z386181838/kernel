 ...
 *
 ***************************************************************************** */
static int AudDrv_Read_show(struct seq_file *m, void *v)
{
    PRINTK_AUDDRV("+AudDrv_Read_show \n");
    AudDrv_Clk_On();

#ifdef MTK_PMIC_MT6397
    seq_printf(m, "Afe_Mem_Pwr_on =0x%x\n", Afe_Mem_Pwr_on);
    seq_printf(m, "Aud_AFE_Clk_cntr = 0x%x\n", Aud_AFE_Clk_cntr);
    seq_printf(m, "Aud_ANA_Clk_cntr = 0x%x\n", Aud_ANA_Clk_cntr);
    seq_printf(m, "Aud_HDMI_Clk_cntr = 0x%x\n", Aud_HDMI_Clk_cntr);
    seq_printf(m, "Aud_I2S_Clk_cntr = 0x%x\n", Aud_I2S_Clk_cntr);
    seq_printf(m, "Aud_APLL_Tuner_Clk_cntr = 0x%x\n", Aud_APLL_Tuner_Clk_cntr);
    seq_printf(m, "Aud_SPDIF_Clk_cntr = 0x%x\n", Aud_SPDIF_Clk_cntr);
    seq_printf(m, "Aud_Int_Mem_Flag = 0x%x\n", Aud_Int_Mem_Flag);
    seq_printf(m, "Aud_Ext_Mem_Flag = 0x%x\n", Aud_Ext_Mem_Flag);
    seq_printf(m, "AuddrvSpkStatus = 0x%x\n", AuddrvSpkStatus);

    seq_printf(m, "AUDIO_TOP_CON0  = 0x%x\n", Afe_Get_Reg(AUDIOAFE_TOP_CON0));
    seq_printf(m, "AUDIO_TOP_CON1  = 0x%x\n", Afe_Get_Reg(AUDIO_TOP_CON1));
    seq_printf(m, "AUDIO_TOP_CON2  = 0x%x\n", Afe_Get_Reg(AUDIO_TOP_CON2));
    seq_printf(m, "AUDIO_TOP_CON3  = 0x%x\n", Afe_Get_Reg(AUDIO_TOP_CON3));
    seq_printf(m, "AFE_DAC_CON0  = 0x%x\n", Afe_Get_Reg(AFE_DAC_CON0));
    seq_printf(m, "AFE_DAC_CON1  = 0x%x\n", Afe_Get_Reg(AFE_DAC_CON1));
    seq_printf(m, "AFE_I2S_CON  = 0x%x\n", Afe_Get_Reg(AFE_I2S_CON));

    seq_printf(m, "AFE_CONN0  = 0x%x\n", Afe_Get_Reg(AFE_CONN0));
    seq_printf(m, "AFE_CONN1  = 0x%x\n", Afe_Get_Reg(AFE_CONN1));
    seq_printf(m, "AFE_CONN2  = 0x%x\n", Afe_Get_Reg(AFE_CONN2));
    seq_printf(m, "AFE_CONN3  = 0x%x\n", Afe_Get_Reg(AFE_CONN3));
    seq_printf(m, "AFE_CONN4  = 0x%x\n", Afe_Get_Reg(AFE_CONN4));
    seq_printf(m, "AFE_I2S_CON1  = 0x%x\n", Afe_Get_Reg(AFE_I2S_CON1));
    seq_printf(m, "AFE_I2S_CON2  = 0x%x\n", Afe_Get_Reg(AFE_I2S_CON2));

    //len += sprintf(buf+len ,"AFE_MRGIF_CON  = 0x%x\n",Afe_Get_Reg(AFE_MRGIF_CON));
    seq_printf(m, "AFE_DL1_BASE  = 0x%x\n", Afe_Get_Reg(AFE_DL1_BASE));
    seq_printf(m, "AFE_DL1_CUR  = 0x%x\n", Afe_Get_Reg(AFE_DL1_CUR));
    seq_printf(m, "AFE_DL1_END  = 0x%x\n", Afe_Get_Reg(AFE_DL1_END));
    seq_printf(m, "AFE_I2S_CON3  = 0x%x\n", Afe_Get_Reg(AFE_I2S_CON3)); //
    seq_printf(m, "AFE_DL2_BASE  = 0x%x\n", Afe_Get_Reg(AFE_DL2_BASE));
    seq_printf(m, "AFE_DL2_CUR  = 0x%x\n", Afe_Get_Reg(AFE_DL2_CUR));
    seq_printf(m, "AFE_DL2_END  = 0x%x\n", Afe_Get_Reg(AFE_DL2_END));
    seq_printf(m, "AFE_AWB_BASE  = 0x%x\n", Afe_Get_Reg(AFE_AWB_BASE));
    seq_printf(m, "AFE_AWB_END  = 0x%x\n", Afe_Get_Reg(AFE_AWB_END));
    seq_printf(m, "AFE_AWB_CUR  = 0x%x\n", Afe_Get_Reg(AFE_AWB_CUR));
    seq_printf(m, "AFE_VUL_BASE  = 0x%x\n", Afe_Get_Reg(AFE_VUL_BASE));
    seq_printf(m, "AFE_VUL_END  = 0x%x\n", Afe_Get_Reg(AFE_VUL_END));
    seq_printf(m, "AFE_VUL_CUR  = 0x%x\n", Afe_Get_Reg(AFE_VUL_CUR));


    seq_printf(m, "MEMIF_MON0 = 0x%x\n", Afe_Get_Reg(AFE_MEMIF_MON0));
    seq_printf(m, "MEMIF_MON1 = 0x%x\n", Afe_Get_Reg(AFE_MEMIF_MON1));
    seq_printf(m, "MEMIF_MON2 = 0x%x\n", Afe_Get_Reg(AFE_MEMIF_MON2));
    seq_printf(m, "MEMIF_MON4 = 0x%x\n", Afe_Get_Reg(AFE_MEMIF_MON4));

    seq_printf(m, "AFE_ADDA_DL_SRC2_CON0  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_DL_SRC2_CON0));
    seq_printf(m, "AFE_ADDA_DL_SRC2_CON1  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_DL_SRC2_CON1));
    seq_printf(m, "AFE_ADDA_UL_SRC_CON0  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_UL_SRC_CON0));
    seq_printf(m, "AFE_ADDA_UL_SRC_CON1  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_UL_SRC_CON1));
    seq_printf(m, "AFE_ADDA_TOP_CON0  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_TOP_CON0));
    seq_printf(m, "AFE_ADDA_UL_DL_CON0  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_UL_DL_CON0));
    seq_printf(m, "AFE_ADDA_SRC_DEBUG  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_SRC_DEBUG));
    seq_printf(m, "AFE_ADDA_SRC_DEBUG_MON0  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_SRC_DEBUG_MON0));
    seq_printf(m, "AFE_ADDA_SRC_DEBUG_MON1  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_SRC_DEBUG_MON1));
    seq_printf(m, "AFE_ADDA_NEWIF_CFG0  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_NEWIF_CFG0));
    seq_printf(m, "AFE_ADDA_NEWIF_CFG1  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_NEWIF_CFG1));

    seq_printf(m, "SIDETONE_DEBUG = 0x%x\n", Afe_Get_Reg(AFE_SIDETONE_DEBUG));
    seq_printf(m, "SIDETONE_MON = 0x%x\n", Afe_Get_Reg(AFE_SIDETONE_MON));
    seq_printf(m, "SIDETONE_CON0 = 0x%x\n", Afe_Get_Reg(AFE_SIDETONE_CON0));
    seq_printf(m, "SIDETONE_COEFF = 0x%x\n", Afe_Get_Reg(AFE_SIDETONE_COEFF));
    seq_printf(m, "SIDETONE_CON1 = 0x%x\n", Afe_Get_Reg(AFE_SIDETONE_CON1));
    seq_printf(m, "SIDETONE_GAIN = 0x%x\n", Afe_Get_Reg(AFE_SIDETONE_GAIN));
    seq_printf(m, "SGEN_CON0 = 0x%x\n", Afe_Get_Reg(AFE_SGEN_CON0));

    seq_printf(m, "TOP_CON0 = 0x%x\n", Afe_Get_Reg(AFE_TOP_CON0));

    seq_printf(m, "HDMI_OUT_CON0   = 0x%x\n", Afe_Get_Reg(AFE_HDMI_OUT_CON0));
    seq_printf(m, "HDMI_OUT_BASE   = 0x%x\n", Afe_Get_Reg(AFE_HDMI_OUT_BASE));
    seq_printf(m, "HDMI_OUT_CUR    = 0x%x\n", Afe_Get_Reg(AFE_HDMI_OUT_CUR));
    seq_printf(m, "HDMI_OUT_END    = 0x%x\n", Afe_Get_Reg(AFE_HDMI_OUT_END));
    seq_printf(m, "SPDIF_OUT_CON0  = 0x%x\n", Afe_Get_Reg(AFE_SPDIF_OUT_CON0));
    seq_printf(m, "SPDIF_BASE      = 0x%x\n", Afe_Get_Reg(AFE_SPDIF_BASE));
    seq_printf(m, "SPDIF_CUR       = 0x%x\n", Afe_Get_Reg(AFE_SPDIF_CUR));
    seq_printf(m, "SPDIF_END       = 0x%x\n", Afe_Get_Reg(AFE_SPDIF_END));
    seq_printf(m, "HDMI_CONN0      = 0x%x\n", Afe_Get_Reg(AFE_HDMI_CONN0));
    seq_printf(m, "8CH_I2S_OUT_CON = 0x%x\n", Afe_Get_Reg(AFE_8CH_I2S_OUT_CON));
    seq_printf(m, "IEC_CFG         = 0x%x\n", Afe_Get_Reg(AFE_IEC_CFG));
    seq_printf(m, "IEC_NSNUM       = 0x%x\n", Afe_Get_Reg(AFE_IEC_NSNUM));
    seq_printf(m, "IEC_BURST_INFO  = 0x%x\n", Afe_Get_Reg(AFE_IEC_BURST_INFO));
    seq_printf(m, "IEC_BURST_LEN   = 0x%x\n", Afe_Get_Reg(AFE_IEC_BURST_LEN));
    seq_printf(m, "IEC_NSADR       = 0x%x\n", Afe_Get_Reg(AFE_IEC_NSADR));
    seq_printf(m, "IEC_CHL_STAT0   = 0x%x\n", Afe_Get_Reg(AFE_IEC_CHL_STAT0));
    seq_printf(m, "IEC_CHL_STAT1   = 0x%x\n", Afe_Get_Reg(AFE_IEC_CHL_STAT1));
    seq_printf(m, "IEC_CHR_STAT0   = 0x%x\n", Afe_Get_Reg(AFE_IEC_CHR_STAT0));
    seq_printf(m, "IEC_CHR_STAT1   = 0x%x\n", Afe_Get_Reg(AFE_IEC_CHR_STAT1));

    seq_printf(m, "AFE_PREDIS_CON0 = 0x%x\n", Afe_Get_Reg(AFE_PREDIS_CON0));
    seq_printf(m, "AFE_PREDIS_CON1 = 0x%x\n", Afe_Get_Reg(AFE_PREDIS_CON1));
    seq_printf(m, "AFE_MOD_PCM_BASE = 0x%x\n", Afe_Get_Reg(AFE_MOD_PCM_BASE));
    seq_printf(m, "AFE_MOD_PCM_END = 0x%x\n", Afe_Get_Reg(AFE_MOD_PCM_END));
    seq_printf(m, "AFE_MOD_PCM_CUR = 0x%x\n", Afe_Get_Reg(AFE_MOD_PCM_CUR));

    seq_printf(m, "IRQ_MCU_CON = 0x%x\n", Afe_Get_Reg(AFE_IRQ_MCU_CON)); //ccc
    seq_printf(m, "IRQ_MCU_STATUS = 0x%x\n", Afe_Get_Reg(AFE_IRQ_MCU_STATUS));
    seq_printf(m, "IRQ_CLR = 0x%x\n", Afe_Get_Reg(AFE_IRQ_CLR));
    seq_printf(m, "IRQ_MCU_CNT1 = 0x%x\n", Afe_Get_Reg(AFE_IRQ_MCU_CNT1));
    seq_printf(m, "IRQ_MCU_CNT2 = 0x%x\n", Afe_Get_Reg(AFE_IRQ_MCU_CNT2));
    seq_printf(m, "IRQ_MCU_MON2 = 0x%x\n", Afe_Get_Reg(AFE_IRQ_MCU_MON2));
    seq_printf(m, "IRQ_MCU_CNT5 = 0x%x\n", Afe_Get_Reg(AFE_IRQ_MCU_CNT5));
    seq_printf(m, "IRQ1_MCU_CNT_MON = 0x%x\n", Afe_Get_Reg(AFE_IRQ1_MCU_CNT_MON));
    seq_printf(m, "IRQ2_MCU_CNT_MON = 0x%x\n", Afe_Get_Reg(AFE_IRQ2_MCU_CNT_MON));
    seq_printf(m, "IRQ1_MCU_EN_CNT_MON = 0x%x\n", Afe_Get_Reg(AFE_IRQ1_MCU_EN_CNT_MON));
    seq_printf(m, "IRQ5_MCU_EN_CNT_MON = 0x%x\n", Afe_Get_Reg(AFE_IRQ5_MCU_EN_CNT_MON));

    //seq_printf(m, "AFE_MEMIF_MINLEN  = 0x%x\n", Afe_Get_Reg(AFE_MEMIF_MINLEN));
    seq_printf(m, "AFE_MEMIF_MAXLEN  = 0x%x\n", Afe_Get_Reg(AFE_MEMIF_MAXLEN));
    seq_printf(m, "AFE_MEMIF_PBUF_SIZE  = 0x%x\n", Afe_Get_Reg(AFE_MEMIF_PBUF_SIZE));

    seq_printf(m, "AFE_GAIN1_CON0  = 0x%x\n", Afe_Get_Reg(AFE_GAIN1_CON0));
    seq_printf(m, "AFE_GAIN1_CON1  = 0x%x\n", Afe_Get_Reg(AFE_GAIN1_CON1));
    seq_printf(m, "AFE_GAIN1_CON2  = 0x%x\n", Afe_Get_Reg(AFE_GAIN1_CON2));
    seq_printf(m, "AFE_GAIN1_CON3  = 0x%x\n", Afe_Get_Reg(AFE_GAIN1_CON3));
    seq_printf(m, "AFE_GAIN1_CONN  = 0x%x\n", Afe_Get_Reg(AFE_GAIN1_CONN));
    seq_printf(m, "AFE_GAIN1_CUR  = 0x%x\n", Afe_Get_Reg(AFE_GAIN1_CUR));

    seq_printf(m, "AFE_GAIN2_CON0  = 0x%x\n", Afe_Get_Reg(AFE_GAIN2_CON0));
    seq_printf(m, "AFE_GAIN2_CON1  = 0x%x\n", Afe_Get_Reg(AFE_GAIN2_CON1));
    seq_printf(m, "AFE_GAIN2_CON2  = 0x%x\n", Afe_Get_Reg(AFE_GAIN2_CON2));

    seq_printf(m, "AFE_GAIN2_CON3  = 0x%x\n", Afe_Get_Reg(AFE_GAIN2_CON3));
    seq_printf(m, "AFE_GAIN2_CONN  = 0x%x\n", Afe_Get_Reg(AFE_GAIN2_CONN));
    seq_printf(m, "AFE_GAIN2_CUR  = 0x%x\n", Afe_Get_Reg(AFE_GAIN2_CUR));
    seq_printf(m, "AFE_GAIN2_CONN2  = 0x%x\n", Afe_Get_Reg(AFE_GAIN2_CONN2));


    seq_printf(m, "FPGA_CFG2  = 0x%x\n", Afe_Get_Reg(FPGA_CFG2));
    seq_printf(m, "FPGA_CFG3  = 0x%x\n", Afe_Get_Reg(FPGA_CFG3));
    seq_printf(m, "FPGA_CFG0  = 0x%x\n", Afe_Get_Reg(FPGA_CFG0));
    seq_printf(m, "FPGA_CFG1  = 0x%x\n", Afe_Get_Reg(FPGA_CFG1));
    seq_printf(m, "FPGA_STC  = 0x%x\n", Afe_Get_Reg(FPGA_STC));

    seq_printf(m, "AFE_ASRC_CON0  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON0));
    seq_printf(m, "AFE_ASRC_CON1  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON1));
    seq_printf(m, "AFE_ASRC_CON2  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON2));
    seq_printf(m, "AFE_ASRC_CON3  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON3));
    seq_printf(m, "AFE_ASRC_CON4  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON4));
    seq_printf(m, "AFE_ASRC_CON5  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON5));
    seq_printf(m, "AFE_ASRC_CON6  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON6));
    seq_printf(m, "AFE_ASRC_CON7  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON7));
    seq_printf(m, "AFE_ASRC_CON8  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON8));
    seq_printf(m, "AFE_ASRC_CON9  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON9));
    seq_printf(m, "AFE_ASRC_CON10  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON10));
    seq_printf(m, "AFE_ASRC_CON11  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON11));

    seq_printf(m, "PCM_INTF_CON1 = 0x%x\n", Afe_Get_Reg(PCM_INTF_CON1));
    seq_printf(m, "PCM_INTF_CON2 = 0x%x\n", Afe_Get_Reg(PCM_INTF_CON2));
    seq_printf(m, "PCM2_INTF_CON = 0x%x\n", Afe_Get_Reg(PCM2_INTF_CON));





    seq_printf(m, "AFE_ASRC_CON13  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON13));
    seq_printf(m, "AFE_ASRC_CON14  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON14));
    seq_printf(m, "AFE_ASRC_CON15  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON15));
    seq_printf(m, "AFE_ASRC_CON16  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON16));
    seq_printf(m, "AFE_ASRC_CON17  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON17));
    seq_printf(m, "AFE_ASRC_CON18  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON18));
    seq_printf(m, "AFE_ASRC_CON19  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON19));
    seq_printf(m, "AFE_ASRC_CON20  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON20));
    seq_printf(m, "AFE_ASRC_CON21  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON21));

    seq_printf(m, "UL_DL_CON0 = 0x%x\n", Ana_Get_Reg(AFE_UL_DL_CON0));
    seq_printf(m, "DL_SRC2_CON0_H = 0x%x\n", Ana_Get_Reg(AFE_DL_SRC2_CON0_H));
    seq_printf(m, "DL_SRC2_CON0_L = 0x%x\n", Ana_Get_Reg(AFE_DL_SRC2_CON0_L));
    seq_printf(m, "DL_SDM_CON0 = 0x%x\n", Ana_Get_Reg(AFE_DL_SDM_CON0));
    seq_printf(m, "DL_SDM_CON1 = 0x%x\n", Ana_Get_Reg(AFE_DL_SDM_CON1));
    seq_printf(m, "UL_SRC_CON0_H = 0x%x\n", Ana_Get_Reg(AFE_UL_SRC_CON0_H));
    seq_printf(m, "UL_SRC_CON0_L = 0x%x\n", Ana_Get_Reg(AFE_UL_SRC_CON0_L));
    seq_printf(m, "UL_SRC_CON1_H = 0x%x\n", Ana_Get_Reg(AFE_UL_SRC_CON1_H));
    seq_printf(m, "UL_SRC_CON1_L = 0x%x\n", Ana_Get_Reg(AFE_UL_SRC_CON1_L));
    seq_printf(m, "AFE_TOP_CON0 = 0x%x\n", Ana_Get_Reg(ANA_AFE_TOP_CON0));

    seq_printf(m, "AFUNC_AUD_CON0 = 0x%x\n", Ana_Get_Reg(AFUNC_AUD_CON0));
    seq_printf(m, "AFUNC_AUD_CON1 = 0x%x\n", Ana_Get_Reg(AFUNC_AUD_CON1));
    seq_printf(m, "AFUNC_AUD_CON2 = 0x%x\n", Ana_Get_Reg(AFUNC_AUD_CON2));
    seq_printf(m, "AFUNC_AUD_CON3 = 0x%x\n", Ana_Get_Reg(AFUNC_AUD_CON3));
    seq_printf(m, "AFUNC_AUD_CON4 = 0x%x\n", Ana_Get_Reg(AFUNC_AUD_CON4));

    seq_printf(m, "TOP_CKPDN = 0x%x\n", Ana_Get_Reg(TOP_CKPDN));
    seq_printf(m, "TOP_CKPDN2 = 0x%x\n", Ana_Get_Reg(TOP_CKPDN2));
    seq_printf(m, "TOP_CKCON1 = 0x%x\n", Ana_Get_Reg(TOP_CKCON1));
    seq_printf(m, "SPK_CON0 = 0x%x\n", Ana_Get_Reg(SPK_CON0));
    seq_printf(m, "SPK_CON1 = 0x%x\n", Ana_Get_Reg(SPK_CON1));
    seq_printf(m, "SPK_CON2 = 0x%x\n", Ana_Get_Reg(SPK_CON2));
    seq_printf(m, "SPK_CON3 = 0x%x\n", Ana_Get_Reg(SPK_CON3));

    seq_printf(m, "SPK_CON4 = 0x%x\n", Ana_Get_Reg(SPK_CON4));
    seq_printf(m, "SPK_CON5 = 0x%x\n", Ana_Get_Reg(SPK_CON5));
    seq_printf(m, "SPK_CON6 = 0x%x\n", Ana_Get_Reg(SPK_CON6));
    seq_printf(m, "SPK_CON7 = 0x%x\n", Ana_Get_Reg(SPK_CON7));
    seq_printf(m, "SPK_CON8 = 0x%x\n", Ana_Get_Reg(SPK_CON8));

    seq_printf(m, "SPK_CON9 = 0x%x\n", Ana_Get_Reg(SPK_CON9));
    seq_printf(m, "SPK_CON10 = 0x%x\n", Ana_Get_Reg(SPK_CON10));
    seq_printf(m, "SPK_CON11 = 0x%x\n", Ana_Get_Reg(SPK_CON11));

    seq_printf(m, "AUDDAC_CON0 = 0x%x\n", Ana_Get_Reg(AUDDAC_CON0));
    seq_printf(m, "AUDBUF_CFG0 = 0x%x\n", Ana_Get_Reg(AUDBUF_CFG0));
    seq_printf(m, "AUDBUF_CFG1 = 0x%x\n", Ana_Get_Reg(AUDBUF_CFG1));
    seq_printf(m, "AUDBUF_CFG2 = 0x%x\n", Ana_Get_Reg(AUDBUF_CFG2));
    seq_printf(m, "AUDBUF_CFG3 = 0x%x\n", Ana_Get_Reg(AUDBUF_CFG3));
    seq_printf(m, "AUDBUF_CFG4 = 0x%x\n", Ana_Get_Reg(AUDBUF_CFG4));

    seq_printf(m, "IBIASDIST_CFG0 = 0x%x\n", Ana_Get_Reg(IBIASDIST_CFG0));
    seq_printf(m, "AUDACCDEPOP_CFG0 = 0x%x\n", Ana_Get_Reg(AUDACCDEPOP_CFG0));
    seq_printf(m, "AUD_IV_CFG0 = 0x%x\n", Ana_Get_Reg(AUD_IV_CFG0));
    seq_printf(m, "AUDCLKGEN_CFG0 = 0x%x\n", Ana_Get_Reg(AUDCLKGEN_CFG0));
    seq_printf(m, "AUDLDO_CFG0 = 0x%x\n", Ana_Get_Reg(AUDLDO_CFG0));
    seq_printf(m, "AUDLDO_CFG1 = 0x%x\n", Ana_Get_Reg(AUDLDO_CFG1));
    seq_printf(m, "AUDNVREGGLB_CFG0 = 0x%x\n", Ana_Get_Reg(AUDNVREGGLB_CFG0));
    seq_printf(m, "AUD_NCP0 = 0x%x\n", Ana_Get_Reg(AUD_NCP0));
    seq_printf(m, "AUDPREAMP_CON0 = 0x%x\n", Ana_Get_Reg(AUDPREAMP_CON0));
    seq_printf(m, "AUDADC_CON0 = 0x%x\n", Ana_Get_Reg(AUDADC_CON0));
    seq_printf(m, "AUDADC_CON1 = 0x%x\n", Ana_Get_Reg(AUDADC_CON1));
    seq_printf(m, "AUDADC_CON2 = 0x%x\n", Ana_Get_Reg(AUDADC_CON2));
    seq_printf(m, "AUDADC_CON3 = 0x%x\n", Ana_Get_Reg(AUDADC_CON3));
    seq_printf(m, "AUDADC_CON4 = 0x%x\n", Ana_Get_Reg(AUDADC_CON4));
    seq_printf(m, "AUDADC_CON5 = 0x%x\n", Ana_Get_Reg(AUDADC_CON5));
    seq_printf(m, "AUDADC_CON6 = 0x%x\n", Ana_Get_Reg(AUDADC_CON6));
    seq_printf(m, "AUDDIGMI_CON0 = 0x%x\n", Ana_Get_Reg(AUDDIGMI_CON0));
    seq_printf(m, "AUDLSBUF_CON0 = 0x%x\n", Ana_Get_Reg(AUDLSBUF_CON0));
    seq_printf(m, "AUDLSBUF_CON1 = 0x%x\n", Ana_Get_Reg(AUDLSBUF_CON1));
    seq_printf(m, "AUDENCSPARE_CON0 = 0x%x\n", Ana_Get_Reg(AUDENCSPARE_CON0));
    seq_printf(m, "AUDENCCLKSQ_CON0 = 0x%x\n", Ana_Get_Reg(AUDENCCLKSQ_CON0));
    seq_printf(m, "AUDPREAMPGAIN_CON0 = 0x%x\n", Ana_Get_Reg(AUDPREAMPGAIN_CON0));
    seq_printf(m, "ZCD_CON0 = 0x%x\n", Ana_Get_Reg(ZCD_CON0));
    seq_printf(m, "ZCD_CON1 = 0x%x\n", Ana_Get_Reg(ZCD_CON1));
    seq_printf(m, "ZCD_CON2 = 0x%x\n", Ana_Get_Reg(ZCD_CON2));
    seq_printf(m, "ZCD_CON3 = 0x%x\n", Ana_Get_Reg(ZCD_CON3));
    seq_printf(m, "ZCD_CON4 = 0x%x\n", Ana_Get_Reg(ZCD_CON4));
    seq_printf(m, "ZCD_CON5 = 0x%x\n", Ana_Get_Reg(ZCD_CON5));
    seq_printf(m, "NCP_CLKDIV_CON0 = 0x%x\n", Ana_Get_Reg(NCP_CLKDIV_CON0));
    seq_printf(m, "NCP_CLKDIV_CON1 = 0x%x\n", Ana_Get_Reg(NCP_CLKDIV_CON1));
    //seq_printf(m, "AUDPLL_CON0 = 0x%x\n", AP_Get_Reg(AUDPLL_CON0));
    //seq_printf(m, "AUDPLL_CON1 = 0x%x\n", AP_Get_Reg(AUDPLL_CON1));
    //seq_printf(m, "AUDPLL_CON3 = 0x%x\n", AP_Get_Reg(AUDPLL_CON3));
    //seq_printf(m, "CLK_CFG_5 = 0x%x\n", AP_Get_Reg(CLK_CFG_5));
    ...
    seq_printf(m, "ABB_AFE_CON0  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON0));
    seq_printf(m, "ABB_AFE_CON1  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON1));
    seq_printf(m, "ABB_AFE_CON2  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON2));
    seq_printf(m, "ABB_AFE_CON3  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON3));
    seq_printf(m, "ABB_AFE_CON4  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON4));
    seq_printf(m, "ABB_AFE_CON5  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON5));
    seq_printf(m, "ABB_AFE_CON6  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON6));
    seq_printf(m, "ABB_AFE_CON7  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON7));
    seq_printf(m, "ABB_AFE_CON8  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON8));
    seq_printf(m, "ABB_AFE_CON9  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON9));
    seq_printf(m, "ABB_AFE_CON10  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON10));
    seq_printf(m, "ABB_AFE_CON11  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON11));
    seq_printf(m, "ABB_AFE_STA0  = 0x%x\n", Ana_Get_Reg(ABB_AFE_STA0));
    seq_printf(m, "ABB_AFE_STA1  = 0x%x\n", Ana_Get_Reg(ABB_AFE_STA1));
    seq_printf(m, "ABB_AFE_STA2  = 0x%x\n", Ana_Get_Reg(ABB_AFE_STA2));
    seq_printf(m, "ABB_AFE_UP8X_FIFO_CFG0  = 0x%x\n", Ana_Get_Reg(ABB_AFE_UP8X_FIFO_CFG0));
    seq_printf(m, "ABB_AFE_UP8X_FIFO_LOG_MON0  = 0x%x\n", Ana_Get_Reg(ABB_AFE_UP8X_FIFO_LOG_MON0));
    seq_printf(m, "ABB_AFE_UP8X_FIFO_LOG_MON1  = 0x%x\n", Ana_Get_Reg(ABB_AFE_UP8X_FIFO_LOG_MON1));
    seq_printf(m, "ABB_AFE_PMIC_NEWIF_CFG0  = 0x%x\n", Ana_Get_Reg(ABB_AFE_PMIC_NEWIF_CFG0));
    seq_printf(m, "ABB_AFE_PMIC_NEWIF_CFG1  = 0x%x\n", Ana_Get_Reg(ABB_AFE_PMIC_NEWIF_CFG1));
    seq_printf(m, "ABB_AFE_PMIC_NEWIF_CFG2  = 0x%x\n", Ana_Get_Reg(ABB_AFE_PMIC_NEWIF_CFG2));
    seq_printf(m, "ABB_AFE_PMIC_NEWIF_CFG3  = 0x%x\n", Ana_Get_Reg(ABB_AFE_PMIC_NEWIF_CFG3));
    seq_printf(m, "ABB_AFE_TOP_CON0  = 0x%x\n", Ana_Get_Reg(ABB_AFE_TOP_CON0));
    seq_printf(m, "ABB_AFE_MON_DEBUG0  = 0x%x\n", Ana_Get_Reg(ABB_AFE_MON_DEBUG0));
    ...
    seq_printf(m, "SPK_CON10  = 0x%x\n", Ana_Get_Reg(SPK_CON10));
    seq_printf(m, "SPK_CON11  = 0x%x\n", Ana_Get_Reg(SPK_CON11));
    seq_printf(m, "SPK_CON12  = 0x%x\n", Ana_Get_Reg(SPK_CON12));

    seq_printf(m, "CID  = 0x%x\n", Ana_Get_Reg(CID));
    seq_printf(m, "TOP_CKPDN0  = 0x%x\n", Ana_Get_Reg(TOP_CKPDN0));
    seq_printf(m, "TOP_CKPDN0_SET  = 0x%x\n", Ana_Get_Reg(TOP_CKPDN0_SET));
    seq_printf(m, "TOP_CKPDN0_CLR  = 0x%x\n", Ana_Get_Reg(TOP_CKPDN0_CLR));

    seq_printf(m, "TOP_CKPDN1  = 0x%x\n", Ana_Get_Reg(TOP_CKPDN1));
    seq_printf(m, "TOP_CKPDN1_SET  = 0x%x\n", Ana_Get_Reg(TOP_CKPDN1_SET));
    seq_printf(m, "TOP_CKPDN1_CLR  = 0x%x\n", Ana_Get_Reg(TOP_CKPDN1_CLR));
    seq_printf(m, "TOP_CKPDN2  = 0x%x\n", Ana_Get_Reg(TOP_CKPDN2));
    seq_printf(m, "TOP_CKPDN2_SET  = 0x%x\n", Ana_Get_Reg(TOP_CKPDN2_SET));
    seq_printf(m, "TOP_CKPDN2_CLR  = 0x%x\n", Ana_Get_Reg(TOP_CKPDN2_CLR));
    seq_printf(m, "TOP_CKCON1  = 0x%x\n", Ana_Get_Reg(TOP_CKCON1));

    seq_printf(m, "AUDTOP_CON0  = 0x%x\n", Ana_Get_Reg(AUDTOP_CON0));
    seq_printf(m, "AUDTOP_CON1  = 0x%x\n", Ana_Get_Reg(AUDTOP_CON1));
    seq_printf(m, "AUDTOP_CON2  = 0x%x\n", Ana_Get_Reg(AUDTOP_CON2));
    seq_printf(m, "AUDTOP_CON3  = 0x%x\n", Ana_Get_Reg(AUDTOP_CON3));
    seq_printf(m, "AUDTOP_CON4  = 0x%x\n", Ana_Get_Reg(AUDTOP_CON4));
    seq_printf(m, "AUDTOP_CON5  = 0x%x\n", Ana_Get_Reg(AUDTOP_CON5));
    seq_printf(m, "AUDTOP_CON6  = 0x%x\n", Ana_Get_Reg(AUDTOP_CON6));
    seq_printf(m, "AUDTOP_CON7  = 0x%x\n", Ana_Get_Reg(AUDTOP_CON7));
    seq_printf(m, "AUDTOP_CON8  = 0x%x\n", Ana_Get_Reg(AUDTOP_CON8));
    seq_printf(m, "AUDTOP_CON9  = 0x%x\n", Ana_Get_Reg(AUDTOP_CON9));
#endif
...
static int AudDrv_Read_Procmem_open(struct inode *inode, struct file *file)
{
    return single_open(file, AudDrv_Read_show, NULL);
}

static const struct file_operations AudDrv_Read_Procmem_fops = {
    .open   = AudDrv_Read_Procmem_open,
    .read   = seq_read,
    .llseek = seq_lseek,
    .release= seq_release,
};
...
void Auddrv_HDMI_Interrupt_Handler(void)
{
    ...
    if ((Afe_consumed_bytes & 0x0f) != 0)
    {
        PRINTK_AUDDRV("[Auddrv] HDMI DMA address is not aligned 16 bytes \n");
    }
...
static int AudDrv_mod_init(void)
{
    ...
    proc_create("audio", 0, NULL, &AudDrv_Read_Procmem_fops);
