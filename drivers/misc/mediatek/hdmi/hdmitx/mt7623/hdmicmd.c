 ...
 void hdmi_InfoframeSetting (unsigned char i1typemode, unsigned char i1typeselect)
{
  ...
  {	
      HDMI_LOG("Arg1: Infoframe output type\n");
      HDMI_LOG("1: AVi, 2: Mpeg, 3: SPD\n");
      HDMI_LOG("4: Vendor, 5: Audio, 6: ACP\n");
      HDMI_LOG("7: ISRC1, 8: ISRC2,  9:GENERIC \n");
      HDMI_LOG("10:GAMUT \n");	

      HDMI_LOG("Arg2: Infoframe data select\n");	  
      HDMI_LOG("0: old(default), 1: new;\n");		  
      return ;
  }
