...
#define MTK_HDMI_CEC_USR_CMD                    HDMI_IOWR(94, unsigned int)
#define MTK_HDMI_GET_EDID_RAW                   HDMI_IOWR(95, HDMITX_EDID_T)
#define MTK_HDMI_VIDEO_CONFIG_EXT               HDMI_IOWR(96, HDMI_OUT_PARAM_T)
