...
#define IO_PAD_MODE 0x8E0
#define PAD_MODE_HTPLG 0x1 << 9
#define PAD_MODE_MASK 0x7 << 9

#define IO_PAD_PD 0x2F0
#define IO_PAD_HOT_PLUG_PD (1<<11)
#define IO_PAD_EN 0x1C0
...
extern void vChgHDMIVideoResolution(unsigned char ui1resindex, unsigned char ui1colorspace, unsigned char ui1hdmifs, unsigned char bdeepmode);
extern void vChgHDMIAudioOutput(unsigned char ui1hdmifs, unsigned char ui1resindex, unsigned char bdeepmode);
extern void vChgtoSoftNCTS(unsigned char ui1resindex, unsigned char ui1audiosoft, unsigned char ui1hdmifs, unsigned char bdeepmode);
...
extern void vHalSendHdmiPacket(unsigned char bType, bool fgEnable, unsigned char *pr_bData);
