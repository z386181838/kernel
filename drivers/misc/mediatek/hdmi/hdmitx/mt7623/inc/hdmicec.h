...
/* --------FLD help macros, mask32 to mask8,mask16,maskalign ----------*/
#define Fld2Msk32(fld)	/*lint -save -e504 */ ((((unsigned int)1<<Fld_wid(fld))-1)<<Fld_shft(fld)) /*lint -restore */
...
extern void hdmi_cec_api_get_txsts(CEC_ACK_INFO_T *pt);
extern void hdmi_cec_api_get_cmd(CEC_FRAME_DESCRIPTION* frame);
