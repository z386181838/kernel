...
extern void hdmi_appGetEdidRawData(char * edid_buf, int buf_size);
...
extern bool fgIsTxDetectHotPlugIn(void);
extern void vSendHdmiPacket(unsigned char bType, bool fgEnable,  unsigned char *pr_bData);
extern int hdmi_tmdsonoff(unsigned char u1ionoff);
extern bool vIsTmdsOn(void);
