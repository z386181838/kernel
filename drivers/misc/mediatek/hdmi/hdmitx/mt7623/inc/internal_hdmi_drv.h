...
typedef struct
{
	...
	int  (*video_config)(HDMI_VIDEO_RESOLUTION vformat, HDMI_VIDEO_INPUT_FORMAT vin, HDMI_VIDEO_OUTPUT_FORMAT vou,  HDMI_VIDEO_OUT_MODE mode);
	...
	void (*getedidrawdata)(char * edid_buf, int buffer_size);
