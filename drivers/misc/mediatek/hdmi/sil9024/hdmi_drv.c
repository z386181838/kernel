...
int sii9024_power_on(void)	/* sii9024 suspend */
{
	if (0 == ucHdmi_isr_en) {
...
#endif
#if defined(GPIO_HDMI_PWR_1_2V_EN)  /* For 6595, use gpio132 as the 1.2v output enable pin */
		...
		mt_set_gpio_out(GPIO_HDMI_PWR_1_2V_EN, 1);
#else
		/* For 8382,8392, PMIC output 1.2v for 9024 */
