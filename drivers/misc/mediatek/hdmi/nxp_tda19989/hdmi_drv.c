...
static void tda_spy_audio(tmdlHdmiTxAudioInConfig_t *audio)
{
	printk(KERN_INFO
	       ...
	       tda_spy_audio_freq(audio->rate), audio->i2sFormat,
	       tda_spy_audio_i2c4(audio->i2sFormat), audio->i2sQualifier,
	       tda_spy_audio_i2c(audio->i2sQualifier), audio->dstRate, audio->channelAllocation);
}
#endif
/*
 *
