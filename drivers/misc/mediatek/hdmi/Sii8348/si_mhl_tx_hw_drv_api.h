...
typedef enum {
	qs_auto_select_by_color_space = 0, qs_full_range = 1, qs_limited_range = 2, qs_reserved = 3
...
int si_mhl_tx_drv_get_scratch_pad(struct drv_hw_context *hw_context, uint8_t start_reg,
...
#ifdef	NEVER
typedef enum {
	AUTH_IDLE, AUTH_PENDING, AUTH_CURRENT
