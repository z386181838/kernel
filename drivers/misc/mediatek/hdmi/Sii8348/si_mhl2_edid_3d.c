...
{
	MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "Begin MHL display timing enumeration\n");
}
					 ...
					 MHL2_video_descriptor_t mhl2_video_descriptor)
{
	...
	MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
			 ...
			 (uint16_t) bits_per_pixel, vertical_refresh_rate_in_milliHz,
...
{
	MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "End MHL display timing enumeration\n");
}
...
uint32_t si_mhl_tx_find_timings_from_totals(edid_3d_data_p mhl_edid_3d_data)
{
	...
	for (i = 0;
	     i < sizeof(timing_modes_from_data_sheet) / sizeof(timing_modes_from_data_sheet[0]);
	     ++i) {
...
VIC_info_t VIC_info[] = {
	CEA_861_D_VIC_info_entry(0, 0, 0, 0, 0, 0000, iar_16_to_10, vsm_progressive, par_1_to_1,
				 vif_single_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(1, 640, 480, 160, 45, 60000, iar_4_to_3, vsm_progressive,
				       par_1_to_1, vif_dual_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(2, 720, 480, 138, 45, 60000, iar_4_to_3, vsm_progressive,
				       par_8_to_9, vif_dual_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(3, 720, 480, 138, 45, 60000, iar_16_to_9, vsm_progressive,
				       par_32_to_27, vif_dual_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(4, 1280, 720, 370, 30, 60000, iar_16_to_9, vsm_progressive,
				       par_1_to_1, vif_dual_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(5, 1920, 1080, 280, 22, 60000, iar_16_to_9, vsm_interlaced,
				       par_1_to_1, vif_dual_frame_rate, 0, 1)
	    , CEA_861_D_VIC_info_entry(6, 720, 480, 276, 22, 60000, iar_4_to_3, vsm_interlaced,
				       par_8_to_9, vif_dual_frame_rate, 1, 1)
	    , CEA_861_D_VIC_info_entry(7, 720, 480, 276, 22, 60000, iar_16_to_9, vsm_interlaced,
				       par_32_to_27, vif_dual_frame_rate, 1, 1)
	    , CEA_861_D_VIC_info_entry(8, 720, 240, 276, 22, 60000, iar_4_to_3, vsm_progressive,
				       par_4_to_9, vif_dual_frame_rate, 1, 1)
	    , CEA_861_D_VIC_info_entry(9, 720, 428, 276, 22, 60000, iar_16_to_9, vsm_progressive,
				       par_16_to_27, vif_dual_frame_rate, 1, 1)
	    , CEA_861_D_VIC_info_entry(10, 2880, 480, 552, 22, 60000, iar_4_to_3, vsm_interlaced,
				       par_2_to_9_20_to_9, vif_dual_frame_rate, 0, 1)
	    , CEA_861_D_VIC_info_entry(11, 2880, 480, 552, 22, 60000, iar_16_to_9, vsm_interlaced,
				       par_8_to_27_80_to_27, vif_dual_frame_rate, 0, 1)
	    , CEA_861_D_VIC_info_entry(12, 2880, 240, 552, 22, 60000, iar_4_to_3, vsm_progressive,
				       par_1_to_9_10_to_9, vif_dual_frame_rate, 0, 1)
	    , CEA_861_D_VIC_info_entry(13, 2880, 240, 552, 22, 60000, iar_16_to_9, vsm_progressive,
				       par_4_to_27_40_to_27, vif_dual_frame_rate, 0, 1)
	    , CEA_861_D_VIC_info_entry(14, 1440, 480, 276, 45, 60000, iar_4_to_3, vsm_progressive,
				       par_4_to_9, vif_dual_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(15, 1440, 480, 276, 45, 60000, iar_16_to_9, vsm_progressive,
				       par_16_to_27, vif_dual_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(16, 1920, 1080, 280, 45, 60000, iar_16_to_9, vsm_progressive,
				       par_1_to_1, vif_dual_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(17, 720, 576, 144, 49, 50000, iar_4_to_3, vsm_progressive,
				       par_16_to_15, vif_single_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(18, 720, 576, 144, 49, 50000, iar_16_to_9, vsm_progressive,
				       par_64_to_45, vif_single_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(19, 1280, 720, 700, 30, 50000, iar_16_to_9, vsm_progressive,
				       par_1_to_1, vif_single_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(20, 1920, 1080, 720, 22, 50000, iar_16_to_9, vsm_interlaced,
				       par_1_to_1, vif_single_frame_rate, 0, 1)
	    ...
	    , CEA_861_D_VIC_info_entry(25, 2880, 576, 576, 24, 50000, iar_4_to_3, vsm_interlaced,
				       par_2_to_15_20_to_15, vif_single_frame_rate, 0, 1)
	    , CEA_861_D_VIC_info_entry(26, 2880, 576, 576, 24, 50000, iar_16_to_9, vsm_interlaced,
				       par_16_to_45_160_to_45, vif_single_frame_rate, 0, 1)
	    , CEA_861_D_VIC_info_entry(27, 2880, 288, 576, 24, 50000, iar_4_to_3, vsm_progressive,
				       par_1_to_15_10_to_15, vif_single_frame_rate, 0, 2)
	    , CEA_861_D_VIC_info_entry(28, 2880, 288, 576, 24, 50000, iar_16_to_9, vsm_progressive,
				       par_8_to_45_80_to_45, vif_single_frame_rate, 0, 2)
	    , CEA_861_D_VIC_info_entry(29, 1440, 576, 288, 49, 50000, iar_4_to_3, vsm_progressive,
				       par_8_to_15, vif_single_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(30, 1440, 576, 288, 49, 50000, iar_16_to_9, vsm_progressive,
				       par_32_to_45, vif_single_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(31, 1920, 1080, 720, 45, 50000, iar_16_to_9, vsm_progressive,
				       par_1_to_1, vif_single_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(32, 1920, 1080, 830, 45, 24000, iar_16_to_9, vsm_progressive,
				       par_1_to_1, vif_dual_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(33, 1920, 1080, 720, 45, 25000, iar_16_to_9, vsm_progressive,
				       par_1_to_1, vif_single_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(34, 1920, 1080, 280, 45, 30000, iar_16_to_9, vsm_progressive,
				       par_1_to_1, vif_dual_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(35, 2880, 480, 552, 45, 60000, iar_4_to_3, vsm_progressive,
				       par_2_to_9, vif_dual_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(36, 2880, 480, 552, 45, 60000, iar_16_to_9, vsm_progressive,
				       par_8_to_27, vif_dual_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(37, 2880, 576, 576, 49, 50000, iar_4_to_3, vsm_progressive,
				       par_4_to_15, vif_single_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(38, 2880, 576, 576, 49, 50000, iar_16_to_9, vsm_progressive,
				       par_16_to_45, vif_single_frame_rate, 0, 0)
	    ...
	    , CEA_861_D_VIC_info_entry(40, 1920, 1080, 720, 22, 100000, iar_16_to_9, vsm_interlaced,
				       par_1_to_1, vif_single_frame_rate, 0, 1)
	    , CEA_861_D_VIC_info_entry(41, 1280, 720, 700, 30, 100000, iar_16_to_9, vsm_progressive,
				       par_1_to_1, vif_single_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(42, 720, 576, 144, 49, 100000, iar_4_to_3, vsm_progressive,
				       par_16_to_15, vif_single_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(43, 720, 576, 144, 49, 100000, iar_16_to_9, vsm_progressive,
				       par_64_to_45, vif_single_frame_rate, 0, 0)
	    ...
	    , CEA_861_D_VIC_info_entry(46, 1920, 1080, 280, 22, 120000, iar_16_to_9, vsm_interlaced,
				       par_1_to_1, vif_dual_frame_rate, 0, 1)
	    , CEA_861_D_VIC_info_entry(47, 1280, 720, 370, 30, 120000, iar_16_to_9, vsm_progressive,
				       par_1_to_1, vif_dual_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(48, 720, 480, 138, 45, 120000, iar_4_to_3, vsm_progressive,
				       par_8_to_9, vif_dual_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(49, 720, 480, 138, 45, 120000, iar_16_to_9, vsm_progressive,
				       par_32_to_27, vif_dual_frame_rate, 0, 0)
	    ...
	    , CEA_861_D_VIC_info_entry(52, 720, 576, 144, 49, 200000, iar_4_to_3, vsm_progressive,
				       par_16_to_15, vif_single_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(53, 720, 576, 144, 49, 200000, iar_16_to_9, vsm_progressive,
				       par_64_to_45, vif_single_frame_rate, 0, 0)
	    ...
	    , CEA_861_D_VIC_info_entry(56, 720, 480, 138, 45, 240000, iar_4_to_3, vsm_progressive,
				       par_8_to_9, vif_dual_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(57, 720, 480, 138, 45, 240000, iar_16_to_9, vsm_progressive,
				       par_32_to_27, vif_dual_frame_rate, 0, 0)
	    ...
	    , CEA_861_D_VIC_info_entry(60, 1280, 720, 370, 30, 24000, iar_16_to_9, vsm_progressive,
				       par_1_to_1, vif_dual_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(61, 1280, 720, 370, 30, 25000, iar_16_to_9, vsm_progressive,
				       par_1_to_1, vif_single_frame_rate, 0, 0)
	    , CEA_861_D_VIC_info_entry(62, 1280, 720, 370, 30, 30000, iar_16_to_9, vsm_progressive,
				       par_1_to_1, vif_dual_frame_rate, 0, 0)
			       ...
			       uint32_t vertical_sync_frequency_in_milliHz, uint8_t VIC)
{
	...
	if (0 == VIC) {
		...
		if (vsm_interlaced == VIC_info[VIC].fields.interlaced) {
			 ...
			 */
			v_blank_in_lines =
			    VIC_info[VIC].v_blank_in_pixels + VIC_info[VIC].fields.field2_v_blank;
		}
		v_total_in_lines = VIC_info[VIC].rows + v_blank_in_lines;
		vertical_active_period_in_microseconds =
		    (vertical_sync_period_in_microseconds * VIC_info[VIC].rows) / v_total_in_lines;
	...
	vertical_blank_period_in_microseconds =
	    vertical_sync_period_in_microseconds - vertical_active_period_in_microseconds;
	MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
	...
	if (0 == VIC) {
		...
		uint16_t h_clocks;
		h_clocks =
		    VIC_info[VIC].columns << VIC_info[VIC].fields.clocks_per_pixel_shift_count;
		h_total_in_pixels = h_clocks + VIC_info[VIC].h_blank_in_pixels;
		horizontal_active_period_in_nanoseconds =
		    (horizontal_sync_period_in_nanoseconds * h_clocks) / h_total_in_pixels;
	}
	/* rigorous calculation: */
	horizontal_blank_period_in_nanoseconds =
	    horizontal_sync_period_in_nanoseconds - horizontal_active_period_in_nanoseconds;
	MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
...
uint8_t qualify_pixel_clock_for_mhl(edid_3d_data_p mhl_edid_3d_data, uint32_t pixel_clock_frequency,
				    uint8_t bits_per_pixel)
{
...
#define DTD_Demoresolution
	...
	const uint8_t DemodetailTiming[18] =
	    { 0x01, 0x1D, 0x00, 0x72, 0x51, 0xD0, 0x1E, 0x20, 0x6E, 0x28, 0x55, 0x00, 0xC4, 0x8E,
0x21, 0x00, 0x00, 0x1E };
	...
	MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
			 " si_peer_supports_packed_pixel(mhl_edid_3d_data->dev_context) :0x%02x\n",
		...
		for (i = 0; i < limit - 1; ++i) {
			...
			if ((0 != p_desc->dtd.pixel_clock_low)
				...
				if ((0 == p_desc->dtd.horz_active_7_0)
					...
					P_18_byte_descriptor_u pHolder = p_desc, pNextDesc =
					    p_desc + 1;
					uint8_t j;
			...
			if ((p_desc->dtd.pixel_clock_high > 0x20)
			    && (!si_peer_supports_packed_pixel(mhl_edid_3d_data->dev_context)))
...
static bool si_mhl_tx_parse_detailed_timing_descriptor(edid_3d_data_p mhl_edid_3d_data,
						       P_18_byte_descriptor_u p_desc,
						       uint8_t Block, uint8_t *p_is_timing,
						       PMHL2_video_descriptor_t
						       pMHL2_video_descriptor)
{
	uint8_t tmp_byte;
	uint8_t i;
	...
	if (tmp_word == 0x00) {
		...
		if (Block == EDID_BLOCK_0) {
			if (0xFC == p_desc->name.data_type_tag) {
				MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "Monitor Name: ");

				for (i = 0; i < 13; i++) {
/* TODO: FD, TBI */
					printk("%c", p_desc->name.ascii_name[i]);	/* Display monitor name */
#if 0
					MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "%c", p_desc->name.ascii_name[i]);	/* Display monitor name */
#endif
				}
				MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "\n");
		...
		*p_is_timing = 1;
		...
		columns =
		    ...
		    256 * p_desc->dtd.horz_active_blanking_high.horz_active_11_8;
		MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "Horizontal Active Pixels: %d\n",
				 columns);

		tmp_word =
		    p_desc->dtd.horz_blanking_7_0 +
		    256 * p_desc->dtd.horz_active_blanking_high.horz_blanking_11_8;
		MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
		...
		rows =
		    ...
		    256 * p_desc->dtd.vert_active_blanking_high.vert_active_11_8;
		MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "Vertical Active (Lines): %u\n",
				 rows);

		tmp_word =
		    p_desc->dtd.vert_blanking_7_0 +
		    256 * p_desc->dtd.vert_active_blanking_high.vert_blanking_11_8;
		MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "Vertical Blanking (Lines): %u\n",
				 tmp_word);

		vertical_sync_period_in_lines = rows + tmp_word;
		vertical_refresh_rate_in_milliHz =
		    horizontal_sync_frequency_in_Hz * 1000 / (vertical_sync_period_in_lines);
		MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
		...
		tmp_word =
		    ...
		    256 *
		    p_desc->dtd.hs_offset_hs_pulse_width_vs_offset_vs_pulse_width.
		...
		case 0x0:
			MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "Analog Composite\n");
			break;
		case 0x1:
			MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
			...
			break;
		case 0x2:
			MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "Digital Composite\n");
			break;
		case 0x3:
			MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "Digital Separate\n");
			break;
		}
		if (pMHL2_video_descriptor) {
			uint8_t this_mode_doable = 0;
			if ((this_mode_doable =
			     qualify_pixel_clock_for_mhl((void *)mhl_edid_3d_data,
...
static uint8_t si_mhl_tx_parse_861_long_descriptors(edid_3d_data_p mhl_edid_3d_data,
						    uint8_t *p_EDID_block_data)
{
	...
	if (!p_CEA_extension->byte_offset_to_18_byte_descriptors) {
		MHL_TX_DBG_ERR(mhl_edid_3d_data->dev_context, "EDID -> No Detailed Descriptors\n");
		...
		while ((uint8_t *) (p_data_u.p_long_descriptors + 1) < puc_next_block) {
			...
			if (!si_mhl_tx_parse_detailed_timing_descriptor
			    (mhl_edid_3d_data, p_data_u.p_long_descriptors, EDID_BLOCK_2_3,
			     &is_timing, NULL)) {
				break;
			}
			p_data_u.p_long_descriptors++;
...
static void si_mhl_tx_prune_edid(edid_3d_data_p mhl_edid_3d_data)
{
	...
	PCEA_extension_t p_CEA_extension =
	    (PCEA_extension_t) &mhl_edid_3d_data->EDID_block_data[EDID_BLOCK_SIZE];
	...
	MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "mhl_tx: %s\n", __func__);
	...
	si_mhl_tx_prune_dtd_list(mhl_edid_3d_data,
				 (P_18_byte_descriptor_u) &p_EDID_block_0->
	...
	if (mhl_edid_3d_data->parse_data.p_3d_mask) {
		...
		uint32_t mask32;
		int8_t index =
		    mhl_edid_3d_data->parse_data.p_video_data_blocks_2d[0]->header.fields.
		    length_following_header - 1;
		...
		for (; index >= 8; mask32 >>= 1, lower_mask >>= 1, --index) {
			if (0 ==
				...
				lower_bits =
				    lower_mask & mhl_edid_3d_data->parse_data.p_3d_mask->
				    _3D_mask_15_8;

				/* and out the bit in question */
				upper_bits =
				    upper_mask & mhl_edid_3d_data->parse_data.p_3d_mask->
				    _3D_mask_15_8;

				/* adjust the positions of the upper bits */
				upper_bits >>= 1;

				mhl_edid_3d_data->parse_data.p_3d_mask->_3D_mask_15_8 =
				    lower_bits | upper_bits;
				MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
						 "3d mask 15..8: 0x%02x",
						 (uint16_t) mhl_edid_3d_data->parse_data.p_3d_mask->
						 _3D_mask_15_8);
			}
		}
		MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
	...
	if (mhl_edid_3d_data->parse_data.p_three_d) {
		...
		MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
				 "num_3D_structure_bytes_pruned:0x%x " "byte14: 0x%02x "
				 "offset to DTDs: 0x%x " "vsdb header: 0x%x\n",
				 num_3D_structure_bytes_pruned,
	...
	if (mhl_edid_3d_data->parse_data.p_byte_13_through_byte_15) {
		uint8_t length_VIC =
		    mhl_edid_3d_data->parse_data.p_byte_13_through_byte_15->byte14.HDMI_VIC_len;
		...
		if (0 == length_VIC) {
			...
			for (i = 0; i < outer_loop_limit;) {
				if (0 ==
					...
					for (prev = i, j = i + 1; j < inner_loop_limit; ++j, ++prev) {
						...
						VIC1 =
						    mhl_edid_3d_data->parse_data.
						    p_byte_13_through_byte_15->vicList[j];
						MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
			...
			DUMP_EDID_BLOCK(0, p_CEA_extension, sizeof(*p_CEA_extension))
				...
				while (pb_src < pb_limit) {
					MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
							 ...
							 pb_dest, (uint16_t) *pb_dest, pb_src,
							 (uint16_t) *pb_src);
					*pb_dest++ = *pb_src++;
				}
			...
			if (mhl_edid_3d_data->parse_data.p_HDMI_vsdb) {
				mhl_edid_3d_data->parse_data.p_HDMI_vsdb->header.fields.
				    length_following_header -= num_HDMI_VICs_pruned;
	...
	/* Now prune the SVD list and move the CEA 861-D data blocks and DTDs up */
	{
		...
		for (vdb_index = mhl_edid_3d_data->parse_data.num_video_data_blocks - 1;
			...
			uint8_t inner_loop_limit =
			    mhl_edid_3d_data->parse_data.p_video_data_blocks_2d[vdb_index]->header.
			...
			if (inner_loop_limit) {
				...
				for (i = 0; i < outer_loop_limit;) {
					if (0 ==
					    mhl_edid_3d_data->parse_data.
					    p_video_data_blocks_2d[vdb_index]->short_descriptors[i].
					    VIC) {
						uint8_t j, prev;
						num_CEA_VICs_pruned++;
						for (prev = i, j = i + 1; j < inner_loop_limit;
						     ++j, ++prev) {
							uint16_t VIC0, VIC1;
							...
							MHL_TX_EDID_INFO(mhl_edid_3d_data->
									 dev_context,
				...
				{	/* no semicolon needed here */
					...
					uint8_t *pb_src =
					    (uint8_t *) &mhl_edid_3d_data->parse_data.
					    p_video_data_blocks_2d[vdb_index]->
					    short_descriptors[mhl_edid_3d_data->parse_data.
							      p_video_data_blocks_2d[vdb_index]->
							      header.fields.
							      length_following_header];
	...
	p_EDID_block_0->checksum =
	    calculate_generic_checksum((uint8_t *) p_EDID_block_0, 0, sizeof(*p_EDID_block_0));

	p_CEA_extension->checksum =
	    calculate_generic_checksum((uint8_t *) p_CEA_extension, 0, sizeof(*p_CEA_extension));
				 ...
				 PMHL2_video_descriptor_t p_mhl2_video_descriptor)
{
	...
	if (VIC > 0) {
		ret_val =
		    is_MHL_timing_mode(mhl_edid_3d_data, VIC_info[VIC].columns, VIC_info[VIC].rows,
				       VIC_info[VIC].field_rate_in_milliHz, p_mhl2_video_descriptor,
				       VIC);
		if (vif_dual_frame_rate == VIC_info[VIC].fields.frame_rate_info) {
			...
			ret_val |=
			    is_MHL_timing_mode(mhl_edid_3d_data, VIC_info[VIC].columns,
					       VIC_info[VIC].rows, field_rate_in_milliHz,
					       p_mhl2_video_descriptor, VIC);
		}
	}
	return ret_val;
}
...
void si_mhl_tx_enumerate_hdmi_vsdb(edid_3d_data_p mhl_edid_3d_data)
{
	...
	if (mhl_edid_3d_data->parse_data.p_HDMI_vsdb) {
		...
		if (mhl_edid_3d_data->parse_data.p_byte_13_through_byte_15) {
			if (((uint8_t *) &mhl_edid_3d_data->parse_data.p_byte_13_through_byte_15->
			     byte13) < p_next_db) {
				uint8_t hdmi3D_present =
				    mhl_edid_3d_data->parse_data.p_byte_13_through_byte_15->byte13.
				    _3D_present;
				...
				if (((uint8_t *) &mhl_edid_3d_data->parse_data.
				     p_byte_13_through_byte_15->byte14) < p_next_db) {
					uint8_t length_VIC;
					uint8_t index;
					MHL2_video_descriptor_t mhl2_video_descriptor;
					length_VIC =
					...
					for (index = 0; index < length_VIC; ++index) {
						...
						VIC =
						    mhl_edid_3d_data->parse_data.
						    p_byte_13_through_byte_15->vicList[index];
						if (!is_qualified_mhl_hdmi_vic
						    (mhl_edid_3d_data, VIC,
						     &mhl2_video_descriptor)) {
							MHL_TX_EDID_INFO(mhl_edid_3d_data->
									 dev_context,
									 "'can't do HDMI VIC:%d\n",
									 (uint16_t) VIC);
					...
					if (hdmi3D_present) {
						...
						length_3D =
						    mhl_edid_3d_data->parse_data.
						    p_byte_13_through_byte_15->byte14.HDMI_3D_len;
						limit =
						    mhl_edid_3d_data->parse_data.
						...
						case 0x01:
							 ...
							 */
							{
								P_3D_structure_all_t
								    ...
								    p_byte_13_through_byte_15->
								    vicList[length_VIC];
								mhl2_video_descriptor.left_right =
								    p_3D_structure_all->
								    _3D_structure_all_7_0.
								    side_by_side;
								mhl2_video_descriptor.top_bottom =
								    p_3D_structure_all->
								    _3D_structure_all_15_8.
								    top_bottom;
								mhl2_video_descriptor.
								    frame_sequential =
								    p_3D_structure_all->
...
;
						...
						mhl_edid_3d_data->parse_data.p_three_d =
						    p_3D_u.p_3D;
						mhl_edid_3d_data->parse_data.p_3d_limit =
						    &p_3D_u.p_as_bytes[length_3D];
						DUMP_EDID_BLOCK(0, (PCEA_extension_t) &mhl_edid_3d_data->EDID_block_data[EDID_BLOCK_SIZE], EDID_BLOCK_SIZE)	/* no semicolon needed here */
						    while (p_3D_u.p_as_bytes <
							   mhl_edid_3d_data->parse_data.
							   p_3d_limit) {
							uint8_t _2D_VIC_order =
							    p_3D_u.p_sans_byte_1->byte0.
							    _2D_VIC_order;
							_3D_structure_e _3D_structure =
							    p_3D_u.p_sans_byte_1->byte0.
							    _3D_structure;
							uint8_t VIC;
							VIC =
...
/*
*/
void si_mhl_tx_process_3d_vic_burst(void *context, PMHL2_video_format_data_t p_write_burst_data	/* from 3D_REQ */
    )
{
			...
			DUMP_EDID_BLOCK(0, (PCEA_extension_t) &mhl_edid_3d_data->EDID_block_data[EDID_BLOCK_SIZE], EDID_BLOCK_SIZE)	/* no semicolon needed here */
				...
				if (mhl_edid_3d_data->parse_data.vic_2d_index >=
				    ...
				    p_video_data_blocks_2d[mhl_edid_3d_data->parse_data.
							   video_data_block_index]->header.fields.
				    length_following_header) {
					mhl_edid_3d_data->parse_data.video_data_block_index++;
					if (mhl_edid_3d_data->parse_data.video_data_block_index >=
					    mhl_edid_3d_data->parse_data.num_video_data_blocks) {
				...
				p_mhl2_video_descriptor =
				    &p_write_burst_data->video_descriptors[block_index];
				VIC =
				    mhl_edid_3d_data->parse_data.
				    p_video_data_blocks_2d[mhl_edid_3d_data->parse_data.
							   video_data_block_index]->
				    short_descriptors[mhl_edid_3d_data->parse_data.vic_2d_index].
				    VIC;
				...
				if (VIC) {
					MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
							 ...
							 psz_space);
					this_mode_doable =
					    IsQualifiedMhlVIC(mhl_edid_3d_data, VIC,
							      p_mhl2_video_descriptor);
					if (!this_mode_doable) {
	...
	if (mhl_edid_3d_data->parse_data.flags.parse_3d_in_progress) {
		if (!TEST_3D_FLAG(mhl_edid_3d_data, FLAGS_BURST_3D_DTD_VESA_DONE)) {
			PEDID_block0_t p_EDID_block_0 =
			    (PEDID_block0_t) &mhl_edid_3d_data->EDID_block_data[0];
			/*
			...
			for (/* burst_index is set to zero above */
				...
				P_18_byte_descriptor_u p_desc =
				    (P_18_byte_descriptor_u) &p_EDID_block_0->
				    detailed_timing_descriptors[mhl_edid_3d_data->parse_data.
								vesa_dtd_index];
				bool is_valid = 0;

				p_mhl2_video_descriptor =
				    &p_write_burst_data->video_descriptors[burst_index];
				is_valid =
			...
			if (mhl_edid_3d_data->parse_data.vesa_dtd_index >=
				...
				check_3d_dtd_sequence_done(mhl_edid_3d_data, p_write_burst_data,
							   dtd_limit);
		...
		}
		{
			...
			MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
					 ...
					 p_write_burst_data->total_entries, dtd_limit,
					 p_CEA_extension->byte_offset_to_18_byte_descriptors);
			...
			for (/* burst_index is set to zero above */
				...
				P_18_byte_descriptor_u p_desc =
				    &p_data_u.p_long_descriptors[mhl_edid_3d_data->parse_data.
								 cea_861_dtd_index];
				bool is_valid = 0;
				p_mhl2_video_descriptor =
				    &p_write_burst_data->video_descriptors[burst_index];
			...
			MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "DTD burst complete\n");
...
static void si_mhl_tx_parse_established_timing(edid_3d_data_p mhl_edid_3d_data,
					       PEDID_block0_t p_EDID_block_0)
{
	...
	MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "Parsing Established Timing:\n");
	MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "===========================\n");


	DUMP_OFFSET(mhl_edid_3d_data, EDID_block0_t, established_timings_I)
	    /* no semicolon needed here ... ... see macro */
		...
		MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "No established video modes\n");
	}
}
...
static void si_mhl_tx_parse_standard_timing(edid_3d_data_p mhl_edid_3d_data,
					    PEDID_block0_t p_EDID_block_0)
{
	uint8_t i;
	uint8_t AR_code;
	...
	for (i = 0;
	     i <
	     sizeof(p_EDID_block_0->standard_timings) / sizeof(p_EDID_block_0->standard_timings[0]);
	     i += 2) {
		if ((1 == p_EDID_block_0->standard_timings[i].horz_pix_div_8_minus_31)
			...
			uint16_t refresh_rate_in_milliHz =
			    (uint16_t) (p_EDID_block_0->standard_timings[i].
					field_refresh_rate_minus_60 + 60) * 1000;
			...
			if (!is_MHL_timing_mode
			    (mhl_edid_3d_data, horz_active, vert_active, refresh_rate_in_milliHz,
			     NULL, 0)) {
				/* disable this mode */
				...
				MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "Disabled\n\n");
			}
		}
	}
}
...
static void si_mhl_tx_parse_block_zero_timing_descriptors(edid_3d_data_p mhl_edid_3d_data,
							  PEDID_block0_t p_EDID_block_0)
{
	uint8_t i;
	uint8_t is_timing = 0;
	...
	for (i = 0;
		...
		si_mhl_tx_parse_detailed_timing_descriptor(mhl_edid_3d_data,
							   ...
							   p_EDID_block_0->
							   detailed_timing_descriptors[i],
							   EDID_BLOCK_0, &is_timing, NULL);
	}
}
					...
					PEDID_block0_t p_EDID_block_0)
{
	...
	for (i = EDID_OFFSET_HEADER_FIRST_FF; i <= EDID_OFFSET_HEADER_LAST_FF; i++) {
		if (0xFF != p_EDID_block_0->header_data[i]) {
			DUMP_EDID_BLOCK(1, p_EDID_block_0, sizeof(*p_EDID_block_0))
			    MHL_TX_DBG_ERR(mhl_edid_3d_data->dev_context, "EDID -1 check failed\n");
			return false;
		}
	}
	...
	if (0x00 != p_EDID_block_0->header_data[EDID_OFFSET_HEADER_LAST_00]) {
		DUMP_EDID_BLOCK(1, p_EDID_block_0, sizeof(*p_EDID_block_0))
		    MHL_TX_DBG_ERR(mhl_edid_3d_data->dev_context, "EDID 0 last check failed\n");
		return false;
	}
...
void SiiMhlTxMakeItDVI(edid_3d_data_p mhl_edid_3d_data, PEDID_block0_t p_EDID_block_0)
{
	...
	MHL_TX_DBG_ERR(mhl_edid_3d_data->dev_context, "EDID: second block now all 0xFF\n");
}
...
static void SiiMhlTx3dReqForNonTranscodeMode(edid_3d_data_p mhl_edid_3d_data)
{
	...
	if (mhl_edid_3d_data->parse_data.HDMI_sink) {
		if (0x20 <= si_get_peer_mhl_version(mhl_edid_3d_data->dev_context)) {
			MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "MHL 2.x sink detected\n");
			...
			si_mhl_tx_set_int(mhl_edid_3d_data->dev_context, MHL_RCHANGE_INT,
					  MHL2_INT_3D_REQ, 0);
			...
			MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "MHL 1.x sink detected\n");
...
static uint8_t parse_861_short_descriptors(edid_3d_data_p mhl_edid_3d_data,
					   uint8_t *p_EDID_block_data)
{
	uint8_t i;
	PCEA_extension_t p_CEA_extension = (PCEA_extension_t) p_EDID_block_data;
	...
	if (EDID_EXTENSION_TAG != p_CEA_extension->tag) {
		MHL_TX_DBG_ERR(mhl_edid_3d_data->dev_context, "EDID -> Non-CEA Extension\n");
		...
		if (EDID_REV_THREE != p_CEA_extension->revision) {
			...
			PCEA_extension_version_3_t p_CEA_extension_version_3 =
			    &p_CEA_extension->version_u.version3;
			union {
				uint8_t *puc_data_block;
			...
			p_data_u.puc_data_block =
			    &p_CEA_extension->version_u.version3.Offset4_u.data_block_collection[0];
			...
			while (p_data_u.puc_data_block < puc_long_descriptors) {
				...
				data_block_length =
				    p_data_u.p_CEA_data_block->header.fields.
				    length_following_header;
				MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
				...
				case DBTC_AUDIO_DATA_BLOCK:
					{
						...
						while (i <
							...
							mhl_edid_3d_data->parse_data.
							    audio_descriptors[A_descriptor_index]
							    = p_audio_data_block->
				...
				case DBTC_SPEAKER_ALLOCATION_DATA_BLOCK:
					{
						Pspeaker_allocation_data_block_t
						    p_speaker_allocation_data_block =
						    (Pspeaker_allocation_data_block_t) p_data_u.
						    puc_data_block;

						*((Pspeaker_allocation_flags_t) &mhl_edid_3d_data->
						  parse_data.speaker_alloc[i++]) =
  p_speaker_allocation_data_block->payload.speaker_alloc_flags;
				...
				case DBTC_USE_EXTENDED_TAG:
					{
						...
						extended_tag_code =
						    p_data_u.p_CEA_data_block->payload_u.
						    extended_tag;
				...
				case DBTC_VENDOR_SPECIFIC_DATA_BLOCK:
					{
						P_vsdb_t p_vsdb =
						    (P_vsdb_t) p_data_u.puc_data_block;
						uint8_t *puc_next_db =
						    ((uint8_t *) &p_vsdb->header) +
		       ...
		       p_HDMI_vendor_specific_payload->D_C;
				...
				p_data_u.puc_data_block +=
				    sizeof(p_data_u.p_CEA_data_block->header) + data_block_length;
			}
...
static uint8_t parse_861_block(edid_3d_data_p mhl_edid_3d_data, uint8_t *p_EDID_block_data)
{
	...
	if (EDID_EXTENSION_BLOCK_MAP == p_CEA_extension->tag) {
		...
		/* adjust */
		err_code =
		    si_mhl_tx_parse_861_long_descriptors(mhl_edid_3d_data, p_EDID_block_data);
						   ...
						   struct cbus_req *req)
{
	...
	MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "EDID -> Number of 861 Extensions = %d\n",
	...
	if (0 == p_EDID_block_0->extension_flag) {
		...
		for (counter = 1; counter <= mhl_edid_3d_data->parse_data.num_EDID_extensions;
		     ++counter) {
			MHL_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
					 " counter:%d tag:place holder EDID block:%p\n", counter,
					 &mhl_edid_3d_data->EDID_block_data[EDID_BLOCK_SIZE *
									    counter]);
			Result =
...
int si_mhl_tx_get_num_cea_861_extensions(void *context, uint8_t block_number)
{
	...
	uint8_t limit_blocks = sizeof(mhl_edid_3d_data->EDID_block_data) / EDID_BLOCK_SIZE;
...
{
	return calculate_pixel_clock(context, (uint16_t) VIC_info[vic].columns,
...
void dump_EDID_block_impl(const char *pszFunction, int iLineNum, uint8_t override, uint8_t *pData,
			  uint16_t length)
{
	uint16_t i;
	...
	for (i = 0; i < length;) {
		...
		for (j = 0; (j < 16) && (temp < length); ++j, ++temp) {
			printk("%c",
			       ((pData[temp] >= ' ') && (pData[temp] <= 'z')) ? pData[temp] : '.');
		}
		printk("\n");
	}
}
