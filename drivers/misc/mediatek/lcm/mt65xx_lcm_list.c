...
#endif
#if defined(CONFIG_NT51012_WXGA_DSI_VDO)
...
#if  defined(NT51012_WXGA_DSI_VDO)
	&nt51012_wxga_dsi_vdo_lcm_drv,
#endif
...
#if defined(CONFIG_HX8392A_DSI_VDO)
...
#if defined(CONFIG_CPT_CLAP070WP03XG_LVDS)
