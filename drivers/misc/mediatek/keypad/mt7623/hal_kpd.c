...
#include <mach/mt_clkmgr.h>
        ...
        #undef GPIO_KPD_KROW0_PIN
    #endif
    #ifdef GPIO_KPD_KROW1_PIN
        #undef GPIO_KPD_KROW1_PIN
    #endif
    #ifdef GPIO_KPD_KROW2_PIN
        #undef GPIO_KPD_KROW2_PIN
    #endif
    #ifdef GPIO_KPD_KROW3_PIN
        #undef GPIO_KPD_KROW3_PIN
    #endif
    #ifdef GPIO_KPD_KROW4_PIN
        #undef GPIO_KPD_KROW4_PIN
    #endif
    #ifdef GPIO_KPD_KROW5_PIN
        #undef GPIO_KPD_KROW5_PIN
    #endif
    #ifdef GPIO_KPD_KROW6_PIN
        #undef GPIO_KPD_KROW6_PIN
    #endif
    #ifdef GPIO_KPD_KROW7_PIN
        #undef GPIO_KPD_KROW7_PIN
    #endif
    #ifdef GPIO_KPD_KCOL0_PIN
        #undef GPIO_KPD_KCOL0_PIN
    #endif
    #ifdef GPIO_KPD_KCOL1_PIN
        #undef GPIO_KPD_KCOL1_PIN
    #endif
    #ifdef GPIO_KPD_KCOL2_PIN
        #undef GPIO_KPD_KCOL2_PIN
    #endif
    #ifdef GPIO_KPD_KCOL3_PIN
        #undef GPIO_KPD_KCOL3_PIN
    #endif
    #ifdef GPIO_KPD_KCOL4_PIN
        #undef GPIO_KPD_KCOL4_PIN
    #endif
    #ifdef GPIO_KPD_KCOL5_PIN
        #undef GPIO_KPD_KCOL5_PIN
    #endif
    #ifdef GPIO_KPD_KCOL6_PIN
        #undef GPIO_KPD_KCOL6_PIN
    #endif
    #ifdef GPIO_KPD_KCOL7_PIN
        #undef GPIO_KPD_KCOL7_PIN
    #endif
    
    #define GPIO_KPD_KROW0_PIN  (GPIO33 | 0x80000000)
    #define GPIO_KPD_KROW1_PIN  (GPIO34 | 0x80000000)
    #define GPIO_KPD_KROW2_PIN  (GPIO35 | 0x80000000)
    #define GPIO_KPD_KCOL0_PIN  (GPIO36 | 0x80000000)
    #define GPIO_KPD_KCOL1_PIN  (GPIO37 | 0x80000000)
    #define GPIO_KPD_KCOL2_PIN  (GPIO38 | 0x80000000)
#endif
...
void mtk_kpd_gpios_get(unsigned int ROW_REG[], unsigned int COL_REG[])
{
    ...
    for(i = 0; i< 8; i++)
    {
        printk("ROW_REG[%d]=%08X\n", i, ROW_REG[i]);
        printk("COL_REG[%d]=%08X\n", i, COL_REG[i]);
    }
    #endif
}
...
{
    //sean added for disable the function of long press and CPU reset
return ;
