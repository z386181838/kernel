...
static char* m4u_get_port_name(M4U_PORT_ID_ENUM portID)
{
   ...
   switch(portID)
	...
	case MDP_RDMA1           :   return "MDP_RDMA1"           ;

        case VDEC_MC_EXT         :   return "VDEC_MC_EXT"         ;
        case VDEC_PP_EXT         :   return "VDEC_PP_EXT"         ;
	case VDEC_PPWRAP_EXT     :   return "VDEC_PPWRAP_EXT"     ;
        ...
        case VDEC_VLD2_EXT       :   return "VDEC_VLD2_EXT"       ;
        case VDEC_TILE_EXT       :   return "VDEC_TILE_EXT"       ;
        case VDEC_IMG_RESZ_EXT   :   return "VDEC_IMG_RESZ_EXT"   ;
        ...
        case VENC_LT_RCPU        :   return "VENC_LT_RCPU"        ;
        case VENC_LT_REC_FRM     :   return "VENC_LT_REC_FRM"     ;
        case VENC_LT_BSDMA       :   return "VENC_LT_BSDMA"       ;
        case JPGDEC_BSDMA        :   return "JPGDEC_BSDMA"        ;
	...
	case VENC_CUR_CHROMA	 :   return "VENC_CUR_CHROMA"	  ;
        ...
        case IMG_RESZ            :   return "IMG_RESZ"            ;
        case VENC_LT_SV_COMV     :   return "VENC_LT_SV_COMV"     ;
        case VENC_LT_RD_COMV     :   return "VENC_LT_RD_COMV"     ;
        case VENC_LT_CUR_LUMA    :   return "VENC_LT_CUR_LUMA"    ;
        case VENC_LT_CUR_CHROMA  :   return "VENC_LT_CUR_CHROMA"  ;
        case VENC_LT_REF_LUMA    :   return "VENC_LT_REF_LUMA"    ;
        case VENC_LT_REF_CHROMA  :   return "VENC_LT_REF_CHROMA"  ;
        case JPGDEC_WDMA         :   return "JPGDEC_WDMA"        ;
