...
#define MSDC_DBGZONE_DBGDRV        (1 << 17)
#define MSDC_DBGZONE_MISCDRV       (1 << 18)
#define MSDC_DBGZONE_OTPDRV        (1 << 19)
...
#define STR_MSDC_DBGDRV             "DBGDRV"
#define STR_MSDC_MISCDRV            "MISCDRV"
#define STR_MSDC_OTPDRV             "OTPDRV"
...
#define MSDC_DBGDRV                MSDCDBGZONE(MSDC_DBGZONE_DBGDRV)
#define MSDC_MISCDRV               MSDCDBGZONE(MSDC_DBGZONE_MISCDRV)
#define MSDC_OTPDRV                MSDCDBGZONE(MSDC_DBGZONE_OTPDRV)

//#define MSDC_DBGZONE_RELEASE      MSDC_DBGZONE_FUNC | MSDC_DBGZONE_CONFIG | MSDC_DBGZONE_DEBUG |  MSDC_DBGZONE_GPIO |  MSDC_DBGZONE_HREG |   MSDC_DBGZONE_INIT|MSDC_DBGZONE_ERROR|MSDC_DBGZONE_INFO\
//	                              |MSDC_DBGZONE_DBGDRV|MSDC_DBGZONE_MISCDRV|MSDC_DBGZONE_OTPDRV|MSDC_DBGZONE_STACK|MSDC_DBGZONE_DREG

#define MSDC_DBGZONE_RELEASE        MSDC_DBGZONE_INIT|MSDC_DBGZONE_ERROR|MSDC_DBGZONE_INFO\
	                              |MSDC_DBGZONE_DBGDRV|MSDC_DBGZONE_MISCDRV|MSDC_DBGZONE_OTPDRV
...
MSDCDBGZNHELPER  g_MsdcZnHelper = {
		{  STR_MSDC_INIT,    STR_MSDC_WARNING,   STR_MSDC_ERROR,   STR_MSDC_INFO,
	       ...
	       STR_MSDC_GPIO,    STR_MSDC_DBGDRV,    STR_MSDC_MISCDRV, STR_MSDC_OTPDRV,
...
#else
#define MSDC_TRC_PRINT(cond, fmt, ...)   \
   ((void)((cond)? (xlog_printk(ANDROID_LOG_ERROR, "%s: KN@MSDC "fmt" <- L<%d> PID<%s><0x%x>\n", MSDC_FILTER_NAME(cond),\
   				     ##__VA_ARGS__, __LINE__, current->comm, current->pid),1):0))

#define MSDC_ERR_PRINT(cond, fmt, ...)	 \
						((void)((cond)?(xlog_printk(ANDROID_LOG_ERROR, "***ERROR:%s:"WHEREDOESMSDCRUN": %s line %d: "fmt" <- PID<%s><0x%x>\n",\
						 MSDC_FILTER_NAME(cond),__FILE__,__LINE__, ##__VA_ARGS__, current->comm, current->pid),1):0))
