...
void msdc_set_fpga_card_pwr(u32 id, int on)
{
    ...
    if (on){
		switch(id){
			case 0:
				...
				MSDC_TRC_PRINT(MSDC_HREG,"FPGA 3.3 Volt power on\n");
#else 
				msdc_set_fpga_pwr(MSDC0_PWR_MASK_VOL_18);
				msdc_set_fpga_pwr(MSDC0_PWR_MASK_L4);
				msdc_set_fpga_pwr(MSDC0_PWR_MASK_EN);
				MSDC_DBG_PRINT(MSDC_DEBUG,"FPGA 1.8 Volt power on\n");
#endif
				break;
			case 1:
			case 2:
				...
				MSDC_DBG_PRINT(MSDC_DEBUG,"FPGA 3.3 Volt power on\n");
				break;
			case 3:
				...
				break;
			default:
				MSDC_DBG_PRINT(MSDC_DEBUG,"[%s:%s] power on, invalid\n", __FILE__, __func__);
				break;
		}
    } else {
		MSDC_DBG_PRINT(MSDC_DEBUG,"FPGA power off\n");
		switch(id){
			case 0:
			...
			case 3:
				...
				break;
			default:
				MSDC_DBG_PRINT(MSDC_DEBUG,"[%s:%s] power off, invalid\n", __FILE__, __func__);
				break;
		}
    }
    mdelay(10);
...
bool hwPowerSwitch_fpga(int id, int lowlevel)
{
	...
	switch(id){
		...
		case 2:
			...
			break;
		default:
			MSDC_DBG_PRINT(MSDC_DEBUG,"[%s:%s] power on, invalid parameter\n", __FILE__, __func__);
			break;
			}
...
struct msdc_host *mtk_msdc_host[HOST_MAX_NUM]   = {NULL, NULL, NULL, NULL};
...
BIT2~0: E8/E4/E2
*/
u32 msdc_dump_padctl0(struct msdc_host *host)
{	
	u32 reg = 0;
#ifndef FPGA_PLATFORM
	u32 id=host->id;
	u32 tmp = 0;
	volatile u32 *gpiobase = host->gpiobase;

	MSDC_ASSERT(id < HOST_MAX_NUM);

	switch(id){
		case 0:
			sdr_get_field(MSDC_CTRL(MSDC0, 6), MSDC_PAD_RDSEL(MSDC0), tmp);
			reg |= tmp << 24;
			sdr_get_field(MSDC_CTRL(MSDC0, 6), MSDC_PAD_TDSEL(MSDC0), tmp);
			reg |= tmp << 20;
			sdr_get_field(MSDC_CTRL(MSDC0, 0), MSDC_CLK_IES(MSDC0), tmp);
			reg |= tmp << 19;
			sdr_get_field(MSDC_CTRL(MSDC0, 0), MSDC_CLK_SMT(MSDC0), tmp);
			reg |= tmp << 18;
			sdr_get_field(MSDC_CTRL(MSDC0, 0), BIT_MSDC_CLK_R0R1PUPD, tmp);
			reg |= tmp << 15;
			sdr_get_field(MSDC_CTRL(MSDC0, 0), MSDC_CLK_SR(MSDC0), tmp);
			reg |= tmp << 8;
			sdr_get_field(MSDC_CTRL(MSDC0, 0), BIT_MSDC_CLK_E8E4E2, tmp);
			reg |= tmp << 0;
			break;
		case 1:
			sdr_get_field(MSDC_CTRL(MSDC1, 5), MSDC_PAD_RDSEL(MSDC1), tmp);
			reg |= tmp << 24;
			sdr_get_field(MSDC_CTRL(MSDC1, 5), MSDC_PAD_TDSEL(MSDC1), tmp);
			reg |= tmp << 20;
			sdr_get_field(MSDC_CTRL(MSDC1, 0), MSDC_CLK_IES(MSDC1), tmp);
			reg |= tmp << 19;
			sdr_get_field(MSDC_CTRL(MSDC1, 0), MSDC_CLK_SMT(MSDC1), tmp);
			reg |= tmp << 18;
			sdr_get_field(MSDC_CTRL(MSDC1, 0), BIT_MSDC_CLK_R0R1PUPD, tmp);
			reg |= tmp << 15;
			sdr_get_field(MSDC_CTRL(MSDC1, 0), MSDC_CLK_SR(MSDC1), tmp);
			reg |= tmp << 8;
			sdr_get_field(MSDC_CTRL(MSDC1, 0), BIT_MSDC_CLK_E8E4E2, tmp);
			reg |= tmp << 0;
			break;
		case 2:
			sdr_get_field(MSDC_CTRL(MSDC2, 5), MSDC_PAD_RDSEL(MSDC2), tmp);
			reg |= tmp << 24;
			sdr_get_field(MSDC_CTRL(MSDC2, 5), MSDC_PAD_TDSEL(MSDC2), tmp);
			reg |= tmp << 20;
			sdr_get_field(MSDC_CTRL(MSDC2, 0), MSDC_CLK_IES(MSDC2), tmp);
			reg |= tmp << 19;
			sdr_get_field(MSDC_CTRL(MSDC2, 0), MSDC_CLK_SMT(MSDC2), tmp);
			reg |= tmp << 18;
			sdr_get_field(MSDC_CTRL(MSDC2, 0), BIT_MSDC_CLK_R0R1PUPD, tmp);
			reg |= tmp << 15;
			sdr_get_field(MSDC_CTRL(MSDC2, 0), MSDC_CLK_SR(MSDC2), tmp);
			reg |= tmp << 8;
			sdr_get_field(MSDC_CTRL(MSDC2, 0), BIT_MSDC_CLK_E8E4E2, tmp);
			reg |= tmp << 0;
			break;
		case 3:
			sdr_get_field(MSDC_CTRL(MSDC3, 6), MSDC_PAD_RDSEL(MSDC3), tmp);
			reg |= tmp << 24;
			sdr_get_field(MSDC_CTRL(MSDC3, 6), MSDC_PAD_TDSEL(MSDC3), tmp);
			reg |= tmp << 20;
			sdr_get_field(MSDC_CTRL(MSDC3, 0), MSDC_CLK_IES(MSDC3), tmp);
			reg |= tmp << 19;
			sdr_get_field(MSDC_CTRL(MSDC3, 0), MSDC_CLK_SMT(MSDC3), tmp);
			reg |= tmp << 18;
			sdr_get_field(MSDC_CTRL(MSDC3, 0), BIT_MSDC_CLK_R0R1PUPD, tmp);
			reg |= tmp << 15;
			sdr_get_field(MSDC_CTRL(MSDC3, 0), MSDC_CLK_SR(MSDC3), tmp);
			reg |= tmp << 8;
			sdr_get_field(MSDC_CTRL(MSDC3, 0), BIT_MSDC_CLK_E8E4E2, tmp);
			reg |= tmp << 0;
			break;
		default:
			break;
...
u32 msdc_dump_padctl1(struct msdc_host *host)
{	
		u32 reg = 0;
#ifndef FPGA_PLATFORM
		u32 id=host->id;
		...
		switch(id){
			case 0:
				...
				sdr_get_field(MSDC_CTRL(MSDC0, 6), MSDC_PAD_TDSEL(MSDC0), tmp);
				reg |= tmp << 20;
				sdr_get_field(MSDC_CTRL(MSDC0, 1), MSDC_CMD_IES(MSDC0), tmp);
				reg |= tmp << 19;
				sdr_get_field(MSDC_CTRL(MSDC0, 1), MSDC_CMD_SMT(MSDC0), tmp);
				reg |= tmp << 18;
				sdr_get_field(MSDC_CTRL(MSDC0, 1), BIT_MSDC_CMD_R0R1PUPD, tmp);
				reg |= tmp << 15;
				sdr_get_field(MSDC_CTRL(MSDC0, 1), MSDC_CMD_SR(MSDC0), tmp);
				reg |= tmp << 8;
				sdr_get_field(MSDC_CTRL(MSDC0, 1), BIT_MSDC_CMD_E8E4E2, tmp);
				reg |= tmp << 0;
				break;
			case 1:
				sdr_get_field(MSDC_CTRL(MSDC1, 5), MSDC_PAD_RDSEL(MSDC1), tmp);
				...
				sdr_get_field(MSDC_CTRL(MSDC1, 5), MSDC_PAD_TDSEL(MSDC1), tmp);
				reg |= tmp << 20;
				sdr_get_field(MSDC_CTRL(MSDC1, 1), MSDC_CMD_IES(MSDC1), tmp);
				reg |= tmp << 19;
				sdr_get_field(MSDC_CTRL(MSDC1, 1), MSDC_CMD_SMT(MSDC1), tmp);
				reg |= tmp << 18;
				sdr_get_field(MSDC_CTRL(MSDC1, 1), BIT_MSDC_CMD_R0R1PUPD, tmp);
				reg |= tmp << 15;
				sdr_get_field(MSDC_CTRL(MSDC1, 1), MSDC_CMD_SR(MSDC1), tmp);
				reg |= tmp << 8;
				sdr_get_field(MSDC_CTRL(MSDC1, 1), BIT_MSDC_CMD_E8E4E2, tmp);
				reg |= tmp << 0;
				break;
			case 2:
				sdr_get_field(MSDC_CTRL(MSDC2, 5), MSDC_PAD_RDSEL(MSDC2), tmp);
				...
				sdr_get_field(MSDC_CTRL(MSDC2, 5), MSDC_PAD_TDSEL(MSDC2), tmp);
				reg |= tmp << 20;
				sdr_get_field(MSDC_CTRL(MSDC2, 1), MSDC_CMD_IES(MSDC2), tmp);
				reg |= tmp << 19;
				sdr_get_field(MSDC_CTRL(MSDC2, 1), MSDC_CMD_SMT(MSDC2), tmp);
				reg |= tmp << 18;
				sdr_get_field(MSDC_CTRL(MSDC2, 1), BIT_MSDC_CMD_R0R1PUPD, tmp);
				reg |= tmp << 15;
				sdr_get_field(MSDC_CTRL(MSDC2, 1), MSDC_CMD_SR(MSDC2), tmp);
				reg |= tmp << 8;
				sdr_get_field(MSDC_CTRL(MSDC2, 1), BIT_MSDC_CMD_E8E4E2, tmp);
				reg |= tmp << 0;
				break;
			case 3:
				sdr_get_field(MSDC_CTRL(MSDC3, 6), MSDC_PAD_RDSEL(MSDC3), tmp);
				...
				sdr_get_field(MSDC_CTRL(MSDC3, 6), MSDC_PAD_TDSEL(MSDC3), tmp);
				reg |= tmp << 20;
				sdr_get_field(MSDC_CTRL(MSDC3, 1), MSDC_CMD_IES(MSDC3), tmp);
				reg |= tmp << 19;
				sdr_get_field(MSDC_CTRL(MSDC3, 1), MSDC_CMD_SMT(MSDC3), tmp);
				reg |= tmp << 18;
				sdr_get_field(MSDC_CTRL(MSDC3, 1), BIT_MSDC_CMD_R0R1PUPD, tmp);
				reg |= tmp << 15;
				sdr_get_field(MSDC_CTRL(MSDC3, 1), MSDC_CMD_SR(MSDC3), tmp);
				reg |= tmp << 8;
				sdr_get_field(MSDC_CTRL(MSDC3, 1), BIT_MSDC_CMD_E8E4E2, tmp);
				reg |= tmp << 0;
				break;
			default:
				break;
...
u32 msdc_dump_padctl2(struct msdc_host *host)
{	
	u32 reg = 0;
#ifndef FPGA_PLATFORM
	u32 id=host->id;
	...
	switch(id){
		case 0:
			...
			sdr_get_field(MSDC_CTRL(MSDC0, 6), MSDC_PAD_TDSEL(MSDC0), tmp);
			reg |= tmp << 20;
			sdr_get_field(MSDC_CTRL(MSDC0, 2), MSDC_DAT_IES(MSDC0), tmp);
			reg |= tmp << 19;
			sdr_get_field(MSDC_CTRL(MSDC0, 3), MSDC_DAT_SMT(MSDC0,DAT0), tmp);
			reg |= tmp << 18;
			sdr_get_field(MSDC_CTRL(MSDC0, 3), BIT_MSDC_R0R1PUPD(DAT0), tmp);
			reg |= tmp << 15;
			sdr_get_field(MSDC_CTRL(MSDC0, 2), MSDC_DAT_SR(MSDC0), tmp);
			reg |= tmp << 8;
			sdr_get_field(MSDC_CTRL(MSDC0, 2), BIT_MSDC_DAT_E8E4E2, tmp);
			reg |= tmp << 0;
			break;
		case 1:
			sdr_get_field(MSDC_CTRL(MSDC1, 5), MSDC_PAD_RDSEL(MSDC1), tmp);
			...
			sdr_get_field(MSDC_CTRL(MSDC1, 5), MSDC_PAD_TDSEL(MSDC1), tmp);
			reg |= tmp << 20;
			sdr_get_field(MSDC_CTRL(MSDC1, 2), MSDC_DAT_IES(MSDC1), tmp);
			reg |= tmp << 19;
			sdr_get_field(MSDC_CTRL(MSDC1, 3), MSDC_DAT_SMT(MSDC1,DAT0), tmp);
			reg |= tmp << 18;
			sdr_get_field(MSDC_CTRL(MSDC1, 3), BIT_MSDC_R0R1PUPD(DAT0), tmp);
			reg |= tmp << 15;
			sdr_get_field(MSDC_CTRL(MSDC1, 2), MSDC_DAT_SR(MSDC1), tmp);
			reg |= tmp << 8;
			sdr_get_field(MSDC_CTRL(MSDC1, 2), BIT_MSDC_DAT_E8E4E2, tmp);
			reg |= tmp << 0;
			break;
		case 2:
			sdr_get_field(MSDC_CTRL(MSDC2, 5), MSDC_PAD_RDSEL(MSDC2), tmp);
			...
			sdr_get_field(MSDC_CTRL(MSDC2, 5), MSDC_PAD_TDSEL(MSDC2), tmp);
			reg |= tmp << 20;
			sdr_get_field(MSDC_CTRL(MSDC2, 2), MSDC_DAT_IES(MSDC2), tmp);
			reg |= tmp << 19;
			sdr_get_field(MSDC_CTRL(MSDC2, 3), MSDC_DAT_SMT(MSDC2,DAT0), tmp);
			reg |= tmp << 18;
			sdr_get_field(MSDC_CTRL(MSDC2, 3), BIT_MSDC_R0R1PUPD(DAT0), tmp);
			reg |= tmp << 15;
			sdr_get_field(MSDC_CTRL(MSDC2, 2), MSDC_DAT_SR(MSDC2), tmp);
			reg |= tmp << 8;
			sdr_get_field(MSDC_CTRL(MSDC2, 2), BIT_MSDC_DAT_E8E4E2, tmp);
			reg |= tmp << 0;
			break;
		case 3:
			sdr_get_field(MSDC_CTRL(MSDC3, 6), MSDC_PAD_RDSEL(MSDC3), tmp);
			...
			sdr_get_field(MSDC_CTRL(MSDC3, 6), MSDC_PAD_TDSEL(MSDC3), tmp);
			reg |= tmp << 20;
			sdr_get_field(MSDC_CTRL(MSDC3, 2), MSDC_DAT_IES(MSDC3), tmp);
			reg |= tmp << 19;
			sdr_get_field(MSDC_CTRL(MSDC3, 3), MSDC_DAT_SMT(MSDC3,DAT0), tmp);
			reg |= tmp << 18;
			sdr_get_field(MSDC_CTRL(MSDC3, 3), BIT_MSDC_R0R1PUPD(DAT0), tmp);
			reg |= tmp << 15;
			sdr_get_field(MSDC_CTRL(MSDC3, 2), MSDC_DAT_SR(MSDC3), tmp);
			reg |= tmp << 8;
			sdr_get_field(MSDC_CTRL(MSDC3, 2), BIT_MSDC_DAT_E8E4E2, tmp);
			reg |= tmp << 0;
			break;
		default:
			break;
...
static void msdc_dump_register(struct msdc_host *host)
{
    ...
    /* dump gpio register */
    MSDC_TRC_PRINT(MSDC_HREG,"Rg[C10] MSDC0_CTRL0_CLK        = 0x%.8x", sdr_read32(0xF0005000 + 0xC00));                   
    MSDC_TRC_PRINT(MSDC_HREG,"Rg[C20] MSDC0_CTRL1_CMD        = 0x%.8x", sdr_read32(0xF0005000 + 0xC10));                   
    MSDC_TRC_PRINT(MSDC_HREG,"Rg[C30] MSDC0_CTRL2_DAT        = 0x%.8x", sdr_read32(0xF0005000 + 0xC20));                   
    MSDC_TRC_PRINT(MSDC_HREG,"Rg[C40] MSDC0_CTRL3_PAD        = 0x%.8x", sdr_read32(0xF0005000 + 0xC30));                   
    MSDC_TRC_PRINT(MSDC_HREG,"Rg[C50] MSDC1_CTRL0_CLK        = 0x%.8x", sdr_read32(0xF0005000 + 0xC40));                   
    MSDC_TRC_PRINT(MSDC_HREG,"Rg[C60] MSDC1_CTRL1_CMD        = 0x%.8x", sdr_read32(0xF0005000 + 0xC50));                   
    MSDC_TRC_PRINT(MSDC_HREG,"Rg[C70] MSDC1_CTRL2_DAT        = 0x%.8x", sdr_read32(0xF0005000 + 0xC60));                   
    MSDC_TRC_PRINT(MSDC_HREG,"Rg[C80] MSDC1_CTRL3_PAD        = 0x%.8x", sdr_read32(0xF0005000 + 0xC70));
...
static void msdc_debug_reg(struct msdc_host *host)
{
    ...
    for (i=0; i < 26; i++) {
        ...
        MSDC_TRC_PRINT(MSDC_HREG,"SW_DBG_SEL: write reg[%x] to 0x%x", base + 0xA0, i);      
        MSDC_TRC_PRINT(MSDC_HREG,"SW_DBG_OUT: read  reg[%x] to 0x%x", base + 0xA4, sdr_read32(base + 0xA4));  	
    }  	
 ...
 * return DMA status. 
 */
int msdc_get_dma_status(u32 host_id)
{
   int result = -1;
...
struct dma_addr* msdc_get_dma_address(u32 host_id)
{
   bd_t* bd; 
   int i = 0;
   int mode = -1;
   ...
   MSDC_ASSERT(host_id < HOST_MAX_NUM); 
   MSDC_ASSERT(mtk_msdc_host[host_id]) ;
...
{
    //MSDC_TRC_PRINT(MSDC_HREG,"MSDC pll status: Reg[0xF00071C0] = 0x%.8x\r\n", sdr_read32(0xF00071C0));	    
    
#ifndef FPGA_PLATFORM
    //freq_meter(0xf, 0); 
    //MSDC_TRC_PRINT(MSDC_HREG,"clock select reg[%x] = 0x%.8x",  MSDC_CLKSRC_REG, sdr_read32(MSDC_CLKSRC_REG));    	
    MSDC_TRC_PRINT(MSDC_HREG,"clock gate status reg[F0003018] = 0x%.8x", sdr_read32(0xF0003018));
    //MSDC_TRC_PRINT(MSDC_HREG,"clock mgr.clock_state[0] = 0x%x",clk_mgr.clock_state[0]);
#endif
}
static void msdc_dump_info(u32 id)
{
    ...
    MSDC_TRC_PRINT(MSDC_HREG,"latest_INT_status<0x%.8x>",latest_int_status[id]);
    ...
    MSDC_TRC_PRINT(MSDC_HREG,"patch reg[%x] = 0x%.8x", (base + 0xB0), temp);  
      
    temp = (~temp);
    sdr_write32(base + 0xB0, temp);    
    temp = sdr_read32(base + 0xB0);
    MSDC_TRC_PRINT(MSDC_HREG,"patch reg[%x] = 0x%.8x second time", (base + 0xB0), temp);          
 
    temp = (~temp);
    sdr_write32(base + 0xB0, temp);    
    temp = sdr_read32(base + 0xB0);
    MSDC_TRC_PRINT(MSDC_HREG,"patch reg[%x] = 0x%.8x Third time", (base + 0xB0), temp);   
...
static u32 msdc_ldo_power(u32 on, MT65XX_POWER powerId, MT65XX_POWER_VOLTAGE powerVolt, u32 *status)
{
    ...
    if (on) { // want to power on
        if (*status == 0) {  // can power on 
            MSDC_TRC_PRINT(MSDC_CONFIG, "msdc LDO<%d> power on<%d>\n", powerId, powerVolt); 	
            hwPowerOn(powerId, powerVolt, "msdc");
            *status = powerVolt;             
        }
		else if (*status == powerVolt){
            MSDC_ERR_PRINT(MSDC_WARN, "msdc LDO<%d><%d> power on again!\n", powerId, powerVolt);	
        } 
		else { // for sd3.0 later
            MSDC_TRC_PRINT(MSDC_CONFIG,"msdc LDO<%d> change<%d> to <%d>\n", powerId, *status, powerVolt);
        ...
        if (*status != 0) {  // has been powerred on
            MSDC_ERR_PRINT(MSDC_WARN,"msdc LDO<%d> power off\n", powerId);   
            hwPowerDown(powerId, "msdc");
            *status = 0;
        }
		else {
            MSDC_ERR_PRINT(MSDC_WARN,"LDO<%d> not power on\n", powerId);	
        }            	
    }  
#endif    
    return 0;      	
...
#else 
            sdr_set_field(MSDC_CTRL(MSDC1, 1), BIT_MSDC_CLK_R0R1PUPD,  3);
            sdr_set_field(MSDC_CTRL(MSDC1, 1), BIT_MSDC_CMD_R0R1PUPD,  4);
            sdr_set_field(MSDC_CTRL(MSDC1, 3), BIT_MSDC_DAT0_R0R1PUPD, 4);
            sdr_set_field(MSDC_CTRL(MSDC1, 3), BIT_MSDC_DAT1_R0R1PUPD, 4);
            sdr_set_field(MSDC_CTRL(MSDC1, 3), BIT_MSDC_DAT2_R0R1PUPD, 4);
            sdr_set_field(MSDC_CTRL(MSDC1, 3), BIT_MSDC_DAT3_R0R1PUPD, 4); 
    ...
    if (host->mmc && host->mmc->card && (host->mmc->caps & MMC_CAP_WAIT_WHILE_BUSY) && (on == 0)){
        ...
        while ((sdr_read32(MSDC_PS) & 0x10000) != 0x10000) {
            if (time_after(jiffies, tmo)){
                MSDC_ERR_PRINT(MSDC_ERROR,"Dat0 keep low before power off, sa_timeout = 0x%x\n", host->mmc->card->ext_csd.sa_timeout); 
                break; 
            }
        }
    }
...
#endif
            MSDC_TRC_PRINT(MSDC_CONFIG,"msdc_ldo_power(on, MT6323_POWER_LDO_VEMC_3V3,...) %u\n", g_msdc0_flash); 
#endif
			break;
...
static void msdc_sd_power(struct msdc_host *host,u32 on)
{
	...
	switch(host->id){
		case 1:
            ...
            MSDC_TRC_PRINT(MSDC_CONFIG,"MSDC1 fixed io 3.3V and flash 3.3V) %u\n");
            printk("MT6323_POWER_LDO_VMC, MT6323_POWER_LDO_VMCH on=%d\n");
            //msdc_ldo_power(on, MT6323_POWER_LDO_VMC, VOL_3300, &g_msdc1_io);
            msdc_ldo_power(on, MT6323_POWER_LDO_VMCH, VOL_3300, &g_msdc1_flash);

			break;
		case 2:
			/* Note that MSDC2 use the same power with MSDC1 on MT8127 */
			msdc_set_smt(host,1);
			msdc_set_driving(host,host->hw,1);
			msdc_set_rdtdsel(host,1);
            MSDC_TRC_PRINT(MSDC_CONFIG,"MSDC2 fixed io 3.3V and flash 3.3V) %u\n"); 
			
#ifndef FPGA_PLATFORM			
			//msdc_set_enio18(host,0);
			msdc_ldo_power(on, MT6323_POWER_LDO_VMCH, VOL_3300, &g_msdc2_io);//If MSDC2 is defined for 2nd SD card host power and card power is the same one--VGP6
			//msdc_set_enio18(host,0);
...
static void msdc_sd_power_switch(struct msdc_host *host,u32 on)
{
	switch(host->id){
		case 1:
#if 10			
            MSDC_TRC_PRINT(MSDC_CONFIG,"CANNOT switch to 1.8V since MSDC2 fixed io 3.3V and flash 3.3V) %u\n"); 
#else			
#ifndef FPGA_PLATFORM			
...
void msdc_gate_clock(struct msdc_host* host, int delay) 
{
    ...
    if (delay) {
       ...
       MSDC_DBG_PRINT(MSDC_CONFIG, "[%s]: msdc%d, clk_gate_count=%d, delay=%d\n", __func__, host->id, host->clk_gate_count, delay);
    }
    else if(host->clk_gate_count == 0) {
       del_timer(&host->timer);
       msdc_clksrc_onoff(host, 0);
       MSDC_DBG_PRINT(MSDC_CONFIG, "[%s]: msdc%d, successfully gate clock, clk_gate_count=%d, delay=%d\n", __func__, host->id, host->clk_gate_count, delay);
    }
    else  {
       MSDC_ERR_PRINT(MSDC_ERROR,"[%s]: msdc%d, failed to gate clock, the clock is still needed by host, clk_gate_count=%d, delay=%d\n", __func__, host->id, host->clk_gate_count, delay);
    }
...
static void msdc_suspend_clock(struct msdc_host* host) 
{
    ...
    if(host->clk_gate_count == 0) {
       del_timer(&host->timer);
       msdc_clksrc_onoff(host, 0);
       MSDC_DBG_PRINT(MSDC_CONFIG, "[%s]: msdc%d, successfully gate clock, clk_gate_count=%d\n", __func__, host->id, host->clk_gate_count);
    }
    else {
       MSDC_ERR_PRINT(MSDC_ERROR,"[%s]: msdc%d, the clock is still needed by host, clk_gate_count=%d\n", __func__, host->id, host->clk_gate_count);
    }
    spin_unlock_irqrestore(&host->clk_gate_lock, flags); 
}
...
{ 
    ...
    spin_lock_irqsave(&host->clk_gate_lock, flags);
    host->clk_gate_count++; 
    MSDC_DBG_PRINT(MSDC_CONFIG, "[%s]: msdc%d, clk_gate_count=%d\n", __func__, host->id, host->clk_gate_count);
...
static void msdc_dump_card_status(struct msdc_host *host, u32 status)
{
    ...
    if (status & R1_OUT_OF_RANGE)
        MSDC_DBG_PRINT(MSDC_DREG,"[CARD_STATUS] Out of Range");
    if (status & R1_ADDRESS_ERROR)
        MSDC_DBG_PRINT(MSDC_DREG, "[CARD_STATUS] Address Error");
    if (status & R1_BLOCK_LEN_ERROR)
        MSDC_DBG_PRINT(MSDC_DREG, "[CARD_STATUS] Block Len Error");
    if (status & R1_ERASE_SEQ_ERROR)
        MSDC_DBG_PRINT(MSDC_DREG, "[CARD_STATUS] Erase Seq Error");
    if (status & R1_ERASE_PARAM)
        MSDC_DBG_PRINT(MSDC_DREG, "[CARD_STATUS] Erase Param");
    if (status & R1_WP_VIOLATION)
        MSDC_DBG_PRINT(MSDC_DREG, "[CARD_STATUS] WP Violation");
    if (status & R1_CARD_IS_LOCKED)
        MSDC_DBG_PRINT(MSDC_DREG, "[CARD_STATUS] Card is Locked");
    if (status & R1_LOCK_UNLOCK_FAILED)
        MSDC_DBG_PRINT(MSDC_DREG,"[CARD_STATUS] Lock/Unlock Failed");
    if (status & R1_COM_CRC_ERROR)
        MSDC_DBG_PRINT(MSDC_DREG,"[CARD_STATUS] Command CRC Error");
    if (status & R1_ILLEGAL_COMMAND)
        MSDC_DBG_PRINT(MSDC_DREG,"[CARD_STATUS] Illegal Command");
    if (status & R1_CARD_ECC_FAILED)
        MSDC_DBG_PRINT(MSDC_DREG,"[CARD_STATUS] Card ECC Failed");
    if (status & R1_CC_ERROR)
        MSDC_DBG_PRINT(MSDC_DREG,"[CARD_STATUS] CC Error");
    if (status & R1_ERROR)
        MSDC_DBG_PRINT(MSDC_DREG,"[CARD_STATUS] Error");
    if (status & R1_UNDERRUN)
        MSDC_DBG_PRINT(MSDC_DREG,"[CARD_STATUS] Underrun");
    if (status & R1_OVERRUN)
        MSDC_DBG_PRINT(MSDC_DREG,"[CARD_STATUS] Overrun");
    if (status & R1_CID_CSD_OVERWRITE)
        MSDC_DBG_PRINT(MSDC_DREG,"[CARD_STATUS] CID/CSD Overwrite");
    if (status & R1_WP_ERASE_SKIP)
        MSDC_DBG_PRINT(MSDC_DREG,"[CARD_STATUS] WP Eraser Skip");
    if (status & R1_CARD_ECC_DISABLED)
        MSDC_DBG_PRINT(MSDC_DREG,"[CARD_STATUS] Card ECC Disabled");
    if (status & R1_ERASE_RESET)
        MSDC_DBG_PRINT(MSDC_DREG,"[CARD_STATUS] Erase Reset");
    if ((status & R1_READY_FOR_DATA) == 0)
        MSDC_DBG_PRINT(MSDC_DREG,"[CARD_STATUS] Not Ready for Data");
    if (status & R1_SWITCH_ERROR)
        MSDC_DBG_PRINT(MSDC_DREG,"[CARD_STATUS] Switch error");
    if (status & R1_APP_CMD)
        MSDC_DBG_PRINT(MSDC_DREG,"[CARD_STATUS] App Command");
    
    MSDC_TRC_PRINT(MSDC_INFO,"[CARD_STATUS] '%s' State", state[R1_CURRENT_STATE(status)]);
} 
...
static void msdc_set_timeout(struct msdc_host *host, u32 ns, u32 clks)
{
    ...
    MSDC_DBG_PRINT(MSDC_DEBUG,"Set read data timeout: %dns %dclks -> %d x 1048576  cycles",
        ns, clks, timeout + 1);
}
...
//    u32 status = 0;
	...
	if(host->block_bad_card){
		...
		if(host->mmc->card)
			mmc_card_set_removed(host->mmc->card);
		MSDC_DBG_PRINT(MSDC_DEBUG,"remove bad SD card");
		}
	else
    	MSDC_DBG_PRINT(MSDC_DEBUG,"card found<%s>", inserted ? "inserted" : "removed");  
	...
	MSDC_DBG_PRINT(MSDC_DEBUG,"host->suspend(%d)",host->suspend);
    if (!host->suspend && host->sd_cd_insert_work) { 
        mmc_detect_change(host->mmc, msecs_to_jiffies(200)); 
    }
	MSDC_DBG_PRINT(MSDC_DEBUG,"insert_workqueue(%d)",host->sd_cd_insert_work);
}
...
static void msdc_select_clksrc(struct msdc_host* host, int clksrc)
{
    ...
    MSDC_ASSERT(clksrc < 3);	
    MSDC_DBG_PRINT(MSDC_INIT,"set clock source to <%d>", clksrc);    	
...
static void msdc_set_mclk(struct msdc_host *host, int ddr, u32 hz)
{
    ...
    if (!hz) { // set mmc system clock to 0 
        MSDC_DBG_PRINT(MSDC_DEBUG,"msdc%d -> set mclk to 0",host->id);  // fix me: need to set to 0        
    ...
    if(hz >= 25000000)
    	MSDC_DBG_PRINT(MSDC_DEBUG,"msdc%d -> !!! Set<%dKHz> Source<%dKHz> -> sclk<%dKHz> DDR<%d> mode<%d> div<%d>" , 
...
static u32 msdc_power_tuning(struct msdc_host *host)
{
    ...
    if (mmc_card_sd(card) && (host->hw->host_function == MSDC_SD)) {
        ...
        {
        // power cycle 
        MSDC_DBG_PRINT(MSDC_DEBUG,"Power cycle start");
        spin_unlock(&host->lock);
#ifdef FPGA_PLATFORM
	...
	if(host->power_control)
		...
		MSDC_DBG_PRINT(MSDC_DEBUG,"Power cycle host->error(0x%x)",host->error);  
		(host->power_cycle)++;
...
static void msdc_remove_card(struct work_struct *work)
{
	...
	MSDC_ASSERT(host);
	MSDC_ASSERT(host->mmc);
	MSDC_DBG_PRINT(MSDC_DEBUG,"Need remove card");
	if(host->mmc->card){
		if(mmc_card_present(host->mmc->card)){
			MSDC_DBG_PRINT(MSDC_DEBUG,"1.remove card");
			mmc_remove_card(host->mmc->card);
        } else{
			MSDC_DBG_PRINT(MSDC_DEBUG,"card was not present can not remove");
		...
		MSDC_DBG_PRINT(MSDC_DEBUG,"2.detach bus");
		host->mmc->card = NULL;
		mmc_detach_bus(host->mmc);
		MSDC_DBG_PRINT(MSDC_DEBUG,"3.Power off");
		mmc_power_off(host->mmc);
		MSDC_DBG_PRINT(MSDC_DEBUG,"4.Gate clock");
		msdc_gate_clock(host,0);
		mmc_release_host(host->mmc);
	}
	MSDC_DBG_PRINT(MSDC_DEBUG,"Card removed");
}
#endif
int msdc_reinit(struct msdc_host *host)
{
    ...
    MSDC_ASSERT(host);	
    MSDC_ASSERT(host->mmc);
    MSDC_ASSERT(host->mmc->card);
	
	mmc  = host->mmc;
    card = mmc->card;
	
    if(host->block_bad_card) {
		MSDC_DBG_PRINT(MSDC_DEBUG,"Need block this bad SD card from re-initialization");
    }
    ...
    if ( host->hw->host_function == MSDC_SD) {
		 if ((!(host->hw->flags & MSDC_CD_PIN_EN)) && (host->block_bad_card == 0)){
		     // power cycle 
		     MSDC_TRC_PRINT(MSDC_INFO,"SD card Re-Init!");
		     mmc_claim_host(host->mmc);
			 MSDC_TRC_PRINT(MSDC_INFO,"SD card Re-Init get host!");
			 spin_lock(&host->lock);
			 MSDC_TRC_PRINT(MSDC_INFO,"SD card Re-Init get lock!");
			 msdc_clksrc_onoff(host, 1); 
			 if (host->app_cmd_arg) {
			while((err = msdc_get_card_status(mmc, host, &status))) {
				MSDC_TRC_PRINT(MSDC_INFO,"SD card Re-Init in get card status!err(%d)",err);
					if(err == (unsigned int)-EIO){
            			if (msdc_tune_cmdrsp(host)) {
		        		MSDC_TRC_PRINT(MSDC_INFO,"update cmd para failed");	
                			break;
            			}
					}
					else 
		        ...
		        if(err == 0){
					...
					spin_unlock(&host->lock);  
					mmc_release_host(host->mmc);
					MSDC_TRC_PRINT(MSDC_INFO,"SD Card is ready.");
					return 0;
				}
			}
			 
			msdc_clksrc_onoff(host, 0);
		    MSDC_TRC_PRINT(MSDC_INFO,"Reinit start..");
		    mmc->ios.clock = HOST_MIN_MCLK;  
		    mmc->ios.bus_width = MMC_BUS_WIDTH_1;
		    mmc->ios.timing = MMC_TIMING_LEGACY;
			host->card_inserted = 1;
			...
			MSDC_TRC_PRINT(MSDC_INFO,"Reinit %s", (ret == 0) ? "success" : "fail");
    ...
    while (state != 4) { // until status to "tran"
        while ((err = msdc_get_card_status(mmc, host, &status))) {
            ...
            if (err != (unsigned int)-EIO) {
                ...
                MSDC_ERR_PRINT(MSDC_ERROR,"update cmd para failed");	
                return 1;
            }   
        } 

        state = R1_CURRENT_STATE(status);
        //MSDC_ERR_PRINT(MSDC_ERROR,"check card state<%d>", state);
        if (state == 5 || state == 6) {
            MSDC_DBG_PRINT(MSDC_DEBUG,"state<%d> need cmd12 to stop", state);	
            msdc_send_stop(host); // don't tuning
        } 
...
static void msdc_pin_config(struct msdc_host *host, int mode)
{
    ...
    if (hw->flags & MSDC_WP_PIN_EN) {
        if (hw->config_gpio_pin){
			/* NULL */
            hw->config_gpio_pin(MSDC_WP_PIN, (mode == MSDC_PIN_PULL_UP) ? GPIO_PULL_UP : GPIO_PULL_DOWN);
        }
    }
...
static void msdc_pin_reset(struct msdc_host *host, int mode)
{
    ...
    if (hw->flags & MSDC_RST_PIN_EN) {
        if (hw->config_gpio_pin) {
			/* NULL */
            hw->config_gpio_pin(MSDC_RST_PIN, (mode == MSDC_PIN_PULL_UP) ? GPIO_PULL_UP : GPIO_PULL_DOWN);
        }
...
{
    MSDC_DBG_PRINT(MSDC_DEBUG,"Set power mode(%d)", mode);
...
static void msdc_sleep_enter(struct msdc_host *host)
{
    ...
    if (MMC_TYPE_MMC != card->type) {
        MSDC_DBG_PRINT(MSDC_DEBUG,"[EMMC] not a mmc card, pls check it before sleep\n");
        return ;
    }
    ...
    if (host->mmc->card->cid.manfid == HYNIX_EMMC_CHIP){
            ...
            if (l_ret != 0){
                MSDC_DBG_PRINT(MSDC_DEBUG,"send cmd1 error while emmc card enter low power state\n");   	/* won't happen. */
            }
            ...
            if (l_ret != 0){
                MSDC_DBG_PRINT(MSDC_DEBUG,"send cmd2 error while emmc card enter low power state\n");   	/* won't happen. */
            }
        }
    }
...
static void msdc_clksrc_onoff(struct msdc_host *host, u32 on)
{
    ...
    if (on) {
        if (0 == host->core_clkon) {
            ...
            //MSDC_DBG_PRINT(MSDC_DEBUG,"3G pll = 0x%x when clk<on>", sdr_read32(0xF00071C0));
#ifndef FPGA_PLATFORM 
            //freq_meter(0xf, 0); 
#endif              
        }    	
		...
		if (!((host->hw->flags & MSDC_SDIO_IRQ) && src_clk_control)) {
		        if (1 == host->core_clkon) {	
		           ...
		           host->core_clkon = 0;   
		            ...
		            //MSDC_DBG_PRINT(MSDC_DEBUG,"3G pll = 0x%x when clk<off>", sdr_read32(0xF00071C0));
#ifndef FPGA_PLATFORM 
		            //freq_meter(0xf, 0);      
#endif                	
		        }            	
...
//#endif
			...
			/* just for double confirm */       
            mmc_remove_host(host->mmc);
        }
    } 
	else if (evt == PM_EVENT_RESUME  || evt == PM_EVENT_USER_RESUME) {
        if (!host->suspend) {
            //MSDC_DBG_PRINT(MSDC_DEBUG,"warning: already resume");   	
            goto end;
        }

        /* No PM resume when USR suspend */
        if (evt == PM_EVENT_RESUME && host->pm_state.event == PM_EVENT_USER_SUSPEND) {
            MSDC_DBG_PRINT(MSDC_DEBUG,"PM Resume when in USR Suspend");   	/* won't happen. */
            goto end;
        }
...
int msdc_get_reserve(void)
{
    ...
    if (NULL == lp_excel_info) {
        MSDC_DBG_PRINT(MSDC_DEBUG,"can't get otp info from part_info struct\n");
        return -1;
    }
...
/*	u64 device_capacity = 0;
	...
	if(mmc_card_blockaddr(host->mmc->card))
			offset /= 512;
    MSDC_DBG_PRINT(MSDC_DEBUG,"Address offset in USER REGION(Capacity %lld MB) is 0x%x",device_capacity/(1024*1024),offset);
    if(offset < 0) {
          MSDC_DBG_PRINT(MSDC_DEBUG,"XXX Address offset error(%d),please check MBR start address!!",(int)offset);
          BUG();
    }
*/
	offset =  0;
                                      ...
                                      unsigned long       timeout)
{
    ...
    MSDC_DBG_PRINT(MSDC_DEBUG,"CMD<%d><0x%.8x> Arg<0x%.8x>", opcode , rawcmd, cmd->arg);
    ...
    if (opcode == MMC_SEND_STATUS) {
        for (;;) {
            ...
            if (time_after(jiffies, tmo)) {
                MSDC_DBG_PRINT(MSDC_DEBUG,"XXX cmd_busy timeout: before CMD<%d>", opcode);	
        ...
        for (;;) {
            if (!sdc_is_busy())
                break;
            if (time_after(jiffies, tmo)) {
                MSDC_DBG_PRINT(MSDC_DEBUG,"XXX sdc_busy timeout: before CMD<%d>", opcode);	
                cmd->error = (unsigned int)-ETIMEDOUT;
                msdc_reset_hw(host->id);
                return cmd->error;
            }
        ...
        unsigned long       timeout)
{
    ...
    while (1){
        ...
        if (time_after(jiffies, tmo)) {
                MSDC_DBG_PRINT(MSDC_DEBUG,"XXX CMD<%d> polling_for_completion timeout ARG<0x%.8x>", cmd->opcode, cmd->arg);	
            cmd->error = (unsigned int)-ETIMEDOUT;
            host->sw_timeout++;
            msdc_dump_info(host->id);
            msdc_reset_hw(host->id);
                                      ...
                                      unsigned long       timeout)
{
    ...
    if(!wait_for_completion_timeout(&host->cmd_done, 10*timeout)){       
        MSDC_DBG_PRINT(MSDC_DEBUG,"XXX CMD<%d> wait_for_completion timeout ARG<0x%.8x>", opcode, cmd->arg);
        host->sw_timeout++;
        msdc_dump_info(host->id);
        cmd->error = (unsigned int)-ETIMEDOUT;
        msdc_reset_hw(host->id);
                                      ...
                                      unsigned long       timeout)
{
    ...
    MSDC_DBG_PRINT(MSDC_DEBUG,"        return<%d> resp<0x%.8x>", cmd->error, cmd->resp[0]); 
...
static int msdc_pio_abort(struct msdc_host *host, struct mmc_data *data, unsigned long tmo)
{
    ...
    if (time_after(jiffies, tmo)) {
        ...
        MSDC_DBG_PRINT(MSDC_DEBUG,"XXX PIO Data Timeout: CMD<%d>", host->mrq->cmd->opcode);
        msdc_dump_info(host->id);          
        ret = 1;		
    }
    ...
    if(ret) {
        msdc_reset_hw(host->id);     	
        MSDC_DBG_PRINT(MSDC_DEBUG,"msdc pio find abort");      
    }
    return ret; 
}
...
int msdc_pio_read(struct msdc_host *host, struct mmc_data *data)
{
    ...
    MSDC_DBG_PRINT(MSDC_DEBUG,"        PIO Read<%d>bytes", size);
    ...
    if(data->error) 
		MSDC_DBG_PRINT(MSDC_DEBUG,"read pio data->error<%d> left<%d> size<%d>", data->error, left, size);
    return data->error;
}
...
static void msdc_dma_resume(struct msdc_host *host)
{
    ...
    MSDC_DBG_PRINT(MSDC_DMA, "DMA resume");
}
#endif
...
static void msdc_dma_start(struct msdc_host *host)
{
    ...
    MSDC_DBG_PRINT(MSDC_DMA,"DMA start");
}
...
static void msdc_dma_stop(struct msdc_host *host)
{
    ...
    if(host->autocmd & MSDC_AUTOCMD12)
        wints |= MSDC_INT_ACMDCRCERR | MSDC_INT_ACMDTMO | MSDC_INT_ACMDRDY;
    MSDC_DBG_PRINT(MSDC_DMA,"DMA status: 0x%.8x",sdr_read32(MSDC_DMA_CFG));
    ...
    if(retry == 0){
		MSDC_ERR_PRINT(MSDC_ERROR,"!!ASSERT!!");
    }
    mb();
    if (host->hw->flags & MSDC_SDIO_IRQ)
        spin_lock_irqsave(&SDIO_IRQ_lock, flags_lock);
    ...
    if (host->hw->flags & MSDC_SDIO_IRQ)
        spin_unlock_irqrestore(&SDIO_IRQ_lock, flags_lock);
    MSDC_DBG_PRINT(MSDC_DMA,"DMA stop");
}
...
static void msdc_dma_dump(struct msdc_host *host, struct msdc_dma *dma)
{
    ...
    MSDC_DBG_PRINT(MSDC_DEBUG,"try to dump gpd and bd");

    /* dump gpd */
    MSDC_DBG_PRINT(MSDC_DEBUG,".gpd<0x%.8x> gpd_phy<0x%.8x>", (int)gpd, (int)dma->gpd_addr);
    MSDC_DBG_PRINT(MSDC_DEBUG,"...hwo   <%d>", gpd->hwo );
    MSDC_DBG_PRINT(MSDC_DEBUG,"...bdp   <%d>", gpd->bdp );
    MSDC_DBG_PRINT(MSDC_DEBUG,"...chksum<0x%.8x>", gpd->chksum );
    //MSDC_DBG_PRINT(MSDC_DEBUG,"...intr  <0x%.8x>", gpd->intr );
    MSDC_DBG_PRINT(MSDC_DEBUG,"...next  <0x%.8x>", (int)gpd->next );
    MSDC_DBG_PRINT(MSDC_DEBUG,"...ptr   <0x%.8x>", (int)gpd->ptr );
    MSDC_DBG_PRINT(MSDC_DEBUG,"...buflen<0x%.8x>", gpd->buflen );
    //MSDC_DBG_PRINT(MSDC_DEBUG,"...extlen<0x%.8x>", gpd->extlen );
    //MSDC_DBG_PRINT(MSDC_DEBUG,"...arg   <0x%.8x>", gpd->arg );
    //MSDC_DBG_PRINT(MSDC_DEBUG,"...blknum<0x%.8x>", gpd->blknum );    
    //MSDC_DBG_PRINT(MSDC_DEBUG,"...cmd   <0x%.8x>", gpd->cmd );      

    /* dump bd */
    MSDC_DBG_PRINT(MSDC_DEBUG,".bd<0x%.8x> bd_phy<0x%.8x> gpd_ptr<0x%.8x>", (int)bd, (int)dma->bd_addr, (int)gpd->ptr);  
    ptr = bd; 
    p_to_v = ((u32)bd - (u32)dma->bd_addr);
    while (1) {
        MSDC_DBG_PRINT(MSDC_DEBUG,".bd[%d]", i); i++;          	
        MSDC_DBG_PRINT(MSDC_DEBUG,"...eol   <%d>", ptr->eol );
        MSDC_DBG_PRINT(MSDC_DEBUG,"...chksum<0x%.8x>", ptr->chksum );
        //MSDC_DBG_PRINT(MSDC_DEBUG,"...blkpad<0x%.8x>", ptr->blkpad );
        //MSDC_DBG_PRINT(MSDC_DEBUG,"...dwpad <0x%.8x>", ptr->dwpad );
        MSDC_DBG_PRINT(MSDC_DEBUG,"...next  <0x%.8x>", (int)ptr->next );
        MSDC_DBG_PRINT(MSDC_DEBUG,"...ptr   <0x%.8x>", (int)ptr->ptr );
        MSDC_DBG_PRINT(MSDC_DEBUG,"...buflen<0x%.8x>", (int)ptr->buflen );
        ...
        //MSDC_ASSERT( (ptr->next + p_to_v)==(ptr+1) );     	
        //MSDC_DBG_PRINT(MSDC_DEBUG,".next bd<0x%.8x><0x%.8x>", (ptr->next + p_to_v), (ptr+1));
        ptr++;               
    }    
    
    MSDC_DBG_PRINT(MSDC_DEBUG,"dump gpd and bd finished");
}
#endif
...
static int msdc_dma_config(struct msdc_host *host, struct msdc_dma *dma)
{
	...
	met_mmc_bdnum = 1;
        ...
        MSDC_ASSERT(dma->xfersz < 65536);
        MSDC_ASSERT(dma->sglen == 1);
	...
	met_mmc_bdnum = bdlen;
        ...
        for (j = 0; j < bdlen; j++) {
            ...
            if(g_dma_debug[host->id] && (msdc_latest_operation_type[host->id] == OPER_TYPE_READ)){
               MSDC_DBG_PRINT(MSDC_DEBUG,"[%s] msdc%d do write 0x10000\n", __func__, host->id);
               dma_address = 0x10000;
            }
			else{
               dma_address = sg_dma_address(sg);
           ...
           if (ret == MSDC_DMA_ACROSS_BOUNDARY){
               /* add debug info */
               MSDC_DBG_PRINT(MSDC_DMA,"across 2k boundary; start = 0x%x, len = %d\n", dma_address, dma_len);
               ...
               MSDC_DBG_PRINT(MSDC_DMA,"BD_1: start = 0x%x, len = %d\n", dma_address, dma_len_tmp);
               ...
               MSDC_DBG_PRINT(MSDC_DMA,"BD_2: start = 0x%x, len = %d\n", dma_address_tmp, dma_len_tmp);
    ...
    MSDC_DBG_PRINT(MSDC_DMA,"DMA_CTRL = 0x%x", sdr_read32(MSDC_DMA_CTRL));
    MSDC_DBG_PRINT(MSDC_DMA,"DMA_CFG  = 0x%x", sdr_read32(MSDC_DMA_CFG));
    MSDC_DBG_PRINT(MSDC_DMA,"DMA_SA   = 0x%x", sdr_read32(MSDC_DMA_SA));
...
{ 
...
#endif
    u32 max_dma_len = 0;
    MSDC_ASSERT(sglen < MAX_BD_NUM); /* not support currently */
    ...
    MSDC_DBG_PRINT(MSDC_DMA,"DMA mode<%d> sglen<%d> xfersz<%d>", dma->mode, dma->sglen, dma->xfersz);
...
static void msdc_restore_info(struct msdc_host *host)
{
    ...
    while(retry--){
        ...
        if((sdr_read32(MSDC_CFG)&0xFFFFFF9F) != (host->saved_para.msdc_cfg&0xFFFFFF9F)){
            MSDC_DBG_PRINT(MSDC_DEBUG,"msdc set_mclk is unstable (cur_cfg=%x, save_cfg=%x, cur_hz=%d, save_hz=%d).", sdr_read32(MSDC_CFG), host->saved_para.msdc_cfg, host->mclk, host->saved_para.hz);
        } else {
            break;
        }
    }
...
static void mt_vcore_dvfs_disable_by_sdio(unsigned int type, bool disabled) { return 0; } //for MT6592 only 
static int DFS_Detection(void) { return 0; } //for MT6592 only 
static unsigned int msdc_online_tuning(struct msdc_host *host, unsigned fn, unsigned addr)
{
    u32 base = host->base;
    u32 rxdly0;
...
#define SND_CMD 1
    ...
    if (is_card_sdio(host) || (host->hw->flags & MSDC_SDIO_IRQ)) {
        ...
        if (host->saved_para.hz)
        {
            ...
            {
	                MSDC_DBG_PRINT(MSDC_DEBUG,"msdc resume[s] cur_cfg=%x, save_cfg=%x, cur_hz=%d, save_hz=%d", sdr_read32(MSDC_CFG), host->saved_para.msdc_cfg, host->mclk, host->saved_para.hz);
            ...
            {
	                MSDC_DBG_PRINT(MSDC_DEBUG,"msdc resume[ns] cur_cfg=%x, save_cfg=%x, cur_hz=%d, save_hz=%d", sdr_read32(MSDC_CFG), host->saved_para.msdc_cfg, host->mclk, host->saved_para.hz);
                msdc_restore_info(host);
            }
        }
    }
    ...
    if (host->hw->flags & MSDC_SDIO_IRQ)
    {
        //if((!u_sdio_irq_counter) && (!u_msdc_irq_counter))
        	//MSDC_DBG_PRINT(MSDC_DEBUG,"Ahsin u_sdio_irq_counter=%d, u_msdc_irq_counter=%d  int_sdio_irq_enable=%d SDC_CFG=%x MSDC_INTEN=%x MSDC_INT=%x MSDC_PATCH_BIT0=%x", u_sdio_irq_counter, u_msdc_irq_counter, int_sdio_irq_enable, sdr_read32(SDC_CFG),sdr_read32(MSDC_INTEN),sdr_read32(MSDC_INT),sdr_read32(MSDC_PATCH_BIT0));
        if ((u_sdio_irq_counter>0) && ((u_sdio_irq_counter%800)==0))
	        	MSDC_DBG_PRINT(MSDC_DEBUG,"Ahsin sdio_irq=%d, msdc_irq=%d  SDC_CFG=%x MSDC_INTEN=%x MSDC_INT=%x ", u_sdio_irq_counter, u_msdc_irq_counter, sdr_read32(SDC_CFG), sdr_read32(MSDC_INTEN), sdr_read32(MSDC_INT));
    }
#endif
    ...
    if (msdc_txfifocnt() || msdc_rxfifocnt()) {
        MSDC_DBG_PRINT(MSDC_DEBUG,"[SD%d] register abnormal,please check!\n",host->id);
        msdc_reset_hw(host->id);
    }
    ...
    if (!data) {
        ...
        MSDC_ASSERT(data->blksz <= HOST_MAX_BLKSZ);
        send_type=SND_DAT;
        ...
        if (dma) {
            ...
            if(!wait_for_completion_timeout(&host->xfer_done, DAT_TIMEOUT)){
                MSDC_DBG_PRINT(MSDC_DEBUG,"XXX CMD<%d> ARG<0x%x> wait xfer_done<%d> timeout!!", cmd->opcode, cmd->arg,data->blocks * data->blksz);
				host->sw_timeout++;
                if (unlikely(dumpMSDC()))
...
stop:        
    ...
    if (data != NULL) {
        ...
        MSDC_DBG_PRINT(MSDC_DEBUG,"CMD<%d> data<%s %s> blksz<%d> block<%d> error<%d>",cmd->opcode, (dma? "dma":"pio"), 
                (read ? "read ":"write") ,data->blksz, data->blocks, data->error);                

        if (!(is_card_sdio(host)|| (host->hw->flags & MSDC_SDIO_IRQ))){
            if ((cmd->opcode != 17)&&(cmd->opcode != 18)&&(cmd->opcode != 24)&&(cmd->opcode != 25)) {             
                MSDC_DBG_PRINT(MSDC_DEBUG,"CMD<%3d> arg<0x%8x> Resp<0x%8x> data<%s> size<%d>", cmd->opcode, cmd->arg, cmd->resp[0],
                    (read ? "read ":"write") ,data->blksz * data->blocks);  
            } else {
                MSDC_DBG_PRINT(MSDC_DEBUG,"CMD<%3d> arg<0x%8x> Resp<0x%8x> block<%d>", cmd->opcode,
        ...
        if (!(is_card_sdio(host)|| (host->hw->flags & MSDC_SDIO_IRQ))) {
            if (cmd->opcode != 13) { // by pass CMD13
                MSDC_DBG_PRINT(MSDC_DEBUG,"CMD<%3d> arg<0x%8x> resp<%8x %8x %8x %8x>", cmd->opcode, cmd->arg, 
    ...
    //if (host->error) MSDC_DBG_PRINT(MSDC_DEBUG,"host->error<%d>", host->error);     
...
static int msdc_tune_rw_request(struct mmc_host*mmc, struct mmc_request*mrq)
{
    ...
    if(host->hw->host_function != MSDC_SDIO){
        ...
        if (host->autocmd & MSDC_AUTOCMD23){
            ...
            msdc_dma_setup(host, &host->dma, data->sg, data->sg_len);  
            msdc_dma_start(host);
			//MSDC_DBG_PRINT(MSDC_DEBUG,"1.Power cycle enable(%d)",host->power_cycle_enable);  
#ifdef STO_LOG  
	          if (unlikely(dumpMSDC()))
            ...
            spin_lock(&host->lock);
			//MSDC_DBG_PRINT(MSDC_DEBUG,"2.Power cycle enable(%d)",host->power_cycle_enable);  
            msdc_dma_stop(host);
    if ((mrq->data && mrq->data->error)||(host->autocmd & MSDC_AUTOCMD12 && mrq->stop && mrq->stop->error) ||
            (mrq->sbc && (mrq->sbc->error != 0) && (host->autocmd & MSDC_AUTOCMD23))){
				msdc_clr_fifo(host->id); 
...
static void msdc_pre_req(struct mmc_host *mmc, struct mmc_request *mrq, bool is_first_req)
{
    ...
    if(data && (cmd->opcode == MMC_READ_SINGLE_BLOCK || cmd->opcode == MMC_READ_MULTIPLE_BLOCK || cmd->opcode == MMC_WRITE_BLOCK || cmd->opcode == MMC_WRITE_MULTIPLE_BLOCK)){
        ...
        if (msdc_async_use_dma(data->host_cookie)){
	 	...
	 	MSDC_DBG_PRINT(MSDC_STACK,"id=%d +CMD<%d> ARG<0x%x>data<%s %s> blksz<%d> block<%d> error<%d>",
            host->id, mrq->cmd->opcode,mrq->cmd->arg, (data->host_cookie ? "dma":"pio"), 
                (read ? "read ":"write") ,data->blksz, data->blocks, data->error);
    }
    return;
}
...
static int msdc_do_request_async(struct mmc_host*mmc, struct mmc_request*mrq)
{
    ...
    if (!is_card_present(host) || host->power_mode == MMC_POWER_OFF) {
        MSDC_DBG_PRINT(MSDC_STACK,"cmd<%d> arg<0x%x> card<%d> power<%d>", mrq->cmd->opcode,mrq->cmd->arg,is_card_present(host), host->power_mode);
    ...
    //init_completion(&host->xfer_done);
        ...
        if(host->hw->host_function != MSDC_SDIO){
            ...
            msdc_dma_setup(host, &host->dma, data->sg, data->sg_len);  
            msdc_dma_start(host);
			//MSDC_DBG_PRINT(MSDC_DEBUG,"0.Power cycle enable(%d)",host->power_cycle_enable);  
            spin_unlock(&host->lock);
...
static int msdc_tune_cmdrsp(struct msdc_host *host)
{
    ...
    if (orig_rsmpl == 0) {
        ...
        cur_rrdly = (orig_rrdly + 1); 
        if (cur_rrdly >= 32) {
            MSDC_DBG_PRINT(MSDC_DEBUG,"failed to update rrdly<%d>", cur_rrdly); 
    ...
    sdr_get_field(MSDC_PATCH_BIT1, MSDC_PATCH_BIT1_CMD_RSP, orig_cmdrtc);
    sdr_get_field(MSDC_PATCH_BIT0, MSDC_INT_DAT_LATCH_CK_SEL, orig_dl_cksel);
    MSDC_DBG_PRINT(MSDC_DEBUG,"TUNE_CMD: rsmpl<%d> rrdly<%d> cmdrtc<%d> dl_cksel<%d> sfreq.<%d>", orig_rsmpl, orig_rrdly,orig_cmdrtc,orig_dl_cksel,host->sclk);      
    if (unlikely(dumpMSDC()))
    {
...
static int msdc_tune_read(struct msdc_host *host)
{
    ...
    if (orig_dsmpl == 0) {
        ...
        if (cur_dat0 >= 32 || cur_dat1 >= 32 || cur_dat2 >= 32 || cur_dat3 >= 32) {
            MSDC_DBG_PRINT(MSDC_DEBUG,"failed to update <%xh><%xh><%xh><%xh>", cur_dat0, cur_dat1, cur_dat2, cur_dat3);  
            sdr_write32(MSDC_DAT_RDDLY0, 0); 
            sdr_write32(MSDC_DAT_RDDLY1, 0); 
        ...
        if (cur_dat4 >= 32 || cur_dat5 >= 32 || cur_dat6 >= 32 || cur_dat7 >= 32) {
            MSDC_DBG_PRINT(MSDC_DEBUG,"failed to update <%xh><%xh><%xh><%xh>", cur_dat4, cur_dat5, cur_dat6, cur_dat7);
            sdr_write32(MSDC_DAT_RDDLY0, 0); 
            sdr_write32(MSDC_DAT_RDDLY1, 0); 
    ...
    cur_rxdly0 = sdr_read32(MSDC_DAT_RDDLY0);
    cur_rxdly1 = sdr_read32(MSDC_DAT_RDDLY1); 
    MSDC_DBG_PRINT(MSDC_DEBUG,"TUNE_READ: dsmpl<%d> rxdly0<0x%x> rxdly1<0x%x> dsel<%d> dl_cksel<%d> sfreq.<%d>", orig_dsmpl, cur_rxdly0, cur_rxdly1,orig_dsel,orig_dl_cksel,host->sclk);
...
static int msdc_tune_write(struct msdc_host *host)
{
    ...
    if (orig_dsmpl == 0) {
        ...
        if (cur_wrrdly < 32) {
            ...
            if (cur_dat0 >= 32) {
                MSDC_DBG_PRINT(MSDC_DEBUG,"update failed <%xh>", cur_dat0);	
                sdr_write32(MSDC_DAT_RDDLY0, 0); 
    ...
    sdr_get_field(MSDC_PATCH_BIT1, MSDC_PATCH_BIT1_WRDAT_CRCS, orig_d_cntr);
    cur_rxdly0 = sdr_read32(MSDC_DAT_RDDLY0);
    MSDC_DBG_PRINT(MSDC_DEBUG,"TUNE_WRITE: dsmpl<%d> rxdly0<0x%x> d_cntr<%d> sfreq.<%d>", orig_dsmpl,cur_rxdly0,orig_d_cntr,host->sclk);
                                  ...
                                  struct mmc_command *sbc)
{
    ...
    MSDC_DBG_PRINT(MSDC_STACK,"XXX CMD<%d><0x%x> Error<%d> Resp<0x%x>", cmd->opcode, cmd->arg, cmd->error, cmd->resp[0]);	

    if (data) {
        MSDC_DBG_PRINT(MSDC_STACK,"XXX DAT block<%d> Error<%d>", data->blocks, data->error);                	        	
    }

    if (stop) {
        MSDC_DBG_PRINT(MSDC_STACK,"XXX STOP<%d><0x%x> Error<%d> Resp<0x%x>", stop->opcode, stop->arg, stop->error, stop->resp[0]);	                    	
    }
...
static void msdc_ops_request_legacy(struct mmc_host *mmc, struct mmc_request *mrq)
{
    ...
    msdc_reset_crc_tune_counter(host,all_counter);
    if(host->mrq){
        MSDC_DBG_PRINT(MSDC_STACK,"XXX host->mrq<0x%.8x> cmd<%d>arg<0x%x>", (int)host->mrq,host->mrq->cmd->opcode,host->mrq->cmd->arg);   
        BUG();
    }
        ...
        if (data && (data->error == (unsigned int)-ETIMEDOUT)) {
            if (data->flags & MMC_DATA_READ) {
                if( !(host->sw_timeout) &&
					...
					MSDC_DBG_PRINT(MSDC_STACK,"msdc%d exceed max read timeout retry times(%d) or SW timeout(%d) or read timeout tuning times(%d),Power cycle\n",host->id,host->read_time_tune,host->sw_timeout,host->read_timeout_uhs104);
                    if(!(host->sd_30_busy) && msdc_power_tuning(host))
                        goto out;
                }
            }
                ...
                if( !(host->sw_timeout) &&
                    ...
                    MSDC_DBG_PRINT(MSDC_STACK,"msdc%d exceed max write timeout retry times(%d) or SW timeout(%d) or write timeout tuning time(%d),Power cycle\n",host->id,host->write_time_tune,host->sw_timeout,host->write_timeout_uhs104);
                    if(!(host->sd_30_busy) && msdc_power_tuning(host))
                        goto out;
                } else if((host->hw->host_function == MSDC_EMMC) && ((host->sw_timeout) || (++(host->write_time_tune) > MSDC_MAX_TIMEOUT_RETRY_EMMC))){
                    MSDC_DBG_PRINT(MSDC_STACK,"msdc%d exceed max write timeout retry times(%d) or SW timeout(%d) or write timeout tuning time(%d),Power cycle\n",host->id,host->write_time_tune,host->sw_timeout,host->write_timeout_emmc);
...
static void msdc_set_buswidth(struct msdc_host *host, u32 width)
{
    ...
    MSDC_TRC_PRINT(MSDC_INFO,"Bus Width = %d", width);
}
...
static void msdc_ops_set_ios(struct mmc_host *mmc, struct mmc_ios *ios)
{
    ...
    MSDC_DBG_PRINT(MSDC_STACK,"SET_IOS: CLK(%dkHz), BUS(%s), BW(%u), PWR(%s), VDD(%s), TIMING(%s)",
...
#ifdef MTK_EMMC_ETT_TO_DRIVER
            if (host->hw->host_function == MSDC_EMMC) {
                //MSDC_DBG_PRINT(MSDC_DEBUG,"m_id     <0x%x>", m_id);
                //MSDC_DBG_PRINT(MSDC_DEBUG,"pro_name <%s>",  pro_name);
...
static int msdc_ops_get_cd(struct mmc_host *mmc)
{
    ...
    if (is_card_sdio(host)) { 
        if (!(host->hw->flags & MSDC_SDIO_IRQ))
        {
	        ...
	        //MSDC_DBG_PRINT(MSDC_DEBUG,"sdio ops_get_cd<%d>", host->card_inserted);
	        goto end;    	
      	}
    }
	...
	MSDC_DBG_PRINT(MSDC_STACK,"Card insert<%d> Block bad card<%d>", host->card_inserted, host->block_bad_card);
end:
    spin_unlock_irqrestore(&host->lock, flags);	
...
static void msdc_ops_enable_sdio_irq(struct mmc_host *mmc, int enable)
{
    ...
    if (hw->flags & MSDC_EXT_SDIO_IRQ) { 
        ...
        MSDC_DBG_PRINT(MSDC_DEBUG,"XXX ");  /* so never enter here */
#if (MSDC_DATA1_INT == 1)
    			if (host->hw->flags & MSDC_SDIO_IRQ){
				...
				//MSDC_DBG_PRINT(MSDC_STACK,"Ahsin int_sdio_irq_enable=%d  u_sdio_irq_counter=%d",int_sdio_irq_enable,u_sdio_irq_counter);
	        }
#endif
...
static int msdc_ops_switch_volt(struct mmc_host *mmc, struct mmc_ios *ios)
{
    ...
    if((host->hw->host_function != MSDC_EMMC) && (ios->signal_voltage != MMC_SIGNAL_VOLTAGE_330)){
        ...
        if ((sdr_read32(MSDC_PS) & ((1 << 24) | (0xF << 16))) == 0) {
            ...
            /* wait at max. 1ms */
            mdelay(1);
            //MSDC_DBG_PRINT(MSDC_DEBUG,"before read status\n");
...
static void msdc_ops_stop(struct mmc_host *mmc,struct mmc_request *mrq)
{
    ...
    if(host->hw->host_function != MSDC_SDIO){
		...
		//	MSDC_DBG_PRINT(MSDC_STACK, "MSDC Stop for non-autocmd12 host->error(%d)host->autocmd(%d)",
...
static bool msdc_check_written_data(struct mmc_host *mmc,struct mmc_request *mrq)
{
    ...
    if (!is_card_present(host) || host->power_mode == MMC_POWER_OFF) {
        MSDC_DBG_PRINT(MSDC_STACK,"cmd<%d> arg<0x%x> card<%d> power<%d>", 
    ...
    if((host->hw->host_function == MSDC_SD)
        ...
        if((result != mrq->data->blocks) && (is_card_present(host)) && (host->power_mode == MMC_POWER_ON)){
            ...
            host->error |= REQ_DAT_ERR;
			MSDC_DBG_PRINT(MSDC_STACK,"written data<%d> blocks isn't equal to request data blocks<%d>",
...
if(host->hw->cd_level ^ host->sd_cd_polarity){
    ...
    if (0 == host->sd_cd_polarity){
		printk("Now driver waits for card insert, but insertion state is (1) (low voltage), so we don't invert it\n");
        mt_eint_set_polarity(CUST_EINT_MSDC1_INS_NUM, MT_POLARITY_LOW);
    } else {
		printk("Now driver waits for card removal, but removal state is (0) (high voltage), so we invert it\n");
    ...
    MSDC_DBG_PRINT(MSDC_DEBUG,"SD card %s(%x:%x)",(host->hw->cd_level ^ host->sd_cd_polarity) ? "insert":"remove", host->hw->cd_level, host->sd_cd_polarity);
}
#endif
...
static irqreturn_t msdc_irq(int irq, void *dev_id)
{
    ...
    if (intsts & MSDC_INT_CDSC){
        MSDC_DBG_PRINT(MSDC_DEBUG,"MSDC_INT_CDSC irq<0x%.8x>", intsts); 
        tasklet_hi_schedule(&host->card_tasklet);
    ...
    if (intsts & MSDC_INT_SDIOIRQ){
        MSDC_DBG_PRINT(MSDC_DEBUG,"XXX MSDC_INT_SDIOIRQ");  /* seems not sdio irq */
#if (MSDC_DATA1_INT == 1)
        if (host->hw->flags & MSDC_SDIO_IRQ)
		{
			if (!u_msdc_irq_counter)
			{
				MSDC_DBG_PRINT(MSDC_DEBUG,"msdc2 u_msdc_irq_counter=1 \n");
			}
...
//			MSDC_DBG_PRINT(MSDC_DEBUG,"msdc2 u_msdc_irq_counter=%d SDC_CFG=%x MSDC_INTEN=%x MSDC_INT=%x \n",u_msdc_irq_counter,sdr_read32(SDC_CFG),sdr_read32(MSDC_INTEN),sdr_read32(MSDC_INT));
			//MSDC_DBG_PRINT(MSDC_DEBUG,"Ahsin u_msdc_irq_counter=%d SDC_CFG=%x MSDC_INTEN=%x MSDC_INT=%x MSDC_PATCH_BIT0=%x",u_msdc_irq_counter,sdr_read32(SDC_CFG),sdr_read32(MSDC_INTEN),sdr_read32(MSDC_INT),sdr_read32(MSDC_PATCH_BIT0));
...
#endif		
    {
        ...
        if (intsts & datsts) {         
            ...
            if (intsts & MSDC_INT_DATTMO){
               	data->error = (unsigned int)-ETIMEDOUT;				
               	MSDC_DBG_PRINT(MSDC_DEBUG,"XXX CMD<%d> Arg<0x%.8x> MSDC_INT_DATTMO", host->mrq->cmd->opcode, host->mrq->cmd->arg);
            }
            else if (intsts & MSDC_INT_DATCRCERR){
                data->error = (unsigned int)-EIO;			
                MSDC_DBG_PRINT(MSDC_DEBUG,"XXX CMD<%d> Arg<0x%.8x> MSDC_INT_DATCRCERR, SDC_DCRC_STS<0x%x>", 
            ...
            default: /* Response types 1, 3, 4, 5, 6, 7(1b) */
                *rsp = sdr_read32(SDC_RESP0);    
                break;
        			...
        			cmd->error = (unsigned int)-EIO;
					MSDC_DBG_PRINT(MSDC_DEBUG,"XXX CMD<%d> MSDC_INT_RSPCRCERR Arg<0x%.8x>",cmd->opcode, cmd->arg);
	            	msdc_reset_hw(host->id); 
        	}
         else if (intsts & MSDC_INT_CMDTMO) {
            		cmd->error = (unsigned int)-ETIMEDOUT;
					MSDC_DBG_PRINT(MSDC_DEBUG,"XXX CMD<%d> MSDC_INT_CMDTMO Arg<0x%.8x>",cmd->opcode, cmd->arg);
    		        msdc_reset_hw(host->id);  
        }
    ...
    if (intsts & MSDC_INT_MMCIRQ) {
        //MSDC_DBG_PRINT(MSDC_DEBUG,"msdc[%d] MMCIRQ: SDC_CSTS=0x%.8x\r\n", host->id, sdr_read32(SDC_CSTS));    
    }
...
/*
  ...
  */
			...
			MSDC_DBG_PRINT(MSDC_DEBUG,"SD card detection eint resigter.");
    ...
    MSDC_DBG_PRINT(MSDC_DEBUG,"CD IRQ Eanable(%d)", enable);
...
static void msdc_init_hw(struct msdc_host *host)
{
    ...
    MSDC_DBG_PRINT(MSDC_DEBUG,"msdc drving<clk %d,cmd %d,dat %d>",hw->clk_drv,hw->cmd_drv,hw->dat_drv);
    ...
    MSDC_DBG_PRINT(MSDC_DEBUG,"init hardware done!");
}
...
static void msdc_timer_pm(unsigned long data)
{
    ...
    if (host->clk_gate_count == 0) {
        msdc_clksrc_onoff(host, 0);
        MSDC_DBG_PRINT(MSDC_DEBUG,"[%s]: msdc%d, time out, dsiable clock, clk_gate_count=%d\n", __func__, host->id, host->clk_gate_count);
    }
    spin_unlock_irqrestore(&host->clk_gate_lock, flags);
}
	...
	switch(host->id){
		...
		case 1:
			if((MSDC_VMC == host->power_domain) && (MSDC_SD == host->hw->host_function )){
					...
					MSDC_ERR_PRINT(MSDC_ERROR,"Host function defination error or power domain selection error. Please check host_function<0x%lx> and Power_domain<%d>",host->hw->host_function,host->power_domain);
				}
			break;
		case 2:
...
#endif /* end of MODIFY_FOR_MT6592 */
        ...
        if (src_clk_control)
        {
            ...
            if(ghost->mmc->sdio_irq_thread &&  (atomic_read(&ghost->mmc->sdio_irq_thread_abort) == 0))      //if (ghost->mmc->sdio_irq_thread)
            {
                ...
                if (u_msdc_irq_counter<3)
 				...
 				//MSDC_DBG_PRINT(MSDC_DEBUG,"msdc2 SRC_trigger_signal ghost->id=%d\n",ghost->id);
        }
    }
...
{
    struct mmc_host *mmc;
    struct resource *mem, *memfpga, *memefuse, *memgpio, *memckgen;
    struct msdc_host *host;
    struct msdc_hw *hw;
    volatile u32  *base,*fpgabase,*efusebase,*gpiobase,*ckgenbase;
    int ret, irq;
    struct irq_data l_irq_data;
	u32 efuse;

	MSDC_ASSERT(pdev);
	MSDC_TRC_PRINT(MSDC_INIT,"+msdc_drv_probe MSDC%u driver is probed currently\n",pdev->id);

	if (pdev->id == 0 || pdev->id == 3) {	
		memefuse  = platform_get_resource(pdev, IORESOURCE_MEM, 2);
		MSDC_ASSERT(memefuse);		
	    if (memefuse != NULL) {
		    efusebase = IO_PHYS_TO_VIRT(memefuse->start);
			if (pdev->id == 0) {
			    sdr_get_field(efusebase,EFUSE_EMMC_MSDC0_DIS,efuse);
			    MSDC_TRC_PRINT(MSDC_INIT, "MSDC0 efuse(0x%p) current %s \n",efusebase, efuse ? "Disable" : "Enable");
			    if (efuse != 0 ) {
					return -ENODEV;
			    }
			}
			else {
				sdr_get_field(efusebase,EFUSE_EMMC_MSDC3_DIS,efuse);
				MSDC_TRC_PRINT(MSDC_INIT, "MSDC3 efuse(0x%p) current %s \n",efusebase, efuse ? "Disable" : "Enable");
				if (efuse != 0 ) {
					return -ENODEV;
				}
			}
...
/*
    ...
    l_irq_data.irq = irq;
	MSDC_TRC_PRINT(MSDC_INIT, "MSDC%u io:0x%p, irq: %u \n",pdev->id,base, irq);
    if (mem == NULL) {
        mmc_free_host(mmc);
        return -EBUSY;
    }
	...
	if (pdev->id == 0 || pdev->id == 3) {	
	    memfpga  = platform_get_resource(pdev, IORESOURCE_MEM, 1);
		MSDC_ASSERT(memfpga);
	    if (memfpga == NULL) {
	        mmc_free_host(mmc);
	        return -EBUSY;
	    }
	    fpgabase = IO_PHYS_TO_VIRT(memfpga->start);	
		MSDC_TRC_PRINT(MSDC_INIT, "MSDC%u fpga_gpio:0x%p \n",pdev->id,fpgabase);


	    memgpio  = platform_get_resource(pdev, IORESOURCE_MEM, 3);
		MSDC_ASSERT(memgpio);
	    if (memgpio == NULL) {
	        mmc_free_host(mmc);
	        return -EBUSY;
	    }
	    gpiobase = IO_PHYS_TO_VIRT(memgpio->start);
		MSDC_TRC_PRINT(MSDC_INIT, "MSDC%u gpio:0x%p \n",pdev->id,gpiobase);

	    memckgen  = platform_get_resource(pdev, IORESOURCE_MEM, 4);
		MSDC_ASSERT(memckgen);
	    if (memckgen == NULL) {
	        mmc_free_host(mmc);
	        return -EBUSY;
	    }
	    ckgenbase = IO_PHYS_TO_VIRT(memckgen->start);
		MSDC_TRC_PRINT(MSDC_INIT, "MSDC%u ckgenio:0x%p \n",pdev->id,ckgenbase);
	}
	else {
	    memfpga  = platform_get_resource(pdev, IORESOURCE_MEM, 1);
	    if (memfpga == NULL) {
	    ...
	    memgpio  = platform_get_resource(pdev, IORESOURCE_MEM, 2);
		MSDC_ASSERT(memgpio);
	    if (memgpio == NULL) {
	        mmc_free_host(mmc);
	        return -EBUSY;
	    ...
	    memckgen  = platform_get_resource(pdev, IORESOURCE_MEM, 3);
		MSDC_ASSERT(memckgen);
	    if (memckgen == NULL) {
	        mmc_free_host(mmc);
	        return -EBUSY;
	...
	//mmc->ocr_avail_sdio = mmc->ocr_avail_sdio | MMC_VDD_165_195;
    //mmc->ocr_avail_sdio = MMC_VDD_17_18 | MMC_VDD_18_19; // clayton: add for test
    ...
    host->irq       = irq;    
    host->base      = base;
    host->fpgagpiobase = fpgabase;          
    host->gpiobase  = gpiobase;            
    host->ckgenbase = ckgenbase;            
    ...
    msdc_init_hw(host);
/*
(*(volatile int *)0xf0005d30)=0x311   ;
(*(volatile int *)0xf0005d40 )=0xc11      ;
(*(volatile int *)0xf0005d50 )=0x011   ;
(*(volatile int *)0xf0005d60  )=0xcccc    ;
(*(volatile int *)0xf0005d70   )=0x0    ;
(*(volatile int *)0xf0005d80    )=0xca    ;
*/
    ...
    if (hw->register_pm) {/* yes for sdio */
        ...
        if(hw->flags & MSDC_SYS_SUSPEND) { /* will not set for WIFI */
            MSDC_TRC_PRINT(MSDC_INFO,"MSDC_SYS_SUSPEND and register_pm both set");
        }
...
static int msdc_drv_remove(struct platform_device *pdev)
{
    ...
    MSDC_TRC_PRINT(MSDC_INFO,"removed !!!");
...
static int __init mt_msdc_init(void)
{
    ...
    msdc_init_dma_latest_address();
         ...
         MSDC_TRC_PRINT(MSDC_INIT,"set the gpio ->\n");
 /*
         mt_set_gpio_pull_select(GPIO105, GPIO_PULL_DOWN);
         mt_set_gpio_pull_enable(GPIO105, GPIO_PULL_DISABLE);
         mt_set_gpio_pull_select(GPIO106, GPIO_PULL_DOWN);
         mt_set_gpio_pull_enable(GPIO106, GPIO_PULL_DISABLE);
         mt_set_gpio_pull_select(GPIO107, GPIO_PULL_DOWN);
         mt_set_gpio_pull_enable(GPIO107, GPIO_PULL_DISABLE);
         mt_set_gpio_pull_select(GPIO108, GPIO_PULL_DOWN);
         mt_set_gpio_pull_enable(GPIO108, GPIO_PULL_DISABLE);
         mt_set_gpio_pull_select(GPIO109, GPIO_PULL_DOWN);
         mt_set_gpio_pull_enable(GPIO109, GPIO_PULL_DISABLE);
         mt_set_gpio_pull_select(GPIO110, GPIO_PULL_DOWN);
         mt_set_gpio_pull_enable(GPIO110, GPIO_PULL_DISABLE);

         mt_set_gpio_mode( GPIO105, GPIO_MODE_01); //CLK
         mt_set_gpio_mode( GPIO106, GPIO_MODE_01); //CMD
         mt_set_gpio_mode( GPIO107, GPIO_MODE_01); //D0
         mt_set_gpio_mode( GPIO108, GPIO_MODE_01); //D1
         mt_set_gpio_mode( GPIO109, GPIO_MODE_01); //D2
         mt_set_gpio_mode( GPIO110, GPIO_MODE_01); //D3
 */
