...
static struct ccci_port md_cd_ports_normal[] = {
#ifdef MT6290
	{CCCI_MONITOR_CH, CCCI_MONITOR_CH, 0xFF, 0xFF, 0xFF, 0xFF, 4, &char_port_ops, MD_CD_MAJOR,
	 0, "eemcs_monitor",},
	{CCCI_PCM_TX, CCCI_PCM_RX, 0, 0, 0xFF, 0xFF, 4, &char_port_ops, MD_CD_MAJOR, 1,
	 "eemcs_aud",},
	...
	{CCCI_UART1_TX, CCCI_UART1_RX, 1, 1, 3, 3, 0, &char_port_ops, MD_CD_MAJOR, 2,
	 "eemcs_md_log_ctrl",},
	{CCCI_UART2_TX, CCCI_UART2_RX, 1, 1, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 3,
	 "eemcs_mux",},
	{CCCI_FS_TX, CCCI_FS_RX, 1, 1, 1, 1, 4, &char_port_ops, MD_CD_MAJOR, 4, "eemcs_fs",},
	{CCCI_IPC_UART_TX, CCCI_IPC_UART_RX, 1, 1, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 5,
	 "eemcs_ipc_uart",},
	{CCCI_ICUSB_TX, CCCI_ICUSB_RX, 1, 1, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 6,
	 "eemcs_ICUSB",},
	{CCCI_RPC_TX, CCCI_RPC_RX, 1, 1, 0xFF, 0xFF, 0, &kernel_port_ops, 0, 0, "eemcs_rpc",},

	{CCCI_IPC_TX, CCCI_IPC_RX, 1, 1, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 0,
	 "eemcs_ipc_0",},
	{CCCI_IPC_TX, CCCI_IPC_RX, 1, 1, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 2,
	 "eemcs_ipc_2",},

	{CCCI_MD_LOG_TX, CCCI_MD_LOG_RX, 2, 2, 2, 2, 8, &char_port_ops, MD_CD_MAJOR, 7,
	 "eemcs_md_log",},
	...
	{CCCI_IMSV_UL, CCCI_IMSV_DL, 6, 6, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 8,
	 "eemcs_imsv",},
	{CCCI_IMSC_UL, CCCI_IMSC_DL, 6, 6, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 9,
	 "eemcs_imsc",},
	{CCCI_IMSA_UL, CCCI_IMSA_DL, 6, 6, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 10,
	 "eemcs_imsa",},
	{CCCI_IMSDC_UL, CCCI_IMSDC_DL, 6, 6, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 11,
	 "eemcs_imsdc",},

	{CCCI_DUMMY_CH, CCCI_DUMMY_CH, 0xFF, 0xFF, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 12,
	 "eemcs_muxrp",},
	{CCCI_DUMMY_CH, CCCI_DUMMY_CH, 0xFF, 0xFF, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 13,
	 "eemcs_ril",},

	{CCCI_IT_TX, CCCI_IT_RX, 0, 0, 0xFF, 0xFF, 4, &char_port_ops, MD_CD_MAJOR, 17, "eemcs_it",},
	{CCCI_LB_IT_TX, CCCI_LB_IT_RX, 0, 0, 0xFF, 0xFF, 4, &char_port_ops, MD_CD_MAJOR, 18,
	 "eemcs_lb_it",},
#else
	{CCCI_MONITOR_CH, CCCI_MONITOR_CH, 0xFF, 0xFF, 0xFF, 0xFF, 4, &char_port_ops, MD_CD_MAJOR,
	 0, "ccci_monitor",},
	...
	{CCCI_IPC_TX, CCCI_IPC_RX, 1, 1, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 2,
	 "ccci_ipc_2",},
	{CCCI_IPC_TX, CCCI_IPC_RX, 1, 1, 0xFF, 0xFF, 16, &char_port_ops, MD_CD_MAJOR, 3,
	 "ccci_ipc_3",},

	{CCCI_MD_LOG_TX, CCCI_MD_LOG_RX, 2, 2, 2, 2, 8, &char_port_ops, MD_CD_MAJOR, 7, "ttyC1",},
	...
	{CCCI_DUMMY_CH, CCCI_DUMMY_CH, 0xFF, 0xFF, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 13,
	 "ccci_ioctl1",},
	{CCCI_DUMMY_CH, CCCI_DUMMY_CH, 0xFF, 0xFF, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 14,
	 "ccci_ioctl2",},
	{CCCI_DUMMY_CH, CCCI_DUMMY_CH, 0xFF, 0xFF, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 15,
	 "ccci_ioctl3",},
	{CCCI_DUMMY_CH, CCCI_DUMMY_CH, 0xFF, 0xFF, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 16,
	 "ccci_ioctl4",},

	{CCCI_IT_TX, CCCI_IT_RX, 0, 0, 0xFF, 0xFF, 4, &char_port_ops, MD_CD_MAJOR, 17, "eemcs_it",},
	{CCCI_LB_IT_TX, CCCI_LB_IT_RX, 0, 0, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 18,
	 "eemcs_lb_it",},
#endif
};
...
static int rx_queue_buffer_size[8] =
    { SKB_4K, SKB_4K, SKB_4K, SKB_1_5K, SKB_1_5K, SKB_1_5K, SKB_4K, SKB_4K };
...
static void cldma_dump_gpd_ring(void *start)
{
...
static void cldma_dump_register(struct md_cd_ctrl *md_ctrl)
{
	...
	printk("[CLDMA] dump AP CLDMA Tx register\n");
	ccci_mem_dump(md_ctrl->cldma_ap_base + CLDMA_AP_UL_START_ADDR_0,
		      CLDMA_AP_UL_CHECKSUM_CHANNEL_ENABLE - CLDMA_AP_UL_START_ADDR_0 + 4);
	printk("[CLDMA] dump AP CLDMA Rx register\n");
	ccci_mem_dump(md_ctrl->cldma_ap_base + CLDMA_AP_SO_ERROR,
		      CLDMA_AP_DEBUG_ID_EN - CLDMA_AP_SO_ERROR + 4);
	printk("[CLDMA] dump AP CLDMA MISC register\n");
	ccci_mem_dump(md_ctrl->cldma_ap_base + CLDMA_AP_L2TISAR0,
		      CLDMA_AP_CHNL_IDLE - CLDMA_AP_L2TISAR0 + 4);
	printk("[CLDMA] dump MD CLDMA Tx register\n");
	ccci_mem_dump(md_ctrl->cldma_md_base + CLDMA_AP_UL_START_ADDR_0,
		      CLDMA_AP_UL_CHECKSUM_CHANNEL_ENABLE - CLDMA_AP_UL_START_ADDR_0 + 4);
	printk("[CLDMA] dump MD CLDMA Rx register\n");
	ccci_mem_dump(md_ctrl->cldma_md_base + CLDMA_AP_SO_ERROR,
		      CLDMA_AP_DEBUG_ID_EN - CLDMA_AP_SO_ERROR + 4);
	printk("[CLDMA] dump MD CLDMA MISC register\n");
	ccci_mem_dump(md_ctrl->cldma_md_base + CLDMA_AP_L2TISAR0,
		      CLDMA_AP_CHNL_IDLE - CLDMA_AP_L2TISAR0 + 4);
...
static int cldma_rx_collect(struct md_cd_queue *queue, int budget)
{
	...
	while (1) {		/* not hardware own */
		...
		if (unlikely(!req->skb)) {
			CCCI_ERR_MSG(md->index, TAG,
				     "found a hole on q%d, try refill and move forward\n",
				     queue->index);
			goto fill_and_move;
		}
		if (req->skb->len != 0) {
		...
		CCCI_DBG_MSG(md->index, TAG, "recv Rx msg (%x %x %x %x) rxq=%d len=%d\n",
			     ...
			     queue->index, rgpd->data_buff_len);
 ...
 fill_and_move:
			...
			if (likely(req->skb)) {
				rgpd->data_buff_bd_ptr =
				    dma_map_single(NULL, req->skb->data, skb_size(req->skb),
						   DMA_FROM_DEVICE);
				/* checksum of GPD */
...
static void cldma_rx_done(struct work_struct *work)
{
	...
	md_cd_lock_cldma_clock_src(1);
	/* resume Rx queue */
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_SO_RESUME_CMD,
		      CLDMA_BM_ALL_QUEUE & (1 << queue->index));
	/* enable RX_DONE interrupt */
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L2RIMCR0,
		      CLDMA_BM_ALL_QUEUE & (1 << queue->index));
	md_cd_lock_cldma_clock_src(0);
}
...
static void cldma_tx_done(struct work_struct *work)
{
	...
	md_cd_lock_cldma_clock_src(1);
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L2TIMCR0,
		      CLDMA_BM_ALL_QUEUE & (1 << queue->index));
	md_cd_lock_cldma_clock_src(0);
}
...
static void cldma_rx_queue_init(struct md_cd_queue *queue)
{
	...
	for (i = 0; i < RING_BUFF_SIZE; i++) {
		...
		gpd->data_buff_bd_ptr =
		    dma_map_single(NULL, req->skb->data, skb_size(req->skb), DMA_FROM_DEVICE);
	 ...
	 */
	queue->worker =
	    alloc_workqueue("rx%d_worker", WQ_UNBOUND | WQ_MEM_RECLAIM | WQ_HIGHPRI, 1,
			    queue->index);
...
static void cldma_tx_queue_init(struct md_cd_queue *queue)
{
	...
	queue->worker =
	    alloc_workqueue("tx%d_worker", WQ_UNBOUND | WQ_MEM_RECLAIM | WQ_HIGHPRI, 1,
			    queue->index);
...
static void cldma_timeout_timer_func(unsigned long data)
{
	...
	CCCI_ERR_MSG(md->index, TAG, "CLDMA no response for %d seconds\n", CLDMA_ACTIVE_T);
...
void cldma_irq_task(unsigned long data)
{
	...
	if (unlikely(!(L2RISAR0 & CLDMA_BM_INT_DONE) && !(L2TISAR0 & CLDMA_BM_INT_DONE))) {
		CCCI_ERR_MSG(md->index, TAG,
			     "no Tx or Rx, L2TISAR0=%X, L3TISAR0=%X, L2RISAR0=%X, L3RISAR0=%X\n",
			     L2TISAR0, L3TISAR0, L2RISAR0, L3RISAR0);
	} else {
	...
	for (i = 0; i < QUEUE_LEN(md_ctrl->txq); i++) {
		if (L2TISAR0 & CLDMA_BM_INT_DONE & (1 << i)) {
			...
			cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L2TIMSR0,
				      CLDMA_BM_ALL_QUEUE & (1 << i));
			ret = queue_work(md_ctrl->txq[i].worker, &md_ctrl->txq[i].cldma_work);
			if (unlikely(!ret))
				CCCI_ERR_MSG(md->index, TAG, "schedule Txq%d work %p fail\n", i,
	...
	if (L2RISAR0 & CLDMA_BM_INT_DONE)
		cldma_write32(md_ctrl->md_peer_wakeup, 0,
			      cldma_read32(md_ctrl->md_peer_wakeup, 0) & ~0x01);
#endif
	for (i = 0; i < QUEUE_LEN(md_ctrl->rxq); i++) {
		if (L2RISAR0 & CLDMA_BM_INT_DONE & (1 << i)) {
			/* disable RX_DONE interrupt */
			cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L2RIMSR0,
				      CLDMA_BM_ALL_QUEUE & (1 << i));
			if (md->md_state != EXCEPTION && ((1 << i) & NAPI_QUEUE_MASK)) {
				md_ctrl->rxq[i].napi_port->ops->md_state_notice(md_ctrl->rxq[i].
										napi_port, RX_IRQ);
			} else {
				ret =
				...
				if (unlikely(!ret))
					CCCI_ERR_MSG(md->index, TAG,
						     "schedule Rxq%d work %p fail\n", i,
						     &md_ctrl->rxq[i].cldma_work);
			}
		}
	}
	md_cd_lock_cldma_clock_src(0);
...
static inline void cldma_stop_for_ee(struct ccci_modem *md)
{
	...
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_UL_STOP_CMD, CLDMA_BM_ALL_QUEUE);
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_SO_STOP_CMD,
		      CLDMA_BM_ALL_QUEUE & NONSTOP_QUEUE_MASK);
	/* clear all L2 and L3 interrupts, but non-stop Rx ones */
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L2TISAR0, CLDMA_BM_INT_ALL);
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L2TISAR1, CLDMA_BM_INT_ALL);
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L2RISAR0,
		      CLDMA_BM_INT_ALL & NONSTOP_QUEUE_MASK_32);
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L2RISAR1,
		      CLDMA_BM_INT_ALL & NONSTOP_QUEUE_MASK_32);
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L3TISAR0, CLDMA_BM_INT_ALL);
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L3TISAR1, CLDMA_BM_INT_ALL);
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L3RISAR0,
		      CLDMA_BM_INT_ALL & NONSTOP_QUEUE_MASK_32);
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L3RISAR1,
		      CLDMA_BM_INT_ALL & NONSTOP_QUEUE_MASK_32);
	...
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L2RIMSR0,
		      CLDMA_BM_INT_ALL & NONSTOP_QUEUE_MASK_32);
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L2RIMSR1,
		      CLDMA_BM_INT_ALL & NONSTOP_QUEUE_MASK_32);
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L3TIMSR0, CLDMA_BM_INT_ALL);
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L3TIMSR1, CLDMA_BM_INT_ALL);
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L3RIMSR0,
		      CLDMA_BM_INT_ALL & NONSTOP_QUEUE_MASK_32);
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L3RIMSR1,
		      CLDMA_BM_INT_ALL & NONSTOP_QUEUE_MASK_32);
}
...
static inline void cldma_reset(struct ccci_modem *md)
{
	...
	cldma_stop(md);
	/* enable OUT DMA */
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_SO_CFG,
		      cldma_read32(md_ctrl->cldma_ap_base, CLDMA_AP_SO_CFG) | 0x01);
	/* enable SPLIT_EN */
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_BUS_CFG,
		      cldma_read32(md_ctrl->cldma_ap_base, CLDMA_AP_BUS_CFG) | 0x02);
	...
	case 0:
		...
		break;
	case 12:
		cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_UL_CHECKSUM_CHANNEL_ENABLE,
			      CLDMA_BM_ALL_QUEUE);
		cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_SO_CHECKSUM_CHANNEL_ENABLE,
			      CLDMA_BM_ALL_QUEUE);
		cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_UL_CFG,
			      cldma_read32(md_ctrl->cldma_ap_base, CLDMA_AP_UL_CFG) & ~0x10);
		cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_SO_CFG,
			      cldma_read32(md_ctrl->cldma_ap_base, CLDMA_AP_SO_CFG) & ~0x10);
		break;
	case 16:
		cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_UL_CHECKSUM_CHANNEL_ENABLE,
			      CLDMA_BM_ALL_QUEUE);
...
static inline void cldma_start(struct ccci_modem *md)
{
	...
	/* set start address */
	for (i = 0; i < QUEUE_LEN(md_ctrl->txq); i++) {
		cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_TQSAR(md_ctrl->txq[i].index),
			      md_ctrl->txq[i].tr_done->gpd_addr);
	}
	for (i = 0; i < QUEUE_LEN(md_ctrl->rxq); i++) {
		cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_RQSAR(md_ctrl->rxq[i].index),
	...
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L2TIMCR0,
		      CLDMA_BM_INT_DONE | CLDMA_BM_INT_ERROR);
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L2RIMCR0,
		      CLDMA_BM_INT_DONE | CLDMA_BM_INT_ERROR);
...
static void md_cd_clear_queue(struct ccci_modem *md, DIRECTION dir)
{
	...
	if (dir == OUT) {
		for (i = 0; i < QUEUE_LEN(md_ctrl->txq); i++) {
			...
			for (k = 0; k < j; k++)
				ccci_free_skb(skb_free[k], skb_free_p[k]);	/* check comments in cldma_tx_done() */
		}
	} else if (dir == IN) {
		struct cldma_rgpd *rgpd;
		for (i = 0; i < QUEUE_LEN(md_ctrl->rxq); i++) {
...
static void md_cd_ccif_work(struct work_struct *work)
{
	...
	if (md_ctrl->channel_id & (1 << AP_MD_PEER_WAKEUP))
		wake_lock_timeout(&md_ctrl->trm_wake_lock, HZ);
}
...
static inline int cldma_sw_init(struct ccci_modem *md)
{
	...
	ret =
	    request_irq(AP2MD_BUS_TIMEOUT_IRQ, md_cd_ap2md_bus_timeout_isr, IRQF_TRIGGER_FALLING,
			"AP2MD_BUS_TIMEOUT", md);
	if (ret) {
...
static int md_cd_send_request(struct ccci_modem *md, unsigned char qno, struct ccci_request *req)
{
 ...
 retry:
	...
	if (queue->free_slot > 0) {
		...
		ccci_free_req(req);
		/* update GPD */
		tgpd->data_buff_bd_ptr =
		    dma_map_single(NULL, tx_req->skb->data, tx_req->skb->len, DMA_TO_DEVICE);
		 ...
		 */
		md_cd_lock_cldma_clock_src(1);
		cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_UL_RESUME_CMD,
		...
		if (req->blocking) {
			ret =
			    wait_event_interruptible_exclusive(queue->req_wq,
							       (queue->free_slot > 0));
			if (ret == -ERESTARTSYS) {
				return -EINTR;
			}
...
static int md_cd_give_more(struct ccci_modem *md, unsigned char qno)
{
	...
	CCCI_DBG_MSG(md->index, TAG, "give more on queue %d work %p\n", qno,
		     &md_ctrl->rxq[qno].cldma_work);
	ret = queue_work(md_ctrl->rxq[qno].worker, &md_ctrl->rxq[qno].cldma_work);
	if (unlikely(!ret))
		CCCI_ERR_MSG(md->index, TAG, "schedule Rxq%d more work %p fail\n", qno,
			     &md_ctrl->rxq[qno].cldma_work);
	return 0;
}

static int md_cd_napi_poll(struct ccci_modem *md, unsigned char qno, struct napi_struct *napi,
			   int budget)
{
	struct md_cd_ctrl *md_ctrl = (struct md_cd_ctrl *)md->private_data;
	int ret;
	...
	/* resume Rx queue */
	cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_SO_RESUME_CMD,
		      CLDMA_BM_ALL_QUEUE & (1 << md_ctrl->rxq[qno].index));
	if (ret == 0) {
		napi_complete(napi);
		/* enable RX_DONE interrupt */
		cldma_write32(md_ctrl->cldma_ap_base, CLDMA_AP_L2RIMCR0,
...
static int md_cd_dump_info(struct ccci_modem *md, MODEM_DUMP_FLAG flag, void *buff, int length)
{
	...
	if (flag & DUMP_FLAG_CCIF) {
		int i;
		unsigned int *dest_buff = (unsigned int *)buff;
#define CCIF_SRAM_SIZE 512
		if (length < CCIF_SRAM_SIZE)
		...
		for (i = 0; i < length / sizeof(unsigned int); i++) {
			*(dest_buff + i) =
			    cldma_read32(AP_CCIF0_BASE, APCCIF_CHDATA + i * sizeof(unsigned int));
		}

		CCCI_INF_MSG(md->index, TAG, "Dump CCIF SRAM\n");
		ccci_mem_dump(buff, CCIF_SRAM_SIZE);
	}
...
static ssize_t md_cd_ccif_show(struct ccci_modem *md, char *buf)
{
	...
	count = snprintf(buf, 128, "check kernel log for result\n");
#ifndef MT6290
	CCCI_INF_MSG(md->index, TAG, "AP_CON(%x)=%x\n", AP_CCIF0_BASE + APCCIF_CON,
		     cldma_read32(AP_CCIF0_BASE, APCCIF_CON));
	CCCI_INF_MSG(md->index, TAG, "AP_BUSY(%x)=%x\n", AP_CCIF0_BASE + APCCIF_BUSY,
		     cldma_read32(AP_CCIF0_BASE, APCCIF_BUSY));
	CCCI_INF_MSG(md->index, TAG, "AP_START(%x)=%x\n", AP_CCIF0_BASE + APCCIF_START,
		     cldma_read32(AP_CCIF0_BASE, APCCIF_START));
	CCCI_INF_MSG(md->index, TAG, "AP_TCHNUM(%x)=%x\n", AP_CCIF0_BASE + APCCIF_TCHNUM,
		     cldma_read32(AP_CCIF0_BASE, APCCIF_TCHNUM));
	CCCI_INF_MSG(md->index, TAG, "AP_RCHNUM(%x)=%x\n", AP_CCIF0_BASE + APCCIF_RCHNUM,
		     cldma_read32(AP_CCIF0_BASE, APCCIF_RCHNUM));
	CCCI_INF_MSG(md->index, TAG, "AP_ACK(%x)=%x\n", AP_CCIF0_BASE + APCCIF_ACK,
		     cldma_read32(AP_CCIF0_BASE, APCCIF_ACK));
#define _MD_CCIF0_BASE (AP_CCIF0_BASE+0x1000)
	CCCI_INF_MSG(md->index, TAG, "MD_CON(%x)=%x\n", _MD_CCIF0_BASE + APCCIF_CON,
		     cldma_read32(_MD_CCIF0_BASE, APCCIF_CON));
	CCCI_INF_MSG(md->index, TAG, "MD_BUSY(%x)=%x\n", _MD_CCIF0_BASE + APCCIF_BUSY,
		     cldma_read32(_MD_CCIF0_BASE, APCCIF_BUSY));
	CCCI_INF_MSG(md->index, TAG, "MD_START(%x)=%x\n", _MD_CCIF0_BASE + APCCIF_START,
		     cldma_read32(_MD_CCIF0_BASE, APCCIF_START));
	CCCI_INF_MSG(md->index, TAG, "MD_TCHNUM(%x)=%x\n", _MD_CCIF0_BASE + APCCIF_TCHNUM,
		     cldma_read32(_MD_CCIF0_BASE, APCCIF_TCHNUM));
	CCCI_INF_MSG(md->index, TAG, "MD_RCHNUM(%x)=%x\n", _MD_CCIF0_BASE + APCCIF_RCHNUM,
		     cldma_read32(_MD_CCIF0_BASE, APCCIF_RCHNUM));
	CCCI_INF_MSG(md->index, TAG, "MD_ACK(%x)=%x\n", _MD_CCIF0_BASE + APCCIF_ACK,
		     cldma_read32(_MD_CCIF0_BASE, APCCIF_ACK));
#endif
	return count;
}
...
static void md_cd_modem_setup(struct ccci_modem *md)
{
	...
	md_ctrl->tgpd_dmapool = dma_pool_create("CLDMA_TGPD_DMA",
						NULL, sizeof(struct cldma_tgpd), 16, 0);
	md_ctrl->rgpd_dmapool = dma_pool_create("CLDMA_RGPD_DMA",
						NULL, sizeof(struct cldma_rgpd), 16, 0);
