...
#define LARB0_PORT_NUM 11
#define LARB1_PORT_NUM 10
#define LARB2_PORT_NUM 23
#define LARB5_PORT_NUM 1// 4 //mtk40525 for 8127, this is should 0
...
{LARB0_BASE, LARB1_BASE, LARB2_BASE, SMI_ERROR_ADDR, SMI_ERROR_ADDR, SMI_ERROR_ADDR/*LARB5_BASE*/};
...
void on_larb_power_off(struct larb_monitor *h, int larb_idx)
{
    ...
    SMI_REGISTER_DBG(2);
    SMIDBG(1, "+larb_reg_backup(), larb_idx=%d \n", larb_idx);
    larb_reg_backup(larb_idx); //can not add spinlock
    SMIDBG(1, "-larb_reg_backup(), larb_idx=%d \n", larb_idx);
    SMI_REGISTER_DBG(2);
}
...
int smi_common_init(void)
{
    ...
    **/
    ...
    // Set the init value of larb registers
