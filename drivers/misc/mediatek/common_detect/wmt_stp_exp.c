...
#define WMT_STP_EXP_INFO_FUNC(fmt, arg...)   printk(DFT_TAG "[I]%s: "  fmt, __func__ , ##arg)
#define WMT_STP_EXP_WARN_FUNC(fmt, arg...)   printk(DFT_TAG "[W]%s: "  fmt, __func__ , ##arg)
#define WMT_STP_EXP_ERR_FUNC(fmt, arg...)    printk(DFT_TAG "[E]%s(%d):ERROR! "   fmt, __func__ , __LINE__, ##arg)
