    ...
    switch(cmd) {
        ...
        case VCODEC_INC_PWR_USER:
            ...
            if (rPowerParam.eDriverType == VAL_DRIVER_TYPE_H264_DEC ||
               ...
               rPowerParam.eDriverType == VAL_DRIVER_TYPE_VC1_ADV_DEC||
               rPowerParam.eDriverType == VAL_DRIVER_TYPE_VC1_DEC ||
               rPowerParam.eDriverType == VAL_DRIVER_TYPE_VP8_DEC ||
               rPowerParam.eDriverType == VAL_DRIVER_TYPE_MP1_MP2_DEC)
            {
                gu4L2CCounter++;
