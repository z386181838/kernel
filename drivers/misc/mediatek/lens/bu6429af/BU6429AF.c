...
static struct i2c_board_info kd_lens_dev __initdata = { I2C_BOARD_INFO("BU6429AF", 0x18) };
...
static struct i2c_client *g_pstBU6429AF_I2Cclient;

static dev_t g_BU6429AF_devno;
static struct cdev *g_pBU6429AF_CharDrv;
static struct class *actuator_class;

static int g_s4BU6429AF_Opened;
static long g_i4MotorStatus;
static long g_i4Dir;
static unsigned long g_u4BU6429AF_INF;
...
static int s4BU6429AF_WriteReg(u16 a_u2Data)
{
	...
	char puSendCmd[2] =
	    { (char)(((a_u2Data >> 8) & 0x3) + (0x3 << 6) + (0xd << 2)), (char)(a_u2Data & 0xFF) };
...
/* ////////////////////////////////////////////////////////////// */
static long BU6429AF_Ioctl(struct file *a_pstFile,
