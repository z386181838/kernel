...
#endif
static int storage_logger_dump_write_proc(struct file *file, const char *buffer,
...
static int storage_logger_bufsize_write_proc(struct file *file, const char *buffer,
					     size_t count, loff_t *data)
{
	char tmpBuf[30];
	unsigned long u4CopySize = 0;
...
static int storage_logger_filename_write_proc(struct file *file, const char *buffer,
					      size_t count, loff_t *data)
{
...
static int storage_logger_iosched_write_proc(struct file *file, const char *buffer,
					     size_t count, loff_t *data)
{
	char tmpBuf[4];
	int u4CopySize = 0;
...
static int mtk_io_osd_write_proc(struct file *file, const char *buffer, size_t count,
				 loff_t *data)
{
	char acBuf[32];
	unsigned long CopySize = 0;
...
static int usb_logger_write_flag(struct file *file, const char *buffer, size_t count,
				 loff_t *data)
{
...
static int thermal_logger_write_flag(struct file *file, const char *buffer, size_t count, loff_t *data)
{
	char kbuf[MAX_SINGLE_LINE_SIZE];
	unsigned long len = 0;
	unsigned int tmp = 0;
