...
#define HIF_SDIO_LOUD_FUNC(fmt, arg...)   if (gHifSdioDbgLvl >= HIF_SDIO_LOG_LOUD) { pr_info(DFT_TAG"[L]%s:"  fmt, __func__ , ##arg); }
#define HIF_SDIO_DBG_FUNC(fmt, arg...)    if (gHifSdioDbgLvl >= HIF_SDIO_LOG_DBG) { pr_info(DFT_TAG"[D]%s:"  fmt, __func__ , ##arg); }
#define HIF_SDIO_INFO_FUNC(fmt, arg...)   if (gHifSdioDbgLvl >= HIF_SDIO_LOG_INFO) { pr_info(DFT_TAG"[I]%s:"  fmt, __func__ , ##arg); }
#define HIF_SDIO_WARN_FUNC(fmt, arg...)   if (gHifSdioDbgLvl >= HIF_SDIO_LOG_WARN) { pr_warn(DFT_TAG"[W]%s(%d):"  fmt, __func__ , __LINE__, ##arg); }
#define HIF_SDIO_ERR_FUNC(fmt, arg...)    if (gHifSdioDbgLvl >= HIF_SDIO_LOG_ERR) { pr_warn(DFT_TAG"[E]%s(%d):"  fmt, __func__ , __LINE__, ##arg); }
