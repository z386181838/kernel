...
#define STP_DBG_LOUD_FUNC(fmt, arg...)   if (gStpDbgDbgLevel >= STP_DBG_LOG_LOUD) {  pr_debug(PFX_STP_DBG "%s: "  fmt, __func__ , ##arg); }
#define STP_DBG_DBG_FUNC(fmt, arg...)    if (gStpDbgDbgLevel >= STP_DBG_LOG_DBG) {  pr_debug(PFX_STP_DBG "%s: "  fmt, __func__ , ##arg); }
#define STP_DBG_INFO_FUNC(fmt, arg...)   if (gStpDbgDbgLevel >= STP_DBG_LOG_INFO) { pr_info(PFX_STP_DBG "%s: "  fmt, __func__ , ##arg); }
#define STP_DBG_WARN_FUNC(fmt, arg...)   if (gStpDbgDbgLevel >= STP_DBG_LOG_WARN) { pr_info(PFX_STP_DBG "%s: "  fmt, __func__ , ##arg); }
#define STP_DBG_ERR_FUNC(fmt, arg...)    if (gStpDbgDbgLevel >= STP_DBG_LOG_ERR) {  pr_info(PFX_STP_DBG "%s: "   fmt, __func__ , ##arg); }
#define STP_DBG_TRC_FUNC(f)              if (gStpDbgDbgLevel >= STP_DBG_LOG_DBG) {  pr_debug(PFX_STP_DBG "<%s> <%d>\n", __func__, __LINE__); }
