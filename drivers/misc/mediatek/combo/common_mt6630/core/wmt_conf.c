...
*******************************************************************************
*/
static INT32 wmt_conf_parse_char(P_DEV_WMT pWmtDev, const struct parse_data *data, const PCHAR pos);
...
static INT32 wmt_conf_parse_short(P_DEV_WMT pWmtDev,
				  const struct parse_data *data, const PCHAR pos);

static PCHAR wmt_conf_write_short(P_DEV_WMT pWmtDev, const struct parse_data *data);

static INT32 wmt_conf_parse_int(P_DEV_WMT pWmtDev, const struct parse_data *data, const PCHAR pos);

static PCHAR wmt_conf_write_int(P_DEV_WMT pWmtDev, const struct parse_data *data);

static INT32 wmt_conf_parse_pair(P_DEV_WMT pWmtDev, const PCHAR pKey, const PCHAR pVal);

static INT32 wmt_conf_parse(P_DEV_WMT pWmtDev, const PCHAR pInBuf, UINT32 size);
...
static int wmt_conf_parse_char(P_DEV_WMT pWmtDev, const struct parse_data *data, const PCHAR pos)
{
	PUCHAR dst;
...
static int wmt_conf_parse_short(P_DEV_WMT pWmtDev, const struct parse_data *data, const PCHAR pos)
{
	PUINT16 dst;
...
static int wmt_conf_parse_int(P_DEV_WMT pWmtDev, const struct parse_data *data, const PCHAR pos)
{
	PUINT32 dst;
...
INT32 wmt_conf_read_file(VOID)
{
	...
	if (0 ==
		...
		if (0 ==
		    wmt_conf_parse(&gDevWmt, (const PCHAR)gDevWmt.pWmtCfg->data,
				   gDevWmt.pWmtCfg->size)) {
			/*config file exists */
