...
#define STP_BTM_LOUD_FUNC(fmt, arg...)   if (gBtmDbgLevel >= STP_BTM_LOG_LOUD) { pr_debug(PFX_BTM "%s: "  fmt, __func__ , ##arg); }
#define STP_BTM_DBG_FUNC(fmt, arg...)    if (gBtmDbgLevel >= STP_BTM_LOG_DBG) { pr_debug(PFX_BTM "%s: "  fmt, __func__ , ##arg); }
#define STP_BTM_INFO_FUNC(fmt, arg...)   if (gBtmDbgLevel >= STP_BTM_LOG_INFO) { pr_info(PFX_BTM "[I]%s: "  fmt, __func__ , ##arg); }
#define STP_BTM_WARN_FUNC(fmt, arg...)   if (gBtmDbgLevel >= STP_BTM_LOG_WARN) { pr_info(PFX_BTM "[W]%s: "  fmt, __func__ , ##arg); }
#define STP_BTM_ERR_FUNC(fmt, arg...)    if (gBtmDbgLevel >= STP_BTM_LOG_ERR) {  pr_info(PFX_BTM "[E]%s(%d):ERROR! "   fmt, __func__ , __LINE__, ##arg); }
#define STP_BTM_TRC_FUNC(f)              if (gBtmDbgLevel >= STP_BTM_LOG_DBG) { pr_debug(PFX_BTM "<%s> <%d>\n", __func__, __LINE__); }
