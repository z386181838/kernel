...
#define STP_DBG_LOUD_FUNC(fmt, arg...)   if (gStpDbgDbgLevel >= STP_DBG_LOG_LOUD) {  printk(KERN_DEBUG PFX_STP_DBG "%s: "  fmt, __func__ , ##arg); }
#define STP_DBG_DBG_FUNC(fmt, arg...)    if (gStpDbgDbgLevel >= STP_DBG_LOG_DBG) {  printk(KERN_DEBUG PFX_STP_DBG "%s: "  fmt, __func__ , ##arg); }
#define STP_DBG_INFO_FUNC(fmt, arg...)   if (gStpDbgDbgLevel >= STP_DBG_LOG_INFO) { printk(PFX_STP_DBG "%s: "  fmt, __func__ , ##arg); }
#define STP_DBG_WARN_FUNC(fmt, arg...)   if (gStpDbgDbgLevel >= STP_DBG_LOG_WARN) { printk(PFX_STP_DBG "%s: "  fmt, __func__ , ##arg); }
#define STP_DBG_ERR_FUNC(fmt, arg...)    if (gStpDbgDbgLevel >= STP_DBG_LOG_ERR) {  printk(PFX_STP_DBG "%s: "   fmt, __func__ , ##arg); }
