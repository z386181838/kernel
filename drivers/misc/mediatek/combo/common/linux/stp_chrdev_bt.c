...
#define BT_DBG_FUNC(fmt, arg...)    if (gDbgLevel >= BT_LOG_DBG) { printk(PFX "%s: "  fmt, __func__ , ##arg); }
#define BT_INFO_FUNC(fmt, arg...)   if (gDbgLevel >= BT_LOG_INFO) { printk(PFX "%s: "  fmt, __func__ , ##arg); }
#define BT_WARN_FUNC(fmt, arg...)   if (gDbgLevel >= BT_LOG_WARN) { printk(PFX "%s: "  fmt, __func__ , ##arg); }
#define BT_ERR_FUNC(fmt, arg...)    if (gDbgLevel >= BT_LOG_ERR) { printk(PFX "%s: "   fmt, __func__ , ##arg); }
