...
#define GPS_DBG_FUNC(fmt, arg...)    if (gDbgLevel >= GPS_LOG_DBG) { printk(PFX "%s: "  fmt, __func__ , ##arg); }
#define GPS_INFO_FUNC(fmt, arg...)   if (gDbgLevel >= GPS_LOG_INFO) { printk(PFX "%s: "  fmt, __func__ , ##arg); }
#define GPS_WARN_FUNC(fmt, arg...)   if (gDbgLevel >= GPS_LOG_WARN) { printk(PFX "%s: "  fmt, __func__ , ##arg); }
#define GPS_ERR_FUNC(fmt, arg...)    if (gDbgLevel >= GPS_LOG_ERR) { printk(PFX "%s: "  fmt, __func__ , ##arg); }
