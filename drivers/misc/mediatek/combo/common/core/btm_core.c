...
#define STP_BTM_LOUD_FUNC(fmt, arg...)   if (gBtmDbgLevel >= STP_BTM_LOG_LOUD) { osal_dbg_print(PFX_BTM "%s: "  fmt, __func__ , ##arg); }
#define STP_BTM_DBG_FUNC(fmt, arg...)    if (gBtmDbgLevel >= STP_BTM_LOG_DBG) { osal_dbg_print(PFX_BTM "%s: "  fmt, __func__ , ##arg); }
#define STP_BTM_INFO_FUNC(fmt, arg...)   if (gBtmDbgLevel >= STP_BTM_LOG_INFO) { osal_dbg_print(PFX_BTM "[I]%s: "  fmt, __func__ , ##arg); }
#define STP_BTM_WARN_FUNC(fmt, arg...)   if (gBtmDbgLevel >= STP_BTM_LOG_WARN) { osal_dbg_print(PFX_BTM "[W]%s: "  fmt, __func__ , ##arg); }
#define STP_BTM_ERR_FUNC(fmt, arg...)    if (gBtmDbgLevel >= STP_BTM_LOG_ERR) {  osal_dbg_print(PFX_BTM "[E]%s(%d):ERROR! "   fmt, __func__ , __LINE__, ##arg); }
