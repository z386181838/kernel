...
#define STP_PSM_LOUD_FUNC(fmt, arg...)   if (gPsmDbgLevel >= STP_PSM_LOG_LOUD) { osal_dbg_print(PFX_PSM "%s: "  fmt, __func__ , ##arg); }
#define STP_PSM_DBG_FUNC(fmt, arg...)    if (gPsmDbgLevel >= STP_PSM_LOG_DBG) {  osal_dbg_print(PFX_PSM "%s: "  fmt, __func__ , ##arg); }
#define STP_PSM_INFO_FUNC(fmt, arg...)   if (gPsmDbgLevel >= STP_PSM_LOG_INFO) { osal_dbg_print(PFX_PSM "[I]%s: "  fmt, __func__ , ##arg); }
#define STP_PSM_WARN_FUNC(fmt, arg...)   if (gPsmDbgLevel >= STP_PSM_LOG_WARN) { osal_dbg_print(PFX_PSM "[W]%s: "  fmt, __func__ , ##arg); }
#define STP_PSM_ERR_FUNC(fmt, arg...)    if (gPsmDbgLevel >= STP_PSM_LOG_ERR) {  osal_dbg_print(PFX_PSM "[E]%s(%d):ERROR! "   fmt, __func__ , __LINE__, ##arg); }
