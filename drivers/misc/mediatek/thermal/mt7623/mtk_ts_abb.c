...
static ssize_t mtktsabb_read(struct file *file, char *buf, size_t count, loff_t *data)
{
...
static ssize_t mtktsabb_write(struct file *file, const char *buffer, size_t count, loff_t *data)
{
...
static int __init mtktsabb_init(void)
{
    ...
    else
    {
		...
		if (!entry)
		{
			mtktsabb_dprintk("[mtktsabb_init]: create /proc/mtktsabb/mtktsabb failed\n");
		}
    }
