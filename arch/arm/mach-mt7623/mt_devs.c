...
#else
#define RESERVED_MEM_SIZE_FOR_FB (0)
#endif
 ...
 */
resource_size_t RESERVED_MEM_SIZE_FOR_PMEM = 0;
...
static struct resource mt_resource_msdc0[] = {
    [0]={
        .start  = 0x11230000,
        .end    = 0x11230000 + 0x00001000,
        .flags  = IORESOURCE_MEM,
    },
    [1]={/* FPGA Power control */
        .start  = 0x10001E84,
        .end    = 0x10001E84 + 0x00000008,
        .flags  = IORESOURCE_MEM,
    },
    [2]={/* efuse select control */
        .start  = 0x102061C0,
        .end    = 0x102061C0 + 0x00000004,
        .flags  = IORESOURCE_MEM,
    },
    [3]={/* GPIO control */
        .start  = 0x10005000,
        .end    = 0x10005000 + 0x00001000,
        .flags  = IORESOURCE_MEM,
    },
    [4]={/* TOPCKGEN control */
        .start  = 0x10000000,
        .end    = 0x10000000 + 0x00001000,
        .flags  = IORESOURCE_MEM,
    },
    [5]={
...
#if defined(CONFIG_SND_SOC_MT7623)
static struct platform_device mt7623_audio_device = {
	.name = "mt7623-audio",
	.id = PLATFORM_DEVID_NONE,
};

static struct platform_device mt7623_dai_device = {
	.name = "mt7623-dai",
	.id = PLATFORM_DEVID_NONE,
};
...
static struct platform_device *demo_audio_devices[] __initdata = {
	&mt7623_audio_device,
    &mt7623_dai_device,
    &dummy_codec_device,
    &demo_machine_device
...
#ifndef CONFIG_MT7623_FPGA // init after USB driver
