...
#define WAKE_SRC_FOR_SUSPEND                                                    \
    (WAKE_SRC_KP | WAKE_SRC_EINT | WAKE_SRC_CONN_WDT | WAKE_SRC_IRRX |   \
     WAKE_SRC_CONN | WAKE_SRC_USB_CD | WAKE_SRC_THERM | WAKE_SRC_SYSPWREQ | WAKE_SRC_ETHERNET)
...
static int spm_request_uart_to_sleep(void)
{
    ...
    //spm_write(0xf0003008, (0x1<<19) | (0x1<<20)| (0x1<<21) | (0x1<<22));
    return 0;
    spm_write(0xf0003008, (0x1<<19) | (0x1<<20)| (0x1<<22));
    //va11 = spm_read(0xf0003008);
    //printk("[0xf0003008]=0x%x\n", val1);
