...
#define OV2659_TEST_PATTERN_CHECKSUM (0x7ba87eae)
...
BOOL OV2659_set_param_wb(UINT16 para)
{
    ...
    switch (para)
    {
        ...
        case AWB_MODE_FLUORESCENT:
             ...
             OV2659_write_cmos_sensor(0x3208, 0x00);                                        
             OV2659_write_cmos_sensor(0x3400, 0x04); 
             OV2659_write_cmos_sensor(0x3401, 0x00); 
			 OV2659_write_cmos_sensor(0x3402, 0x04);
			 OV2659_write_cmos_sensor(0x3403, 0x00);
...
static void OV2659InitialSetting(void)
{
	...
	OV2659_write_cmos_sensor(0x3011, 0xC2/*0x82*/);		// Increase IO driving current   
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	if(SENSOR_MODE_PREVIEW == OV2659Sensor.SensorMode)
	{
		...
		OV2659SetHVMirror(sensor_config_data->SensorImageMirror);//tablet  pc sub sensor use only
		spin_lock(&ov2659_drv_lock);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	{
		OV2659FullSizeCaptureSetting();
		OV2659SetHVMirror(sensor_config_data->SensorImageMirror);//tablet PC sub sensor use
	}
...
UINT32 OV2659_GetDelayInfo(UINT32 delayAddr)
{
    SENSOR_DELAY_INFO_STRUCT *pDelayInfo=(SENSOR_DELAY_INFO_STRUCT*)delayAddr;
	OV2659SENSORDB("[OV2659_GetDelayInfo] delayAddr:%d\n", delayAddr);	
...
{
	//OV2659SENSORDB("[OV2659GetExifInfo]\n");
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	UINT32 *pFeatureReturnPara32=(UINT32 *) pFeaturePara, *pFeatureData32=(UINT32 *) pFeaturePara;
	MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData=(MSDK_SENSOR_CONFIG_STRUCT *) pFeaturePara;
	MSDK_SENSOR_REG_INFO_STRUCT *pSensorRegData=(MSDK_SENSOR_REG_INFO_STRUCT *) pFeaturePara;
    UINT32 ret = ERROR_NONE;
    //OV2659SENSORDB("enter OV2659FeatureControl: FeatureId:%d\n", FeatureId);
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_GET_AE_AWB_LOCK_INFO:
			OV2659_get_AEAWB_lock((UINT32 *)(*pFeatureData32),(UINT32 *) (*(pFeatureData32 + 1)));
			break;
		case SENSOR_FEATURE_GET_DELAY_INFO:
			ret = OV2659_GetDelayInfo(*pFeatureData32);
			break;
        ...
        case SENSOR_FEATURE_GET_AF_MAX_NUM_FOCUS_AREAS:
            OV2659SENSORDB("[OV2659_SENSOR_FEATURE_GET_AF_MAX_NUM_FOCUS_AREAS]\n");	
            break;
		default:
			break;			
	}
