...
#define SPM_BDP_PWR_CON				(SPM_BASE + 0x029C)
#define SPM_ETH_PWR_CON				(SPM_BASE + 0x02A0)
#define SPM_HIF_PWR_CON				(SPM_BASE + 0x02A4)
#define SPM_IFR_MISC_PWR_CON		(SPM_BASE + 0x02A8)
