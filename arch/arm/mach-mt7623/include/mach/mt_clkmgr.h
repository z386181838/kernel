...
#define AUDPLL_CON0         (APMIXEDSYS_BASE + 0x0270)
#define AUDPLL_CON1         (APMIXEDSYS_BASE + 0x0274)
#define AUDPLL_PWR_CON0     (APMIXEDSYS_BASE + 0x027C)
...
#define AUD1PLL_CON0		(APMIXEDSYS_BASE + 0x0270)
#define AUD1PLL_CON1		(APMIXEDSYS_BASE + 0x0274)
#define AUD1PLL_PWR_CON0	(APMIXEDSYS_BASE + 0x027C)

#define AUD2PLL_CON0		(APMIXEDSYS_BASE + 0x02C0)
#define AUD2PLL_CON1		(APMIXEDSYS_BASE + 0x02C4)
#define AUD2PLL_PWR_CON0	(APMIXEDSYS_BASE + 0x02CC)
...
#define CLK_CFG_7           (INFRA_BASE + 0x00B0)
...
#define CLK_CFG_12          (INFRA_BASE + 0x00C0)
#define CLK_CFG_13          (INFRA_BASE + 0x00D0)
#define CLK_CFG_14          (INFRA_BASE + 0x00E0)
#define CLK_CFG_15          (INFRA_BASE + 0x00F0)
...
#define AUDIO_TOP_CON4      (AUDIO_REG_BASE + 0x0010)
#define AUDIO_TOP_CON5      (AUDIO_REG_BASE + 0x0014)
#define PWR2_TOP_CON		(AUDIO_REG_BASE + 0x0634)
